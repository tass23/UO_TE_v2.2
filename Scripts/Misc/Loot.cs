...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_SpellWeavingWandTypes = new Type[]
			{
				typeof( DryadAllureWand ),               typeof( SummonFiendWand ),           typeof( NatureFuryWand ),
				typeof( EtherealVoyageWand ),            typeof( ArcaneEmpowermentWand ),     typeof( ThunderstormWand ),
				typeof( WordOfDeathWand ),               typeof( SummonFeyWand ),             typeof( GiftOfRenewalWand ),
				typeof( EssenceOfWindWand ),             typeof( WildfireWand ),              typeof( ArcaneCircleWand ),
		        typeof( ReaperFormWand ),                typeof( GiftOfLifeWand )        
                
			};
		public static Type[] SpellWeavingWandTypes{ get{ return m_SpellWeavingWandTypes; } }
		...
		public static BaseClothing RandomClothing( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
		...
		{
			return RandomRangedWeapon( false, false, false );
		}

		public static BaseWeapon RandomRangedWeapon( bool inTokuno )
		{
			return RandomRangedWeapon( inTokuno, false, false );
		}

		public static BaseWeapon RandomRangedWeapon( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
		...
		{
			return RandomWeapon( false, false, false );
		}

		public static BaseWeapon RandomWeapon( bool inTokuno )
		{
			return RandomWeapon( inTokuno, false, false );
		}

		public static BaseWeapon RandomWeapon( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
		...
		{
			return RandomWeaponOrJewelry( false, false, false );
		}

		public static Item RandomWeaponOrJewelry( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
		...
		{
			return RandomArmor( false, false, false );
		}

		public static BaseArmor RandomArmor( bool inTokuno )
		{
			return RandomArmor( inTokuno, false, false );
		}

		public static BaseArmor RandomArmor( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
		...
		{
			return RandomArmorOrHat( false, false, false );
		}

		public static Item RandomArmorOrHat( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
		...
		{
			return RandomArmorOrShield( false, false, false );
		}

		public static BaseArmor RandomArmorOrShield( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
			...
			#region Stygian Abyss
			if ( Core.SA && isStygianAbyss )
				return Construct( m_SAArmorTypes, m_SAShieldTypes,  m_ArmorTypes, m_AosShieldTypes, m_ShieldTypes ) as BaseArmor;
			#endregion
		...
		{
			return RandomArmorOrShieldOrJewelry( false, false, false );
		}

		public static Item RandomArmorOrShieldOrJewelry( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
			...
			#region Stygian Abyss
			if ( Core.SA && isStygianAbyss )
				return Construct( m_SAArmorTypes, m_ArmorTypes, m_AosHatTypes, m_HatTypes, m_SAShieldTypes, m_AosShieldTypes, m_ShieldTypes, m_JewelryTypes );
			#endregion
		...
		{
			return RandomArmorOrShieldOrWeapon( false, false, false );
		}

		public static Item RandomArmorOrShieldOrWeapon( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			#region Mondain's Legacy
			if ( Core.ML && isMondain )
			...
			#region Stygian Abyss
			if ( Core.SA && isStygianAbyss )
				return Construct( m_SAWeaponTypes, m_AosWeaponTypes, m_WeaponTypes, m_SARangedWeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_SAArmorTypes, m_ArmorTypes, m_AosHatTypes, m_HatTypes, m_SAShieldTypes, m_AosShieldTypes, m_ShieldTypes );
			#endregion
		...
		{
			return RandomArmorOrShieldOrWeaponOrJewelry( false, false, false );
		}

		public static Item RandomArmorOrShieldOrWeaponOrJewelry( bool inTokuno, bool isMondain, bool isStygianAbyss )
		{
			if ( Core.SE && inTokuno )
		...
		public static SpellScroll RandomScroll( int minIndex, int maxIndex, SpellbookType type )
		{
			...
			switch ( type )
			{
				...
				case SpellbookType.Mystic: types = m_MysticismScrollTypes; break;
			}
