		...
		public void AddFixtures( Mobile from, MultiTileEntry[] list )
		{
			...
			for( int i = 0; i < list.Length; ++i )
			{
				...
				else
				{
					...
					else if( itemID >= 0x2BF9 && itemID < 0x2C09 )						//Ancient Ornate Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2BF9) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2BF9, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2C09 && itemID < 0x2C19 )						//Ancient Blue Ornate Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2C09) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2C09, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2C7E && itemID < 0x2C8E )						//Golden Inlay Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2C7E) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2C7E, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2C8E && itemID < 0x2C9E )						//Rainbow Swirl Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2C8E) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2C8E, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2C9E && itemID < 0x2CAE )						//Elven Mystics Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2C9E) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2C9E, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2CAE && itemID < 0x2CBE )						//Chinese Dragon Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2CAE) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2CAE, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2CBE && itemID < 0x2CCE )						//Chinese Oracle Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2CBE) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2CBE, 0xEB, 0xF2 );
					}
					else if( itemID >= 0x2CCE && itemID < 0x2CDE )						//Palm Tree Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2CCE) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2CCE, 0xEB, 0xF2 );
					}
					#endregion
					...
					#region Custom Door 2
					else if( itemID >= 0x2E48 && itemID < 0x2E58 )						//Asian Tiger Door
					{
						DoorFacing facing = (DoorFacing)(((itemID - 0x2E48) / 2) % 8);
						door = new GenericHouseDoor( facing, 0x2E48, 0xEB, 0xF2 );
					}
					#endregion
	...
	public class DesignState
	{
		...
		public static bool IsFixture( int itemID )
		{
			...
			#region Custom Door 1
				...
				return true;
			else if( itemID >= 0x2BF9 && itemID < 0x2C09 )
				return true;
			else if( itemID >= 0x2C09 && itemID < 0x2C19 )
				return true;
			else if( itemID >= 0x2C19 && itemID < 0x2C8E )
				return true;
			else if( itemID >= 0x2C8E && itemID < 0x2C9E )
				return true;
			else if( itemID >= 0x2C9E && itemID < 0x2CAE )
				return true;
			else if( itemID >= 0x2CAE && itemID < 0x2CBE )
				return true;
			else if( itemID >= 0x2CBE && itemID < 0x2CCE )
				return true;
			else if( itemID >= 0x2CCE && itemID < 0x2CDE )
				return true;
			else if( itemID >= 0x2E48 && itemID < 0x2E58 )
				return true;
			#endregion
