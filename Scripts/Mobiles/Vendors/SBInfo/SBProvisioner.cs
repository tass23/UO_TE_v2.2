	...
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				#endregion
				*/
				Add( new GenericBuyInfo( "Craft Bag", typeof( CraftBag ), 1000, 20, 0xE76, 2364 ) );
				...
				Add( new GenericBuyInfo( "Pet Res Potion", typeof( PetResurrectPotion ), 1000, 10, 0xe2a, 1075 ) );
				...
				Add( new GenericBuyInfo( "Yahtzee Dice", typeof( YahtzeeDice ), 150, 10, 4007, 1150 ) );
				Add( new GenericBuyInfo( typeof( GraveShovel ), 125, 5, 0xF39, 0 ) );
