	...
	public class SBAlchemist : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{  
				...
				Add( new GenericBuyInfo( "Witch's Cauldron", typeof( WitchCauldron ), 1000, 5, 0x9ED, 0 ) );
				//Add( new GenericBuyInfo( "Pyrotechnic Kit", typeof( PyroTechnicKit ), 5000, 5, 0x185E, 0 ) );
			}
		}
