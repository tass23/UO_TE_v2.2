	...
	public class SBHolyMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( GraveAxe ), 50, 5, 0xE86, 0 ) );
				Add( new GenericBuyInfo( typeof( morticiansScalpel ), 500, 5, 0x10E7, 0 ) );
				Add( new GenericBuyInfo( "Advanced Spellbook Deed", typeof( AdvancedSpellbookDeed ), 50000, 5, 0x14F0, 0x2B ) );
