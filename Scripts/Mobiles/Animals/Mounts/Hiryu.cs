	...
	public class Hiryu : BaseMount
	{
		...
		private static int GetHue()
		{
		  ...
		  1000	1075	No Hue Color	93.02%	0x0
			...
			/*
			if( rand <= 0 )
				return 0x855C;	//Bright Green with Red		2863
			else if( rand <= 1 )
				return 0x8490;	//Pink with Red				2864
			else if( rand <= 3 )
				return 0x8030;	//Copper with Red			2865
			else if( rand <= 5 )
				return 0x8037;	//Light Greenish/Yellow with Red	2866
			else if( rand <= 8 )
				return 0x8295;	//Greenish Gray with Red	2867
			else if( rand <= 11 )
				return 0x8123;	//Blue/Green with Red	2868
			else if( rand <= 16 )
				return 0x8482;	//Gray with Red	2869
			else if( rand <= 24 )
				return 0x8487;	//Blue/Gold with Red	2870
			else if( rand <= 34 )
				return 0x8032;	//Copper with Red same hue as 0x8030
			else if( rand <= 44 )
				return 0x8899;	//Dark Red with Red
			else if( rand <= 54 )
				return 0x8495;	//Blue/Green with Red same as hue 0x8123
			else if( rand <= 64 )
				return 0x848D;	//Blue/Purple with Red
			else if( rand <= 74 )
				return 0x847F;	//Grayish Green with Red
			*/

			#region UO-The Expanse Custom Hues for Hiryus
			if( rand <= 0 )
				return 2912;	//Red with Tan Trim
			else if( rand <= 1 )
				return 2912;	//Red with Tan Trim
			else if( rand <= 3 )
				return 2915;	//Greenish_Gray_w_Red
			else if( rand <= 5 )
				return 2916;	//Purple with Bright Pink Trim
			else if( rand <= 8 )
				return 2917;	//Dark Blue with Light Blue Trim
			else if( rand <= 11 )
				return 2918;	//Light_Pink_w_Green
			else if( rand <= 16 )
				return 2920;	//Purple with Yellow Trim
			else if( rand <= 24 )
				return 2922;	//Black/Gray with Gold Trim
			else if( rand <= 34 )
				return 2923;	//Green with Red Trim
			else if( rand <= 44 )
				return 2924;	//Bright Pink, Yellow, Orange
			else if( rand <= 54 )
				return 2923;	//Bright_Green_w_Red
			else if( rand <= 64 )
				return 2936;	//Blue/Gray
			else if( rand <= 74 )
				return 2938;	//Bright Yellow, Pink, Orange
			#endregion
