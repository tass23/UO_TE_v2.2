...
{
    public class EtherealMount : Item, IMount, IMountItem, Engines.RewardSystem.IRewardItem
	{
		...
		public virtual bool Validate( Mobile from )
		{
            ...
            else if (m_IsRewardItem && !Engines.RewardSystem.RewardSystem.CheckIsUsableBy(from, this, null))
			{
