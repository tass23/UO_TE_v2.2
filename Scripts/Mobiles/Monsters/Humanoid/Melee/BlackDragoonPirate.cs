...
{
	[CorpseName( "a Black Dragoon Pirate corpse" )]
	public class BlackDragoonPirate : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public BlackDragoonPirate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Black Dragoon Pirate";
			Body = 17;
			BaseSoundID = 0x45A;
		...
		public BlackDragoonPirate( Serial serial ) : base( serial )
		{
		}
