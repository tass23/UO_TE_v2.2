...
namespace Server.Mobiles
{
	...
	public class LadyLuck : Mobile
	{
		...
		/* SafeBagWeightPercent is the amount of reduction in weight given by using the Safe Trash 4 Tokens Backpack. 
		Set to 0 for it to be like a normal bag. Set to 30 for 30% reduction in weight, 100 for 100% reduction. */
		private static int iSafeBagWeightPercent = 100;
		[CommandProperty(AccessLevel.Administrator)]
		public static int SafeBagWeightPercent { 
			get { return iSafeBagWeightPercent; } 
			set { if ( value < 0 ) iSafeBagWeightPercent = 0; 
				  else if ( value > 100 ) iSafeBagWeightPercent = 100; 
				  else iSafeBagWeightPercent = value; } }

		private static int iSafeBagMinutes = 3;
		[CommandProperty(AccessLevel.Administrator)]
		public static int SafeBagMinutes { get { return iSafeBagMinutes; } set { iSafeBagMinutes = value; } }  

		private static bool bTrashTokensOK = false;
		[CommandProperty(AccessLevel.Administrator)]
		public static bool TrashTokensOK { get { return bTrashTokensOK; } set { bTrashTokensOK = value; } }
		
		private static bool bTrashGoldOK = false;
		[CommandProperty(AccessLevel.Administrator)]
		public static bool TrashGoldOK { get { return bTrashGoldOK; } set { bTrashGoldOK = value; } }
		
		private static bool bTrashBankCheckOK = false;
		[CommandProperty(AccessLevel.Administrator)]
		public static bool TrashBankCheckOK { get { return bTrashBankCheckOK; } set { bTrashBankCheckOK = value; } }
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			//version 4
			writer.Write( (int) iSafeBagMinutes );
			writer.Write( (bool) bTrashTokensOK );
			writer.Write( (bool) bTrashGoldOK );
			writer.Write( (bool) bTrashBankCheckOK );
			//version 3
			writer.Write( (int) iSafeBagWeightPercent );
			//version 2
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch (version)
			{
				case 4:
				{
					iSafeBagMinutes = reader.ReadInt();
					bTrashTokensOK = reader.ReadBool();
					bTrashGoldOK = reader.ReadBool();
					bTrashBankCheckOK = reader.ReadBool();
					goto case 3;
				}
				case 3:
				{
					iSafeBagWeightPercent = reader.ReadInt();
					goto case 2;
				}
				case 2:
				{
