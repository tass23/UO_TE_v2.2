...
namespace Server.Items
{
	public class VinyardGroundAddonDeed : BaseAddonDeed
	{
		...
		{
			Name = "Vineyard Ground Addon Deed";
		}
...
namespace Server.Gumps
{
	...
	public class VinyardGroundPlacedGump : Gump
	{
		...
		public VinyardGroundPlacedGump( BaseAddonDeed deed ) : base( 30, 30 )
		{
			...
			AddHtml( 13, 13, 379, 20, "<BASEFONT COLOR=WHITE>Vineyard Ground Addon Placement Successful</BASEFONT>", false, false );

			AddAlphaRegion( 12, 39, 426, 199 );

			AddHtml( 15, 50, 420, 185, "<BODY>" +
			"<BASEFONT COLOR=YELLOW>Your vineyard ground addon has been successfully placed!<BR>" +
			"<BASEFONT COLOR=YELLOW>You may now begin placing grapevines in your vineyard using a " +
			"<BASEFONT COLOR=YELLOW>grapevine placement tool.<BR><BR>" +
			"<BASEFONT COLOR=YELLOW>You may delete this vineyard ground addon at any time.  " +
			"<BASEFONT COLOR=YELLOW>To do so... <BR>" +
			"<BASEFONT COLOR=YELLOW>   1. Delete all grapevines first.<BR>" +
			"<BASEFONT COLOR=YELLOW>   2. Double click the vineyard addon and accept prompt to delete.<BR>" +
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				case 0:
				{
					from.SendMessage( "Enjoy your new vineyard." );
					break;
				}
