...
//					new SlayerEntry( SlayerName.VampireBane, typeof( Vampire0 ), typeof( Vampire1 ), typeof( Vampire2 ), typeof( Vampire3 ), typeof( Vampire4 ), typeof( Vampire5 ) ),
			...
			arachnid.FoundOn = new Type[]{ typeof( AncientWyrm ), typeof( VenomDragon ), typeof( FireDragon ), typeof( ShadowDragon ), typeof( ShadowDrake ), typeof( GreaterDragon ), typeof( Dragon ), typeof( OphidianMatriarch ), typeof( ShadowWyrm ) };
			...
			reptilian.Entries = new SlayerEntry[]
				{
					new SlayerEntry( SlayerName.DragonSlaying, typeof( AncientWyrm ), typeof( VenomDragon ), typeof( FireDragon ), typeof( ShadowDragon ), typeof( ShadowDrake ), typeof( GreaterDragon ), typeof( Dragon ), typeof( Drake ), typeof( Hiryu ), typeof( LesserHiryu ), typeof( SerpentineDragon ), typeof( ShadowWyrm ), typeof( SkeletalDragon ), typeof( SwampDragon ), typeof( WhiteWyrm ), typeof( Wyvern ), /* Mondain's Legacy */ typeof( Hydra ), typeof( CrystalHydra ), typeof( Reptalon ), typeof( Rend ) /* End */, /* typeof( FairyDragon ), */ typeof( Grim ), typeof( StygianDragon ), typeof( Abscess ) ),
