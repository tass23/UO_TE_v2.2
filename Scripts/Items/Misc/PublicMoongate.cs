...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		public static readonly PMList Haven =
			new PMList( 1012000, 1012012, Map.Trammel, new PMEntry[]
				{
					new PMEntry( new Point3D( 3450, 2677, 25), 1078098 )  // New Haven
				} );
	...
	public class MoongateGump : Gump
	{
		...
		public MoongateGump( Mobile mobile, Item moongate ) : base( 100, 100 )
		{
			...
			AddBackground( 0, 0, 380, 300, 5054 );
			
			#region Player Government
			AddButton( 10, 210, 4005, 4007, 2, GumpButtonType.Reply, 0 );
			AddHtml( 45, 210, 140, 25, @"Player City Menu", false, false );
			#endregion

			AddButton( 10, 235, 4005, 4007, 1, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 45, 235, 140, 25, 1011036, false, false ); // OKAY

			AddButton( 10, 255, 4005, 4007, 0, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 45, 255, 140, 25, 1011012, false, false ); // CANCEL
			
			/* Original Code prior to Government System
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else
            {
				...
				#endregion
				/* Original Code prior to Player Government Install
				BaseCreature.TeleportPets(m_Mobile, entry.Location, list.Map);
