...
namespace Server.Items
{
	...
	public abstract class BaseInstrument : Item, ICraftable, ISlayer, IEngravable
	{
		#region Raist/Tass23
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			#region Spellcrafting
			if( m_TimesCrafted > 0 )
				list.Add( "<BASEFONT COLOR=#1C7BFF>[Spellcrafted]<BASEFONT COLOR=#63A5FF>" );
            #endregion
