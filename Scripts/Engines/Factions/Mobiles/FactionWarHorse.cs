	...
	public class FactionWarHorse : BaseMount
	{
		...
		public Faction Faction
		{
			...
			set
			{
				...
				Body = ( m_Faction == null ? 0xE4 : m_Faction.Definition.WarHorseBody );
		...
		public FactionWarHorse( Faction faction ) : base( "a war horse", 0xE4, 0x3EA0, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0xA8;
