		...
		private class InternalTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				if ( m_Entry.Sender.NetState != null && index != -1 )
				{
					...
					m_Entry.Sender.SendMessage( "You can double check our website at www.UOExpanse.com or contact us at support@uoexpanse.com. To cancel your page, please select the help button again and select cancel." ); // You can reference our website at www.uo.com or contact us at support@uo.com. To cancel your page, please select the help button again and select cancel.
