	...
	public class HelpGump : Gump
	{
		...
		private static void EventSink_HelpRequest( HelpRequestEventArgs e )
		{
			...
			if ( AutoStaffTeam.Enabled )  //If automated staff team enabled, begin the new gump process.
			{
				...
				{                 
                    if (e.Mobile.HasGump(typeof(PR_StaffKeywords)))
					{
                        e.Mobile.CloseGump(typeof(PR_StaffKeywords));
						e.Mobile.SendMessage ( "Please close the keywords window before pressing the help button." );
						return;
					}
        
                    Counselor_PR sm = new Counselor_PR();

                    #region Removed This Code To Add Random GM Spawn Locations
                    /*
                    ...
                    */
                    ...
                    switch (Utility.Random(2))
                    {
                        ...
                        case 1: sm.MoveToWorld(new Point3D(e.Mobile.X, e.Mobile.Y + 1, e.Mobile.Z), e.Mobile.Map); break;
                ...
                e.Mobile.SendMessage("You may only page a staff member once every thirty minutes. If you need assistance now, please visit our website at: www.uoexpanse.com/forum");
				return;
			}
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			if ( isYoung )
			{
				...
				AddHtml( 110, 270, 450, 58, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please send an email to: abuse@uoexpanse.com.", true, true );

				AddButton( 80, 335, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 335, 450, 58, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at http://www.uoexpanse.com), please use this option.", true, true );
			}
			else
			{
				...
				AddHtml( 110, 250, 450, 74, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please send an email to: abuse@uoexpanse.com.", true, true );

				AddButton( 80, 330, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at http://www.uoexpanse.com), please use this option.", true, true );
			}

			AddPage( 2 );

			AddButton( 80, 90, 5540, 5541, 3, GumpButtonType.Reply, 0 );
			AddHtml( 110, 90, 450, 74, @"<u>Report a bug or contact Raist.</u> Use this option to launch your web browser and mail in a bug report. Your report will be read by our Quality Assurance Staff. We apologize for not being able to reply to individual reports. ", true, true );

			AddButton( 80, 170, 5540, 5541, 4, GumpButtonType.Reply, 0 );
			AddHtml( 110, 170, 450, 74, @"<u>Suggestion for the Game.</u> If you'd like to make a suggestion for the game, it should be directed to the Development Team Members who participate in the discussion forums http://www.uoexpanse.com/forum. Choosing this option will take you to the Discussion Forums. ", true, true );
			...
			AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at http://www.uoexpanse.com), and requires in-game assistance, use this option. ", true, true );
