            ...
            m_Lists = new RewardList[]
				{
					...
					new RewardList( RewardInterval, 10, new RewardEntry[]
					{
						...
						new RewardEntry( miscellaneous,  "+25 Bank Slot", typeof( BankStorageIncreaseDeed), 25 ),
						new RewardEntry( miscellaneous,  "+50 Bank Slot", typeof( BankStorageIncreaseDeed), 50 ),
						new RewardEntry( miscellaneous,  "+100 Bank Slot", typeof( BankStorageIncreaseDeed), 100 )
					} )
				};
        }
