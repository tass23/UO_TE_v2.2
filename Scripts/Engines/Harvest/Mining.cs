	...
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			if ( Core.ML )
			{
				...
				{
					new BonusHarvestResource( 0, 84.0, null, null ),	//Nothing
					new BonusHarvestResource( 100, 4.0, 1072562, typeof( BlueDiamond ) ),
					new BonusHarvestResource( 100, 2.0, 1072567, typeof( DarkSapphire ) ),
					new BonusHarvestResource( 100, 2.0, 1072570, typeof( EcruCitrine ) ),
					new BonusHarvestResource( 100, 4.0, 1072564, typeof( FireRuby ) ),
