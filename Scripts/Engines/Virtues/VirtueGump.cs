...
namespace Server
{
	...
	public class VirtueGump : Gump
	{
		...
		public VirtueGump( Mobile beholder, Mobile beheld ) : base( 0, 0 )
		{
			...
			Add( new InternalEntry( 124, 46, 112, GetHueFor( 4 ) ) ); // Valor	//Add( new InternalEntry( 123, 46, 112, GetHueFor( 4 ) ) ); // Valor
			...
			Add( new InternalEntry( 61, 195, 111, GetHueFor( 3 ) ) ); // Spirituality
		...
		private static int[] m_Table = new int[24]
			{
				0x0481, 0x0963, 0x0965,	//Humility Silver
				0x060A, 0x060F, 0x002A,	//Sacrifice Orange
				0x08A4, 0x08A7, 0x0034,	//Compassion Yellow
				0x0965, 0x08FD, 0x0480,	//Honesty Blue
				0x00EA, 0x0845, 0x0020,	//Valor Red
				0x0011, 0x0269, 0x013D,	//Honor Purple
				0x08A1, 0x08A3, 0x0042,	//Justice Green
				0x0543, 0x0547, 0x0061	//Spirituality White
			};
