...
{
	public class GlovesOfTheUnholyWing : BoneGloves
	{
		...
		[Constructable]
		public GlovesOfTheUnholyWing()
		{
			Name = "Unholy Vestment Gloves";
			Hue = 1108;
		...
		public GlovesOfTheUnholyWing( Serial serial ) : base( serial )
		{
		}
