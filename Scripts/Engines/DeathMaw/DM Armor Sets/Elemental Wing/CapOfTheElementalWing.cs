...
{
	public class CapOfTheElementalWing : PlateHelm
	{
		...
		[Constructable]
		public CapOfTheElementalWing()
		{
			Name = "Mantle of Hephaestus Helm";
			Hue = 2130;
		...
		public CapOfTheElementalWing( Serial serial ) : base( serial )
		{
		}
