...
namespace Server.Mobiles
{
	...
	public class AbyssalAbomination2 : BaseCreature
	{
		...
		[Constructable]
		public AbyssalAbomination2() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AbyssalAbomination2( Serial serial ) : base( serial )
		{
		}
