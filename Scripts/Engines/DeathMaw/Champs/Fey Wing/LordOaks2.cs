...
{
	public class LordOaks2 : BaseDMChampion
	{
		...
		[Constructable]
		public LordOaks2() : base( AIType.AI_Mage, FightMode.Evil )
		{
			Body = 175;
			Name = "Lord Oaks";
		...
		public LordOaks2( Serial serial ) : base( serial )
		{
		}
