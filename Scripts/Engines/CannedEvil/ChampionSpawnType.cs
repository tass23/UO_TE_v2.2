...
namespace Server.Engines.CannedEvil
{
	...
	public class ChampionSpawnInfo
	{
		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				new ChampionSpawnInfo( "Pirate", typeof( OneEyedWilly ), new string[]{ "Swabbie", "First Mate", "Captain" }, new Type[][]	// Pirate
				{																											// Pirate
					new Type[]{ typeof( Lizardman ), typeof( GiantRat ) },													// Level 1
					new Type[]{ typeof( Ratman ), typeof( Ettin ) },														// Level 2
					new Type[]{ typeof( Troll ), typeof( Brigand ) },														// Level 3
					new Type[]{ typeof( Titan ), typeof( Orc ) }															// Level 4
				} ),
				new ChampionSpawnInfo( "Tortured", typeof( TheExecutioner ), new string[]{ "Prisoner", "Guard", "Executioner" }, new Type[][]	// Tortured
				{																											// Tortured
					new Type[]{ typeof( Ghoul ), typeof( Spectre ) },														// Level 1
					new Type[]{ typeof( Skeleton ), typeof( Ghoul ) },														// Level 2
					new Type[]{ typeof( HeadlessOne ), typeof( RestlessSoul ) },											// Level 3
					new Type[]{ typeof( SkeletalKnight ), typeof( Zombie ) }												// Level 4
				} ),
