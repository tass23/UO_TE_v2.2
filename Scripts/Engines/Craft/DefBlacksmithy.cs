...
namespace Server.Engines.Craft
{
	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			Synthax for a COMPLEX craft item.  A complex item is an item that needs either more than
			only one skill, or more than only one resource.
			
			AddCraft( ObjectType, Group, MinSkill, MaxSkill, ResourceType, Amount, Message )
					AddRes( index, typeof( ObjectType ), ResourceType, Amount, Message ); //Add this for each resource needed to complete the recipe.
			*/
			...
			if( Core.SE )
			{
        		...
        		{	
					#region SA
					index = AddCraft( typeof( GargishPlateArms ), 1011078, "gargish platemail arms (female)", 66.3, 125.0, typeof( IronIngot ), 1044036, 18, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					index = AddCraft( typeof( GargishPlateArms ), 1011078, 1095336, 66.3, 125.0, typeof( IronIngot ), 1044036, 18, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					
					index = AddCraft( typeof( GargishPlateChest ), 1011078, "gargish platemail chest (female)", 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					index = AddCraft( typeof( GargishPlateChest ), 1011078, 1095338, 75.0, 125.0, typeof( IronIngot ), 1044036, 25, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					
			 		index = AddCraft( typeof( GargishPlateKilt ), 1011078, "gargish platemail kilt (female)", 58.9, 125.0, typeof( IronIngot ), 1044036, 12, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					index = AddCraft( typeof( GargishPlateKilt ), 1011078, 1095340, 58.9, 125.0, typeof( IronIngot ), 1044036, 12, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					
					index = AddCraft( typeof( GargishPlateLegs ), 1011078, "gargish platemail leggings (female)", 68.8, 125.0, typeof( IronIngot ), 1044036, 20, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					index = AddCraft( typeof( GargishPlateLegs ), 1011078, 1095342, 68.8, 125.0, typeof( IronIngot ), 1044036, 20, 1044037 );
					SetNeededExpansion( index, Expansion.SA );
					#endregion
				}
        ...
        {	
			...
			#region Fire Rock
            index = AddCraft(typeof(FemaleFireRockChest), "Armor", "female fireRock chest", 96.0, 115.0, typeof(LargeFireRock), "large FireRock", 2, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "Small FireRock", 5, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
            index = AddCraft(typeof(FireRockChest), "Armor", "fireRock chest", 96.0, 115.0, typeof(LargeFireRock), "large FireRock", 3, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "Small FireRock", 5, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
            index = AddCraft(typeof(FireRockArms), "Armor", "fireRock arms", 85.0, 110.0, typeof(LargeFireRock), "large FireRock", 2, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "Small FireRock", 3, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 2, 1044240 );
            index = AddCraft(typeof(FireRockLegs), "Armor", "fireRock legs", 85.0, 110.0, typeof(LargeFireRock), "large FireRock", 4, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "Small Firerock", 2, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            index = AddCraft(typeof(FireRockGloves), "Armor", "fireRock gloves", 80.0, 105.0, typeof(LargeFireRock), "large FireRock", 1, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "Small FireRock", 2, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 1, 1044240 );
            index = AddCraft(typeof(FireRockGorget), "Armor", "fireRock gorget", 80.0, 105.0, typeof(LargeFireRock), "large FireRock", 1, "You do not have enough large FireRock.");
            AddRes(index, typeof(SmallFireRock), "small FireRock", 2, "You do not have enough small FireRock");
			AddRes( index, typeof( FireRuby ), 1032695, 1, 1044240 );
            AddCraft(typeof(FireRockHelm), "Armor", "FireRock Helm", 75.0, 95.0, typeof(LargeFireRock), "large FireRock", 2, "You do not have enough large FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 1, 1044240 );
            index = AddCraft(typeof(FlameShield), "Armor", "flame shield", 75.0, 95.0, typeof(LargeFireRock), "large FireRock", 5, "You do not have enough large FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
            AddRes(index, typeof(SmallFireRock), "small FireRock", 3, "You do not have enough small FireRock.");
            index = AddCraft(typeof(CrystalineFireChest), "Armor", "crystalline fire chest", 97.0, 115.0, typeof(CrystalineFire), "Crystalline Fire", 10, "You do not have enough Crystalline Fire.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
            AddRes(index, typeof(SmallFireRock), "small FireRock", 5, "You do not have enough small FireRock.");
            index = AddCraft(typeof(CrystalineFireArms), "Armor", "crystalline fire arms", 86.0, 110.0, typeof(CrystalineFire), "Crystalline Fire", 5, "You do not have enough Crystalline Fire.");
			AddRes( index, typeof( FireRuby ), 1032695, 2, 1044240 );
            AddRes(index, typeof(SmallFireRock), "small FireRock", 3, "You do not have enough small FireRock.");
            index = AddCraft(typeof(CrystalineFireLegs), "Armor", "crystalline fire legs", 86.0, 110.0, typeof(CrystalineFire), "Crystalline Fire", 6, "You do not have enough Crystalline Fire.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddRes(index, typeof(SmallFireRock), "small FireRock", 4, "You don;t have enough small FireRock.");
            index = AddCraft(typeof(CrystalineFireGloves), "Armor", "crystalline fire gloves", 82.0, 105.0, typeof(CrystalineFire), "Crystalline Fire", 4, "You do not have enough Crystalline Fire.");
			AddRes( index, typeof( FireRuby ), 1032695, 1, 1044240 );
            AddRes(index, typeof(SmallFireRock), "small FireRock", 2, "You do not have enough small FireRock.");
            AddCraft(typeof(CrystalineFireHelm), "Armor", "crystalline fire helm", 80.0, 95.0, typeof(CrystalineFire), "Crystalline Fire", 3, "You do not have enough Crystalline Fire.");
			AddRes( index, typeof( FireRuby ), 1032695, 1, 1044240 );
            ...
            AddCraft(typeof(Flame), "Weapon", "flame", 75.0, 85.0, typeof(SmallFireRock), "small FireRock", 4, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddCraft(typeof(FlowingFire), "Weapon", "flowing fire", 75.0, 85.0, typeof(SmallFireRock), "small FireRock", 4, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddCraft(typeof(CrashAndBurn), "Weapon", "crash and burn", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 3, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddCraft(typeof(Blaze), "Weapon", "blaze", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 6, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
            AddCraft(typeof(DoubleFlame), "Weapon", "double flame", 75.0, 85.0, typeof(SmallFireRock), "small FireRock", 4, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddCraft(typeof(Inferno), "Weapon", "inferno", 95.0, 105.0, typeof(SmallFireRock), "small FireRock", 7, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 5, 1044240 );
            AddCraft(typeof(FlameThrower), "Weapon", "flame thrower", 75.0, 85.0, typeof(SmallFireRock), "small FireRock", 4, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
            AddCraft(typeof(FireStorm), "Weapon", "fire storm", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 6, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );

            #endregion

            #region Special
            index = AddCraft(typeof(RadiantFire), "Special", "radiant fire", 85.0, 95.0, typeof(LargeFireRock), "large FireRock", 3, "You do not have enough large FireRock.");
            AddRes(index, typeof(CrystalineFire), "Crystalline Fire", 1, "You do not have enough Crystalline Fire");
			AddRes( index, typeof( FireRuby ), 1032695, 4, 1044240 );
			//SetUseAllRes(index, true);

            index = AddCraft(typeof(LuminousFlames), "Special", "luminous flames", 85.0, 95.0, typeof(LargeFireRock), "large FireRock", 2, "You dont have enough FireRock");
            AddRes(index, typeof(CrystalineFire), "Crystalline Fire", 1, "You do not have enough Crystalline Fire");
			AddRes( index, typeof( FireRuby ), 1032695, 3, 1044240 );
			//SetUseAllRes(index, true);
            #endregion
            ...
            #region Item
            index = AddCraft(typeof(FlamingArrow), "Item", "flaming arrow", 50.0, 75.0, typeof(SmallFireRock), "small FireRock", 2, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 2, 1044240 );
            AddRes(index, typeof(PigIron), "Pig Iron", 1, "You do not have enough Pig Iron.");
            SetUseAllRes(index, true);

            index = AddCraft(typeof(FireBolt), "Item", "fire bolt", 50.0, 75.0, typeof(SmallFireRock), "small FireRock", 2, "You do not have enough small FireRock.");
			AddRes( index, typeof( FireRuby ), 1032695, 2, 1044240 );
            AddRes(index, typeof(PigIron), "Pig Iron", 1, "You do not have enough Pig Iron.");
            SetUseAllRes(index, true);
            AddCraft(typeof(TallDragonBrazierAddonDeed), "Item", "tall dragon brazier deed", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 15, "You do not have enough small FireRock.");
            AddCraft(typeof(HorseBardingNorthAddonDeed), "Item", "horse barding deed (north)", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 15, "You do not have enough small FireRock.");
            AddCraft(typeof(HorseBardingWestAddonDeed), "Item", "horse barding deed (west)", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 15, "You do not have enough small FireRock.");
            AddCraft(typeof(LamppostAddonDeed), "Item", "lamp post deed", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 15, "You do not have enough small FireRock.");
            AddCraft(typeof(LamppostFancyAddonDeed), "Item", "lamp post deed (fancy)", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 15, "You do not have enough small FireRock.");
            AddCraft(typeof(BBQEastAddonDeed), "Item", "bbq deed (east)", 95.0, 105.0, typeof(LargeFireRock), "large FireRock", 15, "You do not have enough large FireRock.");
            AddCraft(typeof(BBQSouthAddonDeed), "Item", "bbq deed (south)", 95.0, 105.0, typeof(LargeFireRock), "large FireRock", 15, "You do not have enough large FireRock.");
            AddCraft(typeof(FireSteedBardingDeed), "Item", "fire steed barding deed", 85.0, 95.0, typeof(SmallFireRock), "small FireRock", 10, "You do not have enough small FireRock.");
            #endregion
