...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			#region Speciality Books
				index = AddCraft( typeof( FireRockMiningBook ), "Specialty Books", "mining firerock", 114.0, 125.0, typeof( BlankScroll ), 1044377, 25, 1044378 );
				AddRes( index, typeof(FireRuby), "Fire Ruby", 5, "You do not have enough Fire Ruby.");
				AddRes( index, typeof( Taint ), 1032679, 3, 1044253 );
				AddRes( index, typeof( Corruption ), 1032676, 2, 1044253 );
				
				/*
				index = AddCraft( typeof( GemMiningBook ), "Speciality Books", "Mining for Quality Gems", 115.0, 125.0, typeof( BlankScroll ), 1044377, 50, 1044378 );
				AddRes(index, typeof(Amber), 1062607, 50, 1044240);
				AddRes(index, typeof(Emerald), 1062601, 50, 1044240);
				AddRes(index, typeof(Diamond), 1062608, 50, 1044240);
				*/
				
				index = AddCraft( typeof( GlassblowingBook ), "Specialty Books", "crafting glass with glassblowing", 105.0, 125.0, typeof( BlankScroll ), 1044377, 25, 1044378 );
				AddRes( index, typeof(SamplesOfCorruptedWater), 1074999, 5, "You do not have enough Samples of Corrupted Water.");
				AddRes( index, typeof( Sand ), 1044625, 10, 1044627 );
				
				index = AddCraft( typeof( MasonryBook ), "Specialty Books", "making valuables with stonecrafting", 105.0, 125.0, typeof( BlankScroll ), 1044377, 25, 1044378 );
				AddRes( index, typeof( Granite ), 1044514, 2, 1044513 );
				AddRes( index, typeof( Taint ), 1032679, 2, 1044253 );
				AddRes( index, typeof( Corruption ), 1032676, 2, 1044253 );
				
				index = AddCraft( typeof( SandMiningBook ), "Specialty Books", "find glass-quality sand", 105.0, 125.0, typeof( BlankScroll ), 1044377, 25, 1044378 );
				AddRes(index, typeof(FireRuby), 1032695, 2, 1044253);
				AddRes( index, typeof( Taint ), 1032679, 2, 1044253 );
				AddRes( index, typeof( Corruption ), 1032676, 2, 1044253 );
				
				index = AddCraft( typeof( StoneMiningBook ), "Specialty Books", "mining for quality stone", 105.0, 125.0, typeof( BlankScroll ), 1044377, 50, 1044378 );
