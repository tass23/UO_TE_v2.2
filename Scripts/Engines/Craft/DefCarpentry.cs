...
namespace Server.Engines.Craft
{
	...
	public class DefCarpentry : CraftSystem
	{
		...
		/*
		private static Type[] m_CarpentryColorables = new Type[]
		{
			typeof( BarrelStaves ), typeof( BarrelLid ),
			typeof( ShortMusicStand ), typeof( TallMusicStand ),
			typeof( Easle ), typeof( FishingPole ),
			typeof( FootStool ), typeof( Stool ),
			typeof( BambooChair ), typeof( WoodenChair ),
			typeof( FancyWoodenChairCushion ), typeof( WoodenChairCushion ),
			typeof( WoodenBench ), typeof( WoodenThrone ),
			typeof( Throne ), typeof( Nightstand ),
			typeof( WritingTable ), typeof( LargeTable ),
			typeof( ElegantLowTable ), typeof( PlainLowTable ),
			typeof( WoodenBox ), typeof( SmallCrate ),
			typeof( MediumCrate ), typeof( LargeCrate ),
			typeof( WoodenChest ), typeof( EmptyBookcase ),
			typeof( FancyArmoire ), typeof( Armoire ),
			typeof( Keg ), typeof( WoodenShield ),
			typeof( BaseInstrument ), typeof( ParrotPerchAddonDeed )
		};
		...
		public override bool RetainsColorFrom(CraftItem item, Type type)
        {
            ...
            for (int i = 0; !contains && i < m_CarpentryColorables.Length; ++i)
            {
                if (m_CarpentryColorables[i] == type)
                {
                    contains = true;
                    break;
                }
		...
		*/
		...
		public override void InitCraftList()
		{
			...
			{
				index =	AddCraft( typeof( Board ), 1044294, 1027127, 0.0, 0.0, typeof( Board ), 1044466,  1, 1044465 );
			...
			{
				index = AddCraft( typeof( FishingPole ), 1044294, 1023519, 68.4, 93.4, typeof( Board ), 1044041, 5, 1044351 ); //This is in the category of Other during AoS
			...
			index = AddCraft(typeof(SilverStakeUnblessed), 1044566, "silver stake-unblessed", 70.0, 95.0, typeof(SilverIngot), "Silver Ingot", 3, "You don't have enough Silver ingots.");
			AddRes(index, typeof( Board ), 1044041, 7, 1044351 );
			AddRes(index, typeof(FreshGarlic), "Fresh Garlic", 5, "You don't have enough Fresh Garlic.");
			#endregion
			...
			if( Core.SE )
			{
				...
				index = AddCraft(typeof(Tetsubo), 1044566, 1030225, 85.0, 110.0, typeof(Board), 1044041, 8, 1044351);
			...
			index = AddCraft( typeof( SmallBedSouthDeed ), 1044290, 1044321, 94.7, 113.1, typeof( Board ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
			index = AddCraft( typeof( SmallBedEastDeed ), 1044290, 1044322, 94.7, 113.1, typeof( Board ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
			index = AddCraft( typeof( LargeBedSouthDeed ), 1044290,1044323, 94.7, 113.1, typeof( Board ), 1044041, 150, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			index = AddCraft( typeof( LargeBedEastDeed ), 1044290, 1044324, 94.7, 113.1, typeof( Board ), 1044041, 150, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			AddCraft( typeof( DartBoardSouthDeed ), 1044290, 1044325, 15.7, 40.7, typeof( Board ), 1044041, 5, 1044351 );
			AddCraft( typeof( DartBoardEastDeed ), 1044290, 1044326, 15.7, 40.7, typeof( Board ), 1044041, 5, 1044351 );
