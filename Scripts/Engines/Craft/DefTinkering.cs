...
namespace Server.Engines.Craft
{
    ...
    public class DefTinkering : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(FirePick), 1044046, "fire pick", 25.0, 75.0, typeof(IronIngot), 1044036, 5, 1044037);
			AddRes(index, typeof(Ruby), 1044234, 2, 1044253);
			AddRes(index, typeof(Diamond), 1062608, 2, 1044240);
			
			index = AddCraft(typeof(MalletAndChisel), 1044046, "mallet and chisel", 25.0, 75.0, typeof(IronIngot), 1044036, 5, 1044037);
			AddRes(index, typeof(Diamond), 1062608, 2, 1044240);
			
			index = AddCraft(typeof(Blowpipe), 1044046, "blowpipe", 25.0, 75.0, typeof(IronIngot), 1044036, 10, 1044037);
			AddRes(index, typeof(Diamond), 1062608, 2, 1044240);
			AddRes( index, typeof( Sand ), 1044625, 5, 1044627 );
			
			index = AddCraft(typeof(GoldPan), 1044046, "gold pan", 110.0, 120.0, typeof(ValoriteIngot), "Valorite ingot", 5, "You don't have enough Valorite ingots.");
			AddRes(index, typeof(DreadHornMane), "Dread Horn Mane", 1, "You don't have enough Dread Horn Mane.");
			AddRes(index, typeof(EyeOfTheTravesty), "Eye Of The Travesty", 1, "You don't have enough Eye Of The Travesty.");
			AddRes(index, typeof(Muculent), "Muculent", 10, "You don't have enough Muculent.");
			AddRecipe(index, (int) TinkerRecipes.GoldPan );
			SetNeededExpansion(index, Expansion.ML);
			
			index = AddCraft(typeof(PaintingPallete), 1044046, "hand-power miter saw", 25.0, 75.0, typeof(Log), 1044041, 4, 1044351);
			AddRes(index, typeof(SmoothingPlane), "Smoothing Plane", 1, "You don't have a Smoothing Plane.");
			AddRes( index, typeof(Gears), "Gears", 3, "You don't have any gears." );
            ...
            if (Core.ML)
            {
                ...
                index = AddCraft(typeof(HitchingPost2), 1044051, 1071127, 90.0, 160.0, typeof(IronIngot), 1044036, 50, 1044253);
