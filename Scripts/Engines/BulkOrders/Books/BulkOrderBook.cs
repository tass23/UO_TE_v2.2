...
namespace Server.Engines.BulkOrders
{
	public class BulkOrderBook : Item, ISecurable
	{
		...
		public BulkOrderBook() : base( 0x2259 )
		{
			...
			Name = "Blacksmith & Tailor Bulk Order Book";
		...
		{
			if ( dropped is LargeSmithBOD || dropped is LargeTailorBOD || dropped is SmallSmithBOD || dropped is SmallTailorBOD )
			{
			...
			else if ( dropped is LargeFletcherBOD  || dropped is LargeCarpenterBOD || dropped is SmallFletcherBOD  || dropped is SmallCarpenterBOD )
			{
