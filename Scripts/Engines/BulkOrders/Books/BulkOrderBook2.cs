...
namespace Server.Engines.BulkOrders
{
	public class BulkOrderBook2 : Item, ISecurable
	{
		...
		public BulkOrderBook2() : base( 0x2259 )
		{
            ...
            Name = "Carpentry & Fletching Bulk Order Book";
		...
		{
			if ( dropped is LargeFletcherBOD || dropped is LargeCarpenterBOD || dropped is SmallFletcherBOD || dropped is SmallCarpenterBOD )
			{
			...
			else if ( dropped is LargeSmithBOD || dropped is LargeTailorBOD || dropped is SmallSmithBOD || dropped is SmallTailorBOD )
			{
				from.SendMessage ("That bulk order deed does not belong in this book.");
				return false;
			}
			else
			{
