...
namespace Server.Engines.BulkOrders
{
	public class SmallBulkEntry
	{
		...
		#region Custom BODs
		public static SmallBulkEntry[] CarpenterStaff			//Name must match cfg name after #
        {
            get { return GetEntries("Carpenter", "staffs"); }
        }
        public static SmallBulkEntry[] CarpenterAllInstrument
        {
		...
		public static SmallBulkEntry[] Fletchercfbbows
        {
            get { return GetEntries("Fletcher", "cfbbows"); }
        }
		#endregion
