...
namespace Server
{
	...
	{	
		...
		private static void DecorateML_OnCommand( CommandEventArgs e )
		{
			...
			if ( !FindItem( 88, 239, 30, Map.Malas, altar ) )
			{
				altar.MoveToWorld( new Point3D( 89, 237, 26 ), Map.Malas );
				tele = new PeerlessTeleporter( altar );
				tele.PointDest = altar.ExitDest;
				tele.MoveToWorld( new Point3D( 198, 279, 7 ), Map.Malas );
			}
		...
		private static bool m_SithValley;
		...
		public static bool SithValley{ get{ return m_SithValley; } set{ m_SithValley = value; } }
		...
		public static void LoadSettings()
		{
			...
			try
			{
				...
				ReadNode( root, "SithValley", ref m_Sanctuary );
		...
		public static void SaveSetings()
		{
			...
			{	
				...
				UpdateNode( root, "SithValley", m_Sanctuary );
	...
	{	
		public MondainsLegacyGump() : base( 50, 50 )
		{
			...
			AddButton( 20, 285, MondainsLegacy.SithValley ? 0x939 : 0x938, MondainsLegacy.SithValley ? 0x939 : 0x938, 10, GumpButtonType.Reply, 0 );
			AddButton( 20, 310, MondainsLegacy.Spellweaving ? 0x939 : 0x938, MondainsLegacy.Spellweaving ? 0x939 : 0x938, 11, GumpButtonType.Reply, 0 );
			AddButton( 20, 335, MondainsLegacy.PublicDonations ? 0x939 : 0x938, MondainsLegacy.PublicDonations ? 0x939 : 0x938, 12, GumpButtonType.Reply, 0 );
			...
			AddLabel( 45, 281, 0x226, "Sith Valley" );
			AddLabel( 45, 306, 0x226, "Spellweaving" );
			AddLabel( 45, 331, 0x226, "PublicDonations" );
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			switch ( info.ButtonID )
			{
				...
				case 10: MondainsLegacy.SithValley = !MondainsLegacy.SithValley; break;
				case 11: MondainsLegacy.Spellweaving = !MondainsLegacy.Spellweaving; break;
				case 12: MondainsLegacy.PublicDonations = !MondainsLegacy.PublicDonations; break;
			}
