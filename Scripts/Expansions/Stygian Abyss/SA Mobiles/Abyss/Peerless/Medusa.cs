...
namespace Server.Mobiles
{
    ...
    public class Medusa : BaseSABosses, ICarvable
	{
		...
		public override Type[] SharedSAList{ get { return new Type[] { typeof( DemonBridleRing), typeof(PetrifiedSnake), typeof(StoneDragonsTooth), typeof(SummonersKilt), typeof(Venom) }; } }
        ...
        public override void OnDeath(Container c)
        {
            ...
            if ( Utility.RandomDouble() < 0.025 )
            {
                ...
                {
                    case 0: c.DropItem(new MedusaBlood()); break;
                    case 1: c.DropItem(new MedusaStatue()); break;
                }
            }
        }
    ...
    {
        public MedusaClone(Mobile m): base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            SolidHueOverride = 33;
            Clone(m);
        }
        ...
        public MedusaClone(Serial serial): base(serial)
		{
		}
