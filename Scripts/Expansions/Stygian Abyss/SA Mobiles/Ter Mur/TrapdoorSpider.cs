...
namespace Server.Mobiles
{
	...
	public class TrapdoorSpider : BaseCreature
	{
		...
		}//todo: Special abilities. Stealth and summon help
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (Utility.RandomDouble() < 0.25)
            {
                ...
                {
                    case 0: c.DropItem(new BottleIchor()); break;
                    case 1: c.DropItem(new SpiderCarapace()); break;
                    case 2: c.DropItem(new TatteredAncientScroll()); break;
                }
            }
        }
