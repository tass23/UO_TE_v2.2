...
namespace Server.Engines.Craft
{
    public class AlterItem
    {
        ...
        public static void Configure()
        {
            ...
            // Leather Armor
            TypeList.Add(typeof(FemaleLeatherChest), typeof(GargishLeatherChest));
            TypeList.Add(typeof(LeatherShorts), typeof(GargishLeatherKilt));
            TypeList.Add(typeof(LeatherSkirt), typeof(GargishLeatherKilt));
            TypeList.Add(typeof(LeatherBustierArms), typeof(GargishLeatherArms));
