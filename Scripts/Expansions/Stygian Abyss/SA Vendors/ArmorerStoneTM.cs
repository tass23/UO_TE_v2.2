...
{
	public class ArmorerStoneTM : BaseVendor
	{
		...
		[Constructable]
		public ArmorerStoneTM() : base( "the gargish stone armorer" )
		{
		...
		public override void InitSBInfo()
		{
			...
			m_SBInfos.Add( new SBArmorerStoneTM() );
			if ( IsTokunoVendor )
			{
		...
		public ArmorerStoneTM( Serial serial ) : base( serial )
		{
		}
