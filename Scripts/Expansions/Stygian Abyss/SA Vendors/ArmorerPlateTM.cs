...
{
	public class ArmorerPlateTM : BaseVendor
	{
		...
		[Constructable]
		public ArmorerPlateTM() : base( "the gargish plate armorer" )
		{
		...
		public override void InitSBInfo()
		{
			...
			m_SBInfos.Add( new SBArmorerPlateTM() );
			if ( IsTokunoVendor )
			{
		...
		public ArmorerPlateTM( Serial serial ) : base( serial )
		{
		}
