...
{
	public class TailorTM : BaseVendor
	{
		...
		[Constructable]
		public TailorTM() : base( "the Gargish Tailor" )
		{
		...
		public override void InitOutfit()
		{
			...
			Item item = ( new Server.Items.GargishFancyRobe() );
		}
		...
		public TailorTM( Serial serial ) : base( serial )
		{
		}
