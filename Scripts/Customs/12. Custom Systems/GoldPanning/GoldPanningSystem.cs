...
namespace Server.Engines.Harvest
{
	public class GoldPanning : HarvestSystem
	{
        ...
        private GoldPanning()
		{
            ...
            if (Core.ML)
            {
                nugget.BonusResources = new BonusHarvestResource[]
				{
					...
					new BonusHarvestResource( 100, 3.0, 1072562, typeof( BlueDiamond ) ),
					new BonusHarvestResource( 100, 3.0, 1072567, typeof( DarkSapphire ) ),
					new BonusHarvestResource( 100, 3.0, 1072570, typeof( EcruCitrine ) ),
					new BonusHarvestResource( 100, 5.0, 1072564, typeof( FireRuby ) ),
					new BonusHarvestResource( 100, 3.0, 1072566, typeof( PerfectEmerald ) ),
					new BonusHarvestResource( 100, 3.0, 1072568, typeof( Turquoise ) )
				};
            }
		...
		{
			typeof(MidasElemental ),  // put your critters in there
            typeof(MidasElemental )
