...
{
	public class NewHitchingPostSouth3 : AddonComponent
	{
		private int m_Charges;
		private NewHitchingPostSouth3Addon m_Addon;
		...
		#region Constructors
		[Constructable]
		public NewHitchingPostSouth3() : this( 0x14E8 )
		{
		}

		[Constructable]
		public NewHitchingPostSouth3( NewHitchingPostSouth3Addon addon, int charges, int itemID ) : base( itemID )
		{
			m_Charges = charges;
			m_Addon = addon;
		}
		
		public NewHitchingPostSouth3( Serial serial ) : base( serial )
		{
		}
		#endregion
		...
		private class HitchingPostTarget : Target 
      	{ 
         	...
         	private NewHitchingPostSouth3 m_Powder;
			private NewHitchingPostSouth3Addon m_Addon; 

         	public HitchingPostTarget( NewHitchingPostSouth3Addon addon, NewHitchingPostSouth3 charge ) : base ( 10, false, TargetFlags.None ) 
         	{ 
            	m_Powder = charge;
				m_Addon = addon;
         	} 
	...
	public class NewHitchingPostSouth3Addon : BaseAddon
	{
		private int m_Charges;
		...
		public override BaseAddonDeed Deed{ get{ return new NewHitchingPostSouth3Deed( m_Charges ); } }

		[Constructable]
		public NewHitchingPostSouth3Addon( int charges)
		{
			Charges = charges;
			AddComponent( new NewHitchingPostSouth3( this, m_Charges, 0x14E7 ), 0, 0, 0 );
		}

		public NewHitchingPostSouth3Addon( Serial serial ) : base( serial )
		{
		}
	...
	public class NewHitchingPostSouth3Deed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new NewHitchingPostSouth3Addon( m_Charges ); } }
		...
		[Constructable]
		public NewHitchingPostSouth3Deed() : this( 100 )
		{
		}

		[Constructable]
		public NewHitchingPostSouth3Deed( int charges )
		{
			Name = "hitching post south deed";
			Charges = charges;
		}

		public NewHitchingPostSouth3Deed( Serial serial ) : base( serial )
		{
		}
