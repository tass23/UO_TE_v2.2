...
{ 
   	public class ElectricBluePetDye : Item 
   	{ 
    
      		[Constructable] 
      		public ElectricBluePetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
				Hue = 1300;
         		Name="pet dye (Electric Blue)"; 
          	} 

      		public ElectricBluePetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new ElectricBlueDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class ElectricBlueDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private ElectricBluePetDye m_Powder; 

         		public ElectricBlueDyeTarget( ElectricBluePetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
