...
{ 
   	public class ElectricGreenPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public ElectricGreenPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
				Hue = 1391;
         		Name="pet dye (Electric Green)"; 
          	} 

      		public ElectricGreenPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new ElectricGreenDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class ElectricGreenDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private ElectricGreenPetDye m_Powder; 

         		public ElectricGreenDyeTarget( ElectricGreenPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
