...
namespace Server.Items
{
	...
	public class TimedLever : XmlLatch, ILinkable, ITelekinesisable, DIKinesisable, IKinesisable, VKinesisable
	{
		...
		public void OnDKinesis( Mobile from )
		{
			if(from == null || Disabled) return;
		...
		public void OnKinesis( Mobile from )
		{
			if(from == null || Disabled) return;
		...
		public void OnVKinesis( Mobile from )
		{
			if(from == null || Disabled) return;
	...
	public class TimedSwitch : XmlLatch, ILinkable, ITelekinesisable, DIKinesisable, IKinesisable, VKinesisable
	{
	...
	public class TimedSwitchableItem : XmlLatch, ILinkable, ITelekinesisable, DIKinesisable, IKinesisable, VKinesisable
	{
		private int m_SwitchSound = 939;
		private Item m_TargetItem0 = null;
		private string m_TargetProperty0 = null;
