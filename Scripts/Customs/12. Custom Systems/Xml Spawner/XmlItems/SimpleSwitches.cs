...
namespace Server.Items
{
	...
	public class SimpleLever : Item, ILinkable, ITelekinesisable, DIKinesisable, IKinesisable, VKinesisable
	{
	...
	public class SimpleSwitch : Item, ILinkable, ITelekinesisable, DIKinesisable, IKinesisable
	{
