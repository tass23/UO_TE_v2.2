...
{ 
	public class XWorldItemWipeCommand 
	{ 
		public static void Initialize() 
		{ 
			Register( "XClearall", AccessLevel.Administrator, new CommandEventHandler( XClearall_OnCommand ) ); 
		} 
		...
		public static void XClearall_OnCommand( CommandEventArgs e ) 
		{ 
