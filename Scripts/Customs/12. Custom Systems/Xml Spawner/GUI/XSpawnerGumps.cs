...
{
	public class XOptionsGumps
	{
		public XOptionsGumps()
		{
		}

		public static void Initialize() 
		{ 
			CommandSystem.Register( "XGumpSaveRegion", AccessLevel.Administrator, new CommandEventHandler( XOptionsGumps1_OnCommand ) );
			CommandSystem.Register( "XGumpSaveCoordinate", AccessLevel.Administrator, new CommandEventHandler( XOptionsGumps2_OnCommand ) );
			CommandSystem.Register( "XGumpRemoveID", AccessLevel.Administrator, new CommandEventHandler( XOptionsGumps3_OnCommand ) );
			CommandSystem.Register( "XGumpRemoveCoordinate", AccessLevel.Administrator, new CommandEventHandler( XOptionsGumps4_OnCommand ) );
			CommandSystem.Register( "XGumpRemoveRegion", AccessLevel.Administrator, new CommandEventHandler( XOptionsGumps5_OnCommand ) );
		}

		[Usage( "[XGumpSaveRegion" )]
		[Description( "Gump to Save inside Region" )] 
		private static void XOptionsGumps1_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new XGumpSaveRegion( e ) );
		}

		[Usage( "[XGumpSaveCoordinate" )]
		[Description( "Gump to save by coordinates" )] 
		private static void XOptionsGumps2_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new XGumpSaveCoordinate( e ) );
		}

		[Usage( "[XGumpRemoveID" )]
		[Description( "Gump to remove by ID" )] 
		private static void XOptionsGumps3_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new XGumpRemoveID( e ) );
		}

		[Usage( "[XGumpRemoveCoordinate" )]
		[Description( "Gump to remove by coordinates" )] 
		private static void XOptionsGumps4_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new XGumpRemoveCoordinate( e ) );
		}

		[Usage( "[XGumpRemoveRegion" )]
		[Description( "Gump to remove inside region" )] 
		private static void XOptionsGumps5_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new XGumpRemoveRegion( e ) );
		}
	}
}
...
{
	public class XGumpSaveRegion : Gump
	{
		private CommandEventArgs m_CommandEventArgs;

		public XGumpSaveRegion( CommandEventArgs e ) : base( 50,50 )
		{
			...
			switch ( info.ButtonID )
			{
				...
				case 101:
				{
					...
					else
					{
						...
						string prefix = Server.Commands.CommandSystem.Prefix;
						CommandSystem.Handle( from, String.Format( "{0}XGumpSaveRegion", prefix ) );
					}
					break;
				}
			}
	...
	public class XGumpRemoveRegion : Gump
	{
		private CommandEventArgs m_CommandEventArgs;

		public XGumpRemoveRegion( CommandEventArgs e ) : base( 50,50 )
		{
			m_CommandEventArgs = e;
			Closable = true;
			Dragable = true;
			...
			switch ( info.ButtonID )
			{
				...
				case 101:
				{
					...
					else
					{
						from.SendMessage( "You must specify a region!" );
						string prefix = Server.Commands.CommandSystem.Prefix;
						CommandSystem.Handle( from, String.Format( "{0}XGumpRemoveRegion", prefix ) );
					}
					break;
				}
			}
	...
	public class XGumpRemoveID : Gump
	{
		private CommandEventArgs m_CommandEventArgs;

		public XGumpRemoveID( CommandEventArgs e ) : base( 50,50 )
		{
			m_CommandEventArgs = e;
			Closable = true;
			Dragable = true;
				...
				case 101:
				{
					...
					if( sID != "" )
					{
						...
						catch
						{
							...
							string prefix = Server.Commands.CommandSystem.Prefix;
							CommandSystem.Handle( from, String.Format( "{0}XGumpRemoveID", prefix ) );
						}
					}
	...
	public class XGumpSaveCoordinate : Gump
	{
		private CommandEventArgs m_CommandEventArgs;

		public XGumpSaveCoordinate( CommandEventArgs e ) : base( 50,50 )
		{
			m_CommandEventArgs = e;
			Closable = true;
			Dragable = true;
				...
				case 101:
				{
					...
					if( sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "" )
					{
						...
						catch
						{
							...
							string prefix = Server.Commands.CommandSystem.Prefix;
							CommandSystem.Handle( from, String.Format( "{0}XGumpSaveCoordinate", prefix ) );
						}
					}
	...
	public class XGumpRemoveCoordinate : Gump
	{
		private CommandEventArgs m_CommandEventArgs;

		public XGumpRemoveCoordinate( CommandEventArgs e ) : base( 50,50 )
		{
			m_CommandEventArgs = e;
			Closable = true;
			Dragable = true;
				...
				case 101:
				{
					...
					if( sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "" )
					{
						...
						catch
						{
							from.SendMessage( "Coordinates must be numbers!" );
							string prefix = Server.Commands.CommandSystem.Prefix;
							CommandSystem.Handle( from, String.Format( "{0}XGumpRemoveCoordinate", prefix ) );
						}
					}
