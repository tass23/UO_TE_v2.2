...
{
    public class XmlUse2 : XmlAttachment
    {
        ...
        [Attachable]
        public XmlUse2(int maxuses)
        {
            MaxUses = maxuses;
        }

        [Attachable]
        public XmlUse2(int maxuses, double refractory)
        {
            MaxUses = maxuses;
        ...
        public class XmlUse2Target : Target
        {
            private object m_objectused;
            private XmlUse2 m_xa;

            public XmlUse2Target(int range, object objectused, XmlUse2 xa)
        ...
        private void TryToTarget(Mobile from, object target, XmlUse2 xa)
        {
            if (from == null) return;
            ...
            if (xa != null)
            {
                from.Target = new XmlUse2Target(xa.MaxTargetRange, target, xa);
            }
        }
