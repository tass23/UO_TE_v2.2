...
{
    public class XmlUse1 : XmlAttachment
    {
        ...
        [Attachable]
        public XmlUse1(int maxuses)
        {
            MaxUses = maxuses;
        }

        [Attachable]
        public XmlUse1(int maxuses, double refractory)
        {
            MaxUses = maxuses;
        ...
        public class XmlUse1Target : Target
        {
            private object m_objectused;
            private XmlUse1 m_xa;

            public XmlUse1Target(int range, object objectused, XmlUse1 xa)
        ...
        private void TryToTarget(Mobile from, object target, XmlUse1 xa)
        {
            if (from == null) return;
            ...
            if (xa != null)
            {
                from.Target = new XmlUse1Target(xa.MaxTargetRange, target, xa);
            }
        }
