...
namespace Server.Mobiles
{
    public class HelpGump : Gump
    {
		...
		private const int HtmlColor = 0x000000;

		private static string[] Xmlhelp = new string[]
		{
			"spawntype[,arg1,arg2,...]",	"SET[,itemname or serialno][,itemtype]/property/value/...",
			"SETVAR,varname/value",	"SETONMOB,mobname[,mobtype]/property/value/...",
			"SETONTRIGMOB/property/value/...",	"SETONTHIS/property/value/..."
		};
            ...
            : base(X, Y)
        {
            ...
            AddBackground(20, 0, width, 490, 5150);	//AddBackground(20, 0, width, 480, 5054);

            AddPage(1);
            //AddAlphaRegion( 20, 0, 220, 554 );
            //AddImageTiled(37, 24, 636, 431, 9504); //AddImageTiled(20, 0, width, 480, 0x52);
            //AddImageTiled( 24, 6, 213, 261, 0xBBC );

            AddLabel(60, 2, 0x384, "Standalone Keywords");	//AddLabel(27, 2, 0x384, "Standalone Keywords");
			AddHtmlLocalized(45, 30, width - 50, 430, 3010198, HtmlColor, false, false );
            /*AddHtml(45, 30, width - 50, 420,	//AddHtml(25, 20, width - 10, 440,                
				"spawntype[,arg1,arg2,...]\n" +
                "SET[,itemname or serialno][,itemtype]/property/value/...\n" +
                "SETVAR,varname/value\n" +
				"SETACCOUNTTAG,varname/value\n" +
                ...
                false, true); */
            AddButton(width - 40, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 2);
            AddLabel(width - 50, 2, 0x384, "1");
            AddButton(width - 70, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 5);

            AddPage(2);
            AddLabel(60, 2, 0x384, "Value and Itemtype Keywords");	//AddLabel(27, 2, 0x384, "Value and Itemtype Keywords");
			AddHtmlLocalized(45, 30, width - 50, 430, 3010199, HtmlColor, false, false );
            /*AddHtml(45, 20, width - 40, 440,	//AddHtml(25, 20, width - 10, 440,
                "property/@value\n" +
				...
				"PEFFECT,itemid,duration[,x,y,z]\n" +
				"BOLTEFFECT[,soundid[,hue]]\n" +
                "POISON,level[,range][,playeronly]\n" +
                "DAMAGE,dmg,phys,fire,cold,pois,energy[,range][,playeronly]\n" +
                ...
                false, true); */
            AddButton(width - 40, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 3);
            AddLabel(width - 50, 2, 0x384, "2");
            AddButton(width - 70, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 1);

            AddPage(3);
            AddLabel(60, 2, 0x384, "[ Commands");	//AddLabel(27, 2, 0x384, "[ Commands");
			AddHtmlLocalized(45, 30, width - 50, 430, 3010200, HtmlColor, false, false );
            /*AddHtml(45, 20, width - 40, 440,	//AddHtml(25, 20, width - 10, 440,
                "XmlAdd [-defaults]\n" +
                "XmlShow\n" +
                "XmlHide\n" +
            ...
            AddButton(width - 40, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 4);
            AddLabel(width - 50, 2, 0x384, "3");
            AddButton(width - 70, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 2);

            AddPage(4);
            AddLabel(60, 2, 0x384, "Quest Types");	//AddLabel(27, 2, 0x384, "Quest types");
			AddHtmlLocalized(45, 30, width - 50, 190, 3010201, HtmlColor, false, false );
            /*AddHtml(45, 20, width - 40, 180,	//AddHtml(25, 20, width - 10, 180,
            ...
            AddLabel(60, 200, 0x384, "Trigger/NoTriggerOnCarried");		//AddLabel(27, 200, 0x384, "Trigger/NoTriggerOnCarried");
			AddHtmlLocalized(45, 220, width - 50, 60, 3010202, HtmlColor, false, false );
			/*AddHtml(45, 220, width - 40, 50,		//AddHtml(25, 220, width - 10, 50,
                "ATTACHMENT,name,type\n" +
                "itemname[,type][,EQUIPPED][,objective#,objective#,...]\n",
                false, false); */

            AddLabel(60, 300, 0x384, "GUMPITEMS");		//AddLabel(27, 300, 0x384, "GUMPITEMS");
			AddHtmlLocalized(45, 320, width - 50, 150, 3010203, HtmlColor, false, false );
            /*AddHtml(45, 320, width - 40, 150,		//AddHtml(25, 320, width - 10, 150,
                "BUTTON,gumpid,x,y\n" +
            ...
            AddButton(width - 40, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 5);
            AddLabel(width - 50, 2, 0x384, "4");
            AddButton(width - 70, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 3);
			
			#region UO-The Expanse
			AddPage(5);
            AddLabel(60, 2, 0x384, "Attachments");
			AddHtmlLocalized(45, 30, width - 50, 430, 3010204, HtmlColor, false, false );
			/*AddHtml(45, 20, width - 40, 180,
                "XmlAddFame,value\n" +
                "XmlAddKarma,value\n" +
                "XmlAddTithing,value\n" +
                "XmlAddVirtue,value,virtue\n" +
                "XmlCustomData,string\n" +
                "XmlData,name,string\n" +
                "XmlDate,name,DateTime.Now\n" +
				"XmlDeathAction,action\n" +
				"XmlDex,value,[duration]\n" +
				"XmlDialog-[see XmlQuestNPC]\n" +
				"XmlEnemyMastery,enemy,[value-inc],[chance],[expiresin]\n" +
				"XmlFire,value,[expires],[refract]\n" +
				"XmlFreeze,value-expires\n" +
				"XmlHue,value,value-expires\n" +
				"XmlInt,value,[duration]\n" +
				"XmlDrain,value,[expires],[refract]\n" +
				"XmlLightning,value,[expires],[refract]\n" +
				"XmlLocalVariable,name,[data-string],[expiresin]\n" +
				"XmlMagicWord,word,word,[duration],[refract],[charges]\n" +
				"XmlManaDrain,value,[expiresin],[refract]\n" +
				"XmlMessage,message,[word],[refract],[charges]\n" +
				"XmlMinionStrike,minion,[chance],[expiresin],[refract]\n" +
				"XmlMorph,value,[duration],[word]\n" +
				"XmlPoints-[see XmlPvPSystems]\n" +
				"XmlSaveItem,name,itemname,ownedby\n" +
				"XmlSkill,name,skillname,value,[duration]\n" +
				"XmlSound,soundID,[word],[refract],[charges]\n" +
				"XmlStamDrain,value,[expiresin],[refract]\n" +
				"XmlStr,value,[duration]\n"+
				"XmlTitle,name,title,[duration]\n"+
				"XmlUse,maxuses,[refract]\n"+
				"XmlValue,name,value,[expiresin]\n"+
				"XmlWeaponAbility,name,weaponability,[expiresin]\n",
                false, false); */

            AddButton(width - 40, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 1);
            AddLabel(width - 50, 2, 0x384, "5");
            AddButton(width - 70, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 4);
			#endregion
        }
    }
                ...
                case 1: // Help
                    {
                        ...
                        state.Mobile.SendGump(new HelpGump(/*m_Spawner, this,*/ this.X + 290, this.Y)); //UO-The Expanse: this allows the gump to be called from anywhere
                        break;
                    }
