...
namespace Server.Engines.XmlSpawner2
{
	public class XmlSiege : XmlAttachment
	{
		...
		public virtual int DamagedItemEffectDuration { get { return 0; } }
		...
		private int m_DestroyedItemID = 0;	// itemid used when hits go to zero. 2322=dirt patch, 10984 pulsing pool.  Specifying a value of zero will cause the object to be permanently destroyed.
