            ...
            if (IsTypeKeyword(typeName))
            {
                ...
                switch (kw)
                {
                    ...
                    case typeKeyword.SETONTHIS:
                        {
                            // the syntax is SETONTHIS,[proptest=value]/prop/value/prop2/value...
                            ...
                            if (invoker != null && (proptest == null || CheckPropertyString(null, invoker, proptest, null, out status_str)))
                            {
                                ...
                                ApplyObjectStringProperties(spawner, substitutedtypeName, invoker, triggermob, proptest, out status_str);
                            }
