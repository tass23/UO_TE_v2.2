	...
	public class XmlFindGump : Gump
	{
			...
			: base(X, Y)
		{
			...
			if (m_ShowExtension)
			{
				...
				AddLabel(525, 5, 0x384, "Location");
				AddLabel(619, 5, 0x384, "Map");
				AddLabel(667, 5, 0x384, "Owner");
				...
				for (int i = 0; i < MaxEntries; i++)
				{
					...
					else if (mapstr == "Trammel")
					{
						mapstr = "Tram";
					}
					else if (mapstr == "Tokuno")
					{
						mapstr = "Tok";
					}
					else if (mapstr == "Ilshenar")
					{
						mapstr = "Ilsh";
					}
					else if (mapstr == "TerMur")
					{
						mapstr = "Ter";
					}
					else if (mapstr == "Malas")
					{
						mapstr = "Mal";
					}
					else
					...
					// display the name
					AddLabelCropped(248, 22 * (i % MaxEntriesPerPage) + 31, 150, 21, texthue, namestr);
					...
					// display the type
					AddImageTiled(410, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, 0xBBC);
					AddLabelCropped(410, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, texthue, typestr);
					// display the loc
					AddImageTiled(500, 22 * (i % MaxEntriesPerPage) + 31, 137, 21, 0xBBC);
					AddLabel(500, 22 * (i % MaxEntriesPerPage) + 31, texthue, locstr);
					// display the map
					AddImageTiled(615, 22 * (i % MaxEntriesPerPage) + 31, 30, 21, 0xBBC);
					AddLabel(615, 22 * (i % MaxEntriesPerPage) + 31, texthue, mapstr);
					// display the owner
					AddImageTiled(645, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, 0xBBC);
					AddLabelCropped(647, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, texthue, ownstr);
