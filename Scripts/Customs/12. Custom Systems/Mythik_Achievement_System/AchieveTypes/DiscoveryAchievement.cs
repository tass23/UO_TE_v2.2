...
namespace Scripts.Mythik.Systems.Achievements
{
    public class DiscoveryAchievement : BaseAchievement
    {
        ...
        {
            if (e == null || e.OldRegion == null || e.From == null || e.NewRegion.Name == null)	//if (e == null || e.Region == null || e.From == null || e.Region.Name == null)
                return;
            var player = e.From as PlayerMobile;
            if (e.NewRegion.Name.Contains(m_Region) && player != null)	//if (e.Region.Name.Contains(m_Region) && player != null)
            {
