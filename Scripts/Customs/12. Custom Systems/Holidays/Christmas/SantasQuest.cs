...
namespace Server.Engines.Quests
{
	public class SantasQuest : BaseQuest
	{
		...
		{ 
			...
			{ 
				return 
					...
					"You look trustworthy and I am sure you would not peek inside any of those gifts. Would you??<BR><BR>" +
		...
		public override object Refuse{ get{ return "<I>*sigh*</I> I understand. But I do not think all the children will."; } }
		...
		{ get
			{ 
				return 
					...
					"Thank you for your tremendous help! Now children everywhere will be able to have a wonderful holiday!<BR><BR>" +
		...
		{					
			AddObjective( new ObtainObjective( typeof( PlayerGiftBox ), "Lost Christmas Present", 10, 0x232A ) );	
