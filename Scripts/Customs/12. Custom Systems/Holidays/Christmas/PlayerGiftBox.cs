...
namespace Server.Items
{
	...
	public class PlayerGiftBox : Container, IChopable
	{
		public override int DefaultMaxWeight{ get{ return 0; } } // A value of 0 signals unlimited weight
	 	
	 	public override bool TryDropItem( Mobile from, Item dropped, bool sendFullMessage )
		{
			from.SendMessage("This is one of Santas' Lost Presents! You cannot add things to his gifts!");
				return false;
		...
		{
			from.SendMessage("This is one of Santas' Lost Presents! You should not open someone else's gift!");
		}
		
		[Constructable]
		public PlayerGiftBox() : base(0x232A)
		{
			Weight = 1.0;
		...
		public void OnChop( Mobile from )
		{
			...
			{
				from.SendMessage( "That Christmas Present must be in your backpack IF you are going to open it." );
			}
		}
		...
		private void Chop( Mobile from )
		{
			...
			switch (Utility.Random(12))  //picks one of the following
                {
                    case 0:
                        from.AddToBackpack( new HolidayGarland() ); break;
                    case 1:
                    ...
                    case 6:
                        from.AddToBackpack( new HolidayBaubles() ); break;
                    case 7:
		...
		public PlayerGiftBox( Serial serial ) : base( serial )
		{
		}
