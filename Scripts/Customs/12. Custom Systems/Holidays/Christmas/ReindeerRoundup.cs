...
{	
	...
	{					
		...
		public override object Refuse{ get{ return "I guess I will continue looking for the lost presents."; } }
		...
		{								
			...
			AddReward( new BaseReward( typeof( PlayerGiftBox ), "A Lost Present" ) );
		}		
