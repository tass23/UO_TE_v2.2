...
{
	public class RainbowHordeBeastCostume : Item
	{

		[Constructable]
		public RainbowHordeBeastCostume() : base( 0x2684 )
		{
                        Name = "Rainbow Horde Beast Costume";
		...
		public RainbowHordeBeastCostume( Serial serial ) : base( serial )
		{
		}
