...
{
	public class GiantBlackWidowCostume : Item
	{

		[Constructable]
		public GiantBlackWidowCostume() : base( 0x2684 )
		{
                        Name = "Giant Black Widow Costume";
		...
		public GiantBlackWidowCostume( Serial serial ) : base( serial )
		{
		}
