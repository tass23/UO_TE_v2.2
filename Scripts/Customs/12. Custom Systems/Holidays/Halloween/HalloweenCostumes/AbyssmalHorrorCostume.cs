...
{
    public class AbyssmalHorrorCostume : Item
    {
        [Constructable]
        public AbyssmalHorrorCostume() : base( 0x2684 )
        {
            Name = "Abyssmal Horror Costume";
            Hue = 43;
            Layer = Layer.OuterTorso;
            ItemID = 0x2684;
            Weight = 3.0;
        }
        public AbyssmalHorrorCostume( Serial serial ) : base( serial )
        {
        }
