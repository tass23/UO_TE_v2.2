...
{
	public class WandererOfTheVoidCostume : Item
	{

		[Constructable]
		public WandererOfTheVoidCostume() : base( 0x2684 )
		{
                        Name = "Wanderer Of The Void Costume";
		...
		public WandererOfTheVoidCostume( Serial serial ) : base( serial )
		{
		}
