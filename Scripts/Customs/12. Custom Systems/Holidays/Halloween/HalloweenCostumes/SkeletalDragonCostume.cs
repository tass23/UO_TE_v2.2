...
{
	public class SkeletalDragonCostume : Item
	{

		[Constructable]
		public SkeletalDragonCostume() : base( 0x2684 )
		{
                        Name = "Skeletal Dragon Costume";
		...
		public SkeletalDragonCostume( Serial serial ) : base( serial )
		{
		}
