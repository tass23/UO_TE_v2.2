...
{
	public class ShadowKnightCostume : Item
	{

		[Constructable]
		public ShadowKnightCostume() : base( 0x2684 )
		{
                        Name = "Shadow Knight Costume";
		...
		public ShadowKnightCostume( Serial serial ) : base( serial )
		{
		}
