...
{
	public class TrickOrTreatBag2013 : BaseContainer, IDyable
	{
		private int m_Uses;
		...
		[Constructable]
		public TrickOrTreatBag2013() : base( 0xE76 )
		{
			Weight = 2.0;
			Name = "Trick or Treat 2013";
			Hue = 43;
			
			Uses = 31;
			
			AddItem( new TrickOrTreatBook2013() );
		}

		public TrickOrTreatBag2013( Serial serial ) : base( serial )
		{
		}
