...
{  
	public class HalloweenBagFilled2 : Bag
	{
		[Constructable]
		public HalloweenBagFilled2()
		{
		...
		[Constructable]
		public HalloweenBagFilled2(int amount)
		{
		}
		...
		public HalloweenBagFilled2(Serial serial) : base( serial )
		{
		}
