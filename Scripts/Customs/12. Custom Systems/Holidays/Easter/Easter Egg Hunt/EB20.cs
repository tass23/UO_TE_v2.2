...
namespace Server.Items
{
	...
	public class EB20 : Item
	{
		...
		[Constructable]
		public EB20() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #20";
		}

		public EB20( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs20() );
			from.CloseGump( typeof(EB20Gump) );
			from.SendGump( new EB20Gump( from, MaxDonations ) );
		}
	...
	public class EB20Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB20Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #20");
			// Initializing Background
			...
			temp += "You have found a Quest Easter Backet! A Quest Egg has been placed in your backpack.<br><br>";
			temp += "The Egg will give you a clue to the Final Easter Basket!<Br><Br>";
