...
namespace Server.Items
{
	...
	public class EB3 : Item
	{
		...
		public EB3( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs3() );
			from.CloseGump( typeof(EB3Gump) );
			from.SendGump( new EB3Gump( from, MaxDonations ) );
		}
	...
	public class EB3Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB3Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #3");
			// Initializing Background
