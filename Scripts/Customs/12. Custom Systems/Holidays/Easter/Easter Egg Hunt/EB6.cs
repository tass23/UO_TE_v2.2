...
namespace Server.Items
{
	...
	public class EB6 : Item
	{
		...
		[Constructable]
		public EB6() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #6";
		}

		public EB6( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs6() );
			from.CloseGump( typeof(EB6Gump) );
			from.SendGump( new EB6Gump( from, MaxDonations ) );
		}
	...
	public class EB6Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB6Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #6");
			// Initializing Background
