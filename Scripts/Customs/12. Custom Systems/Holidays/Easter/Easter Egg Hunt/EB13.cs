...
namespace Server.Items
{
	...
	public class EB13 : Item
	{
		...
		[Constructable]
		public EB13() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #13";
		}

		public EB13( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs13() );
			from.CloseGump( typeof(EB13Gump) );
			from.SendGump( new EB13Gump( from, MaxDonations ) );
		}
	...
	public class EB13Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB13Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #13");
			// Initializing Background
