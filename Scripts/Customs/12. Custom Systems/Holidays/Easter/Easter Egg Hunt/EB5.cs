...
namespace Server.Items
{
	...
	public class EB5 : Item
	{
		...
		[Constructable]
		public EB5() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #5";
		}

		public EB5( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs5() );
			from.CloseGump( typeof(EB5Gump) );
			from.SendGump( new EB5Gump( from, MaxDonations ) );
		}
	...
	public class EB5Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB5Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #5");
			// Initializing Background
