...
namespace Server.Items
{
	...
	public class EB15 : Item
	{
		...
		[Constructable]
		public EB15() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #15";
		}

		public EB15( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs15() );
			from.CloseGump( typeof(EB15Gump) );
			from.SendGump( new EB15Gump( from, MaxDonations ) );
		}
	...
	public class EB15Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB15Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #15");
			// Initializing Background
