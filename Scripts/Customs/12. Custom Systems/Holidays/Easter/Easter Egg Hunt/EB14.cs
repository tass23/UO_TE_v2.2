...
namespace Server.Items
{
	...
	public class EB14 : Item
	{
		...
		[Constructable]
		public EB14() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #14";
		}

		public EB14( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs14() );
			from.CloseGump( typeof(EB14Gump) );
			from.SendGump( new EB14Gump( from, MaxDonations ) );
		}
	...
	public class EB14Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB14Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #14");
			// Initializing Background
