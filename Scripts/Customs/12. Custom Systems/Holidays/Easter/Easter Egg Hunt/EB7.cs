...
namespace Server.Items
{
	...
	public class EB7 : Item
	{
		...
		[Constructable]
		public EB7() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #7";
		}

		public EB7( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs7() );
			from.CloseGump( typeof(EB7Gump) );
			from.SendGump( new EB7Gump( from, MaxDonations ) );
		}
	...
	public class EB7Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB7Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #7");
			// Initializing Background
