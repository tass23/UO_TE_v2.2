...
namespace Server.Items
{
	...
	public class EB18 : Item
	{
		...
		[Constructable]
		public EB18() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #18";
		}

		public EB18( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs18() );
			from.CloseGump( typeof(EB18Gump) );
			from.SendGump( new EB18Gump( from, MaxDonations ) );
		}
	...
	public class EB18Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB18Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #18");
			// Initializing Background
