...
namespace Server.Items
{
	...
	public class EB17 : Item
	{
		...
		[Constructable]
		public EB17() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #17";
		}

		public EB17( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs17() );
			from.CloseGump( typeof(EB17Gump) );
			from.SendGump( new EB17Gump( from, MaxDonations ) );
		}
	...
	public class EB17Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB17Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #17");
			// Initializing Background
