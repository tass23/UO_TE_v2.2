...
namespace Server.Items
{
	...
	public class EB11 : Item
	{
		...
		[Constructable]
		public EB11() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #11";
		}

		public EB11( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs11() );
			from.AddToBackpack( new Bunny1() );
			from.CloseGump( typeof(EB11Gump) );
			from.SendGump( new EB11Gump( from, MaxDonations ) );
		}
	...
	public class EB11Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB11Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #11");
			// Initializing Background
			...
			temp += "You have Completed Level 1 of the Easter Quest! <br><br>";
			temp += "Message Staff if you have all 1-10 Eggs so they can post your time.<Br><Br>";
			temp += "A new Quest Egg for Level 2 has been placed in your backpack.<br><br>";
