...
namespace Server.Items
{
	...
	public class EB4 : Item
	{
		...
		public EB4( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs4() );
			from.CloseGump( typeof(EB4Gump) );
			from.SendGump( new EB4Gump( from, MaxDonations ) );
		}
	...
	public class EB4Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB4Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #4");
			// Initializing Background
