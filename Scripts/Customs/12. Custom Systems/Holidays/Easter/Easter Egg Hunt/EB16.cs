...
namespace Server.Items
{
	...
	public class EB16 : Item
	{
		...
		[Constructable]
		public EB16() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #16";
		}

		public EB16( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs16() );
			from.AddToBackpack( new Bunny2() );
			from.CloseGump( typeof(EB16Gump) );
			from.SendGump( new EB16Gump( from, MaxDonations ) );
		}
	...
	public class EB16Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB16Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #16");
			// Initializing Background
			...
			temp += "You have completed Level 2 of the Easter Quest!<br><br>";
			temp += "Message Staff if you have all 1-15 Eggs so they can post your time.<Br><Br>";
			temp += "A new Quest Egg for Level 3 has been placed in your Backpack.<br><br>";
