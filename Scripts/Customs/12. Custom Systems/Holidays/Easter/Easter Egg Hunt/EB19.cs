...
namespace Server.Items
{
	...
	public class EB19 : Item
	{
		...
		[Constructable]
		public EB19() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #19";
		}

		public EB19( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs19() );
			from.CloseGump( typeof(EB19Gump) );
			from.SendGump( new EB19Gump( from, MaxDonations ) );
		}
	...
	public class EB19Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB19Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #19");
			// Initializing Background
