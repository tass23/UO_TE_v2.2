...
namespace Server.Items
{
	...
	public class EB8 : Item
	{
		...
		[Constructable]
		public EB8() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #8";
		}

		public EB8( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs8() );
			from.CloseGump( typeof(EB8Gump) );
			from.SendGump( new EB8Gump( from, MaxDonations ) );
		}
	...
	public class EB8Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB8Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #8");
			// Initializing Background
