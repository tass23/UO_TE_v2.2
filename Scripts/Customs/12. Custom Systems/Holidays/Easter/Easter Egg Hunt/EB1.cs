...
namespace Server.Items
{
	...
	public class EB1 : Item
	{
		...
		public EB1( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs1() );
			from.CloseGump( typeof(EB1Gump) );
			from.SendGump( new EB1Gump( from, MaxDonations ) );
		}
	...
	public class EB1Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB1Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #1");
			// Initializing Background
