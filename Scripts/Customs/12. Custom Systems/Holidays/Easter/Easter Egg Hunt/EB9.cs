...
namespace Server.Items
{
	...
	public class EB9 : Item
	{
		...
		[Constructable]
		public EB9() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #9";
		}

		public EB9( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs9() );
			from.CloseGump( typeof( EB9Gump ) );
			from.SendGump( new EB9Gump( from, MaxDonations ) );
		}
	...
	public class EB9Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB9Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #9");
			// Initializing Background
