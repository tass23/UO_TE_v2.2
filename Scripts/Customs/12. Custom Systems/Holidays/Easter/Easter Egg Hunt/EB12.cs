...
namespace Server.Items
{
	...
	public class EB12 : Item
	{
		...
		[Constructable]
		public EB12() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #12";
		}

		public EB12( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs12() );
			from.CloseGump( typeof(EB12Gump) );
			from.SendGump( new EB12Gump( from, MaxDonations ) );
		}
	...
	public class EB12Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB12Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #12");
			// Initializing Background
