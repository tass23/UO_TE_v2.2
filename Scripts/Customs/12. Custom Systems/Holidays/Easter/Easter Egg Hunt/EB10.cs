...
namespace Server.Items
{
	...
	public class EB10 : Item
	{
		...
		[Constructable]
		public EB10() : base( 9434 )
		{
			Hue = 1356;//golden
			Movable = false;
			Name = "Easter Basket #10";
		}

		public EB10( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick(Mobile from )
		{
			...
			//show gump
			from.AddToBackpack( new Eggs10() );
			from.CloseGump( typeof(EB10Gump) );
			from.SendGump( new EB10Gump( from, MaxDonations ) );
		}
	...
	public class EB10Gump : Gump 
	{
		private Mobile m_from;
		private int m_max;

		public EB10Gump( Mobile from, int max ) : base(50, 50) 
		{
			m_from = from;
			m_max = max;
			this.InitializeGump();
		...
		public virtual void InitializeGump() 
		{
			...
			// Initializing Label
			this.AddLabel(90, 19, 255, "Easter Basket #10");
			// Initializing Background
