...
namespace Server.ACC.CSS
{
    public abstract class CSpellbookGump : Gump
    {
            ...
            : base(50, 100)
        {
            ...
            */
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                AddImage(100, 100, BGImage);
				AddButton(450, 140, 2643, 2643, 11, GumpButtonType.Reply, 0); //Master crafting right button
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
			...
			{
				//state.Mobile.CloseGump(typeof(CSpellbookGump));	//Add Master Craft Menu to select specific crafting menu.
