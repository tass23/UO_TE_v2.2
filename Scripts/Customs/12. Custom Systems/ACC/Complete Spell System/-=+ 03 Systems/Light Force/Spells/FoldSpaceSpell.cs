...
{
	public class FoldSpaceSpell : LightForceSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		"Fold Space", "A Jedi seeks not vengeance.",
		//SpellCircle.Fourth,
		239,
		9031,
		...
		public FoldSpaceSpell( Mobile caster, Item scroll ) : this( caster, scroll, null, null )
		{
		}

		public FoldSpaceSpell( Mobile caster, Item scroll, RunebookEntry entry, Runebook book ) : base( caster, scroll, m_Info )
		{
			m_Entry = entry;
			m_Book = book;
		}
		...
		{
			private FoldSpaceSpell m_Owner;

			public InternalTarget( FoldSpaceSpell owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
