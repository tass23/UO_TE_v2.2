...
{
	public class ForceWeaponSpell : LightForceSpell
	{
		public static bool SkillLock = true;
		private static SpellInfo m_Info = new SpellInfo(
		"Force Weapon", "The Crystal, the Blade, the Jedi, we are one.",
		-1,
		9002,
		Reagent.Garlic,
		Reagent.BlackPearl
		...
		public ForceWeaponSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
