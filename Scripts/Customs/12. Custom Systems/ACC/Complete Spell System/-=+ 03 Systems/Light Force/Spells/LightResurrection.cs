...
{
	public class LightResurrectionSpell : LightForceSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"Force Revival", "The Force can reverse death.",
				245,
				9032,
		...
		public LightResurrectionSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private LightResurrectionSpell m_Owner;

			public InternalTarget( LightResurrectionSpell owner ) : base( 1, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			}
