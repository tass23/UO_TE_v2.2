...
{
	public class CleanseSpell : LightForceSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		"Cleanse", "There is no death, there is the Force.",
		//SpellCircle.Second,
		212,
		9041,
		...
		public CleanseSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private CleanseSpell m_Owner;

			public InternalTarget( CleanseSpell owner ) : base( 12, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			}
