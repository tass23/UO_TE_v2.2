...
{
	public class DarkCurseSpell : DarkForceSpell
	{
		...
		public DarkCurseSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private DarkCurseSpell m_Owner;

			public InternalTarget( DarkCurseSpell owner ) : base( Core.ML? 10 : 12, false, TargetFlags.Harmful )
			{
				m_Owner = owner;
			}
