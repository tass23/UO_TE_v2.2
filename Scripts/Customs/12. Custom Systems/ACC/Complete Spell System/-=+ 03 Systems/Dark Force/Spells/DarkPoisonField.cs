...
{
	public class DarkPoisonField : DarkForceSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
			"Force Toxin", "The Dark Side kills quickly.",
			230,
			9052,
			false,
			Reagent.BatWing,
		...
		public DarkPoisonField( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private DarkPoisonField m_Owner;

			public InternalTarget( DarkPoisonField owner ) : base( Core.ML ? 10 : 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
