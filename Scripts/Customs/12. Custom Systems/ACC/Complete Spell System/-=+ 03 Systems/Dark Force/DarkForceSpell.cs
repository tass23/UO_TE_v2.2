...
{
	public abstract class DarkForceSpell : CSpell
	{
		public DarkForceSpell( Mobile caster, Item scroll, SpellInfo info ) : base( caster, scroll, info )
		{
		}
        ...
        public static int ComputePowerValue(Mobile from, int div)
        {
            ...
            int v = (int)Math.Sqrt(from.Karma + 20000 + (from.Skills.Magery.Fixed * 50));
