...
{
	public abstract class MysticismForm : MysticismSpell, ITransformationSpell
	{
		...
		public MysticismForm( Mobile caster, Item scroll, SpellInfo info ) : base( caster, scroll, info )
		{
