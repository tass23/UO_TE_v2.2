...
{
	public abstract class WerewolfSpell : CSpell
	{
		public WerewolfSpell( Mobile caster, Item scroll, SpellInfo info ) : base( caster, scroll, info )
		{
		}
        ...
        public static int ComputePowerValue(Mobile from, int div)
        {
            ...
            int v = (int)Math.Sqrt(from.Karma + 20000 + (from.Skills.Anatomy.Fixed * 50));
