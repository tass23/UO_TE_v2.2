...
{
	public class WStrengthSpell : WerewolfSpell
	{
		...
		public WStrengthSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
				...
				m.SendMessage( "You body is filled with a rabid fever." );
				...
				BuffInfo.AddBuff( m, new BuffInfo( BuffIcon.Strength, 1122608, length, m, percentage.ToString() ) );
		...
		{
			private WStrengthSpell m_Owner;

			public InternalTarget( WStrengthSpell owner ) : base( Core.ML ? 10 : 12, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			} 
