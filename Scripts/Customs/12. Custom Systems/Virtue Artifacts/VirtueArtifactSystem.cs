...
namespace Server.Misc
{
    public class VirtueArtifactSystem
    {
        ...
        public static void HandleKill(Mobile victim, Mobile killer)
        {
            ...
            const double A = 0.000115829210; // Lower this number to lower chance.  Raise it to raise chance.  Currently it's 1/4 of Treasures of Tokuno drop. Default: 0.000215829210
