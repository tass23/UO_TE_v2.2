...
namespace Arya.Auction
{
	...
	public class NewAuctionGump : Gump
	{
		...
		{			
			...
			AddTextEntry(255, 35, 70, 20, GreenHue, 0, m_Auction.MinBid.ToString( "#,0" ) );
			...
			AddTextEntry(415, 35, 70, 20, GreenHue, 1, m_Auction.Reserve.ToString( "#,0" ) );
			...
			AddTextEntry(255, 60, 30, 20, GreenHue, 2, m_Auction.Duration.TotalDays.ToString() );
