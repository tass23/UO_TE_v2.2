		...
		private void MakeGump()
		{
			...
			for ( int i = 0; i < 10; i++ )
			{
				...
				if ( m_Page * 10 + i < m_Bids.Count )
				{
					...
					AddLabel(15, 50 + i * 20, LabelHue, ( m_Page * 10 + i + 1 ).ToString() );
					AddLabelCropped( 55, 50 + i * 20, 100, 19, LabelHue, bid.Mobile != null ? bid.Mobile.Name : AuctionSystem.ST[ 78 ] );
					AddLabel(160, 50 + i * 20, LabelHue, bid.Amount.ToString("#,0" ));
				}
			}
