...
namespace Server.Items
{
	...
	/// </summary>
	public class TreeDoor_Locked_M : TreeDoor, ILockpickable
	{
		...
		[Constructable]
		public TreeDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TreeDoor_Locked_M( Serial serial ) : base( serial )
		{
