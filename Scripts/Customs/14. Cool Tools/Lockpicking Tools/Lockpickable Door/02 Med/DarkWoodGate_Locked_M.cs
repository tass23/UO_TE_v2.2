...
namespace Server.Items
{
	...
	// [add DarkWoodGate_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class DarkWoodGate_Locked_M : DarkWoodGate, ILockpickable
	{
		...
		[Constructable]
		public DarkWoodGate_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public DarkWoodGate_Locked_M( Serial serial ) : base( serial )
		{
