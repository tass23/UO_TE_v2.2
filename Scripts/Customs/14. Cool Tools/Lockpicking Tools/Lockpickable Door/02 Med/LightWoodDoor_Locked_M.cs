...
namespace Server.Items
{
	...
	// [add LightWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodDoor_Locked_M : LightWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public LightWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
