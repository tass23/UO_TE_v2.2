...
{
	// [add WhiteDragonWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class WhiteDragonWoodDoor_Locked_M : WhiteDragonWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public WhiteDragonWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
			m_LockLevel = Utility.Random( 25, 50 );	//80
			m_MaxLockLevel = 75; 			//110
			m_RequiredSkill = 75; 			//100
		}
...
// determines how long the door remains unlocked
		...
		public WhiteDragonWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
