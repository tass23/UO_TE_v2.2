...
namespace Server.Items
{
	...
	// [add DarkWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class DarkWoodDoor_Locked_M : DarkWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public DarkWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public DarkWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
