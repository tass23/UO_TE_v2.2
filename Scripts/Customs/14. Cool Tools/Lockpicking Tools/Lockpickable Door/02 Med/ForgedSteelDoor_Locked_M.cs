...
{
	// [add ForgedSteelDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class ForgedSteelDoor_Locked_M : ForgedSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public ForgedSteelDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public ForgedSteelDoor_Locked_M( Serial serial ) : base( serial )
		{
