...
{
	// [add RedOrnateWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class RedOrnateWoodDoor_Locked_M : RedOrnateWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public RedOrnateWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public RedOrnateWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
