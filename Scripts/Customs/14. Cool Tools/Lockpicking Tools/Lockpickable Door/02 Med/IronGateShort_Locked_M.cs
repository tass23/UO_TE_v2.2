...
namespace Server.Items
{
	...
	// [add IronGateShort_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class IronGateShort_Locked_M : IronGateShort, ILockpickable
	{
		...
		[Constructable]
		public IronGateShort_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGateShort_Locked_M( Serial serial ) : base( serial )
		{
