...
namespace Server.Items
{
	...
	// [add BarredMetalDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class BarredMetalDoor_Locked_M : BarredMetalDoor, ILockpickable
	{
		...
		[Constructable]
		public BarredMetalDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public BarredMetalDoor_Locked_M( Serial serial ) : base( serial )
		{
