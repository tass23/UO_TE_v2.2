...
{
	// [add TigerRatanDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class TigerRatanDoor_Locked_M : TigerRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public TigerRatanDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TigerRatanDoor_Locked_M( Serial serial ) : base( serial )
		{
