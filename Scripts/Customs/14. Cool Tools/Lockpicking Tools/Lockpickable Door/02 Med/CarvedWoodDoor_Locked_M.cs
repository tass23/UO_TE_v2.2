...
{
	// [add CarvedWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CarvedWoodDoor_Locked_M : CarvedWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public CarvedWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CarvedWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
