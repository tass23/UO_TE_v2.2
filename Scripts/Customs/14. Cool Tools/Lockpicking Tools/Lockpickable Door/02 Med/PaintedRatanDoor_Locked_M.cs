...
{
	// [add PaintedRatanDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class PaintedRatanDoor_Locked_M : PaintedRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public PaintedRatanDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public PaintedRatanDoor_Locked_M( Serial serial ) : base( serial )
		{
