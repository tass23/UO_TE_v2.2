...
{
	// [add HippieWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class HippieWoodDoor_Locked_M : HippieWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public HippieWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public HippieWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
