...
{
	// [add CelestialSteelDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CelestialSteelDoor_Locked_M : CelestialSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public CelestialSteelDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CelestialSteelDoor_Locked_M( Serial serial ) : base( serial )
		{
