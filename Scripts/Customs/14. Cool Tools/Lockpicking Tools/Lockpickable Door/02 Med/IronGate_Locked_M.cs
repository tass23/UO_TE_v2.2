...
namespace Server.Items
{
	...
	/// </summary>
	public class IronGate_Locked_M : IronGate, ILockpickable
	{
		...
		[Constructable]
		public IronGate_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGate_Locked_M( Serial serial ) : base( serial )
		{
