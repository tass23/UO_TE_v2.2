...
namespace Server.Items
{
	...
	// [add MediumWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class MediumWoodDoor_Locked_M : MediumWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public MediumWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public MediumWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
