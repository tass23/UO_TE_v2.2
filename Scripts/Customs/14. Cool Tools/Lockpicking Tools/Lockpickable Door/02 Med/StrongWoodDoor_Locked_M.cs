...
namespace Server.Items
{
	...
	// [add StrongWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class StrongWoodDoor_Locked_M : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public StrongWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public StrongWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
