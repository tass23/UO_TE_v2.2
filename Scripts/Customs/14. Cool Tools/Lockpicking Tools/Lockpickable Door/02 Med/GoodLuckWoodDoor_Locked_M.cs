...
{
	// [add GoodLuckWoodDoor_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class GoodLuckWoodDoor_Locked_M : GoodLuckWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public GoodLuckWoodDoor_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public GoodLuckWoodDoor_Locked_M( Serial serial ) : base( serial )
		{
