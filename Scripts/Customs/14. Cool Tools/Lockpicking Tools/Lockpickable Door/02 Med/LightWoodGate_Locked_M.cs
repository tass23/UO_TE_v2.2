...
namespace Server.Items
{
	...
	// [add LightWoodGate_Locked_M NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodGate_Locked_M : LightWoodGate, ILockpickable
	{
		...
		[Constructable]
		public LightWoodGate_Locked_M( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodGate_Locked_M( Serial serial ) : base( serial )
		{
