...
{
	// [add PaintedRatanDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class PaintedRatanDoor_Locked : PaintedRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public PaintedRatanDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public PaintedRatanDoor_Locked( Serial serial ) : base( serial )
		{
