...
namespace Server.Items
{
	...
	/// </summary>
	public class TreeDoor_Locked : TreeDoor, ILockpickable
	{
		...
		[Constructable]
		public TreeDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TreeDoor_Locked( Serial serial ) : base( serial )
		{
