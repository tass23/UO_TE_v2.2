...
namespace Server.Items
{
	...
	/// </summary>
	public class IronGate_Locked : IronGate, ILockpickable
	{
		...
		[Constructable]
		public IronGate_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGate_Locked( Serial serial ) : base( serial )
		{
