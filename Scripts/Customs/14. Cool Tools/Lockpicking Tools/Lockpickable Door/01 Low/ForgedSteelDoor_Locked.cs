...
{
	// [add ForgedSteelDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class ForgedSteelDoor_Locked : ForgedSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public ForgedSteelDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public ForgedSteelDoor_Locked( Serial serial ) : base( serial )
		{
