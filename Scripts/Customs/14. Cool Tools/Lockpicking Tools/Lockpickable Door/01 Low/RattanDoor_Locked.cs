...
namespace Server.Items
{
	...
	/// </summary>
	public class RattanDoor_Locked : RattanDoor, ILockpickable
	{
		...
		[Constructable]
		public RattanDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public RattanDoor_Locked( Serial serial ) : base( serial )
		{
