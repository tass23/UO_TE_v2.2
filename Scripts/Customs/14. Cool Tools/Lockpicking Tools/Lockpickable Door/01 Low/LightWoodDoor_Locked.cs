...
namespace Server.Items
{
	...
	// [add LightWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodDoor_Locked : LightWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public LightWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodDoor_Locked( Serial serial ) : base( serial )
		{
