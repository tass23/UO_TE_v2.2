...
{
	// [add HippieWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class HippieWoodDoor_Locked : HippieWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public HippieWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public HippieWoodDoor_Locked( Serial serial ) : base( serial )
		{
