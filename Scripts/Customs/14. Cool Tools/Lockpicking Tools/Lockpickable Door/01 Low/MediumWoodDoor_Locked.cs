...
namespace Server.Items
{
	...
	// [add MediumWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class MediumWoodDoor_Locked : MediumWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public MediumWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public MediumWoodDoor_Locked( Serial serial ) : base( serial )
		{
