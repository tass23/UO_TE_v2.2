...
{
	// [add WhiteDragonWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class WhiteDragonWoodDoor_Locked : WhiteDragonWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public WhiteDragonWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
			m_LockLevel = Utility.Random( 10, 40 );	//80
			m_MaxLockLevel = 50; 			//110
			m_RequiredSkill = 50; 			//100
		}
...
// determines how long the door remains unlocked
		...
		public WhiteDragonWoodDoor_Locked( Serial serial ) : base( serial )
		{
