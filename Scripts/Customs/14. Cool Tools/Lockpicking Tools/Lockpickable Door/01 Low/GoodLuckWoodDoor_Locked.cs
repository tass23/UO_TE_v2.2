...
{
	// [add GoodLuckWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class GoodLuckWoodDoor_Locked : GoodLuckWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public GoodLuckWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public GoodLuckWoodDoor_Locked( Serial serial ) : base( serial )
		{
