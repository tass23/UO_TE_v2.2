...
namespace Server.Items
{
	...
	// [add LightWoodGate_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodGate_Locked : LightWoodGate, ILockpickable
	{
		...
		[Constructable]
		public LightWoodGate_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodGate_Locked( Serial serial ) : base( serial )
		{
