...
{
	// [add CarvedWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CarvedWoodDoor_Locked : CarvedWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public CarvedWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CarvedWoodDoor_Locked( Serial serial ) : base( serial )
		{
