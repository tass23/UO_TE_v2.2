...
{
	// [add RedOrnateWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class RedOrnateWoodDoor_Locked : RedOrnateWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public RedOrnateWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public RedOrnateWoodDoor_Locked( Serial serial ) : base( serial )
		{
