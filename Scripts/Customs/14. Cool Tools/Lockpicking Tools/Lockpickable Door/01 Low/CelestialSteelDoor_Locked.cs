...
{
	// [add CelestialSteelDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CelestialSteelDoor_Locked : CelestialSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public CelestialSteelDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CelestialSteelDoor_Locked( Serial serial ) : base( serial )
		{
