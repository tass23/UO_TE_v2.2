...
namespace Server.Items
{
	...
	// [add BarredMetalDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class BarredMetalDoor_Locked : BarredMetalDoor, ILockpickable
	{
		...
		[Constructable]
		public BarredMetalDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public BarredMetalDoor_Locked( Serial serial ) : base( serial )
		{
