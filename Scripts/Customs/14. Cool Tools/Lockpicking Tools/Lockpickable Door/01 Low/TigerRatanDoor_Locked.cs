...
{
	// [add TigerRatanDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class TigerRatanDoor_Locked : TigerRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public TigerRatanDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TigerRatanDoor_Locked( Serial serial ) : base( serial )
		{
