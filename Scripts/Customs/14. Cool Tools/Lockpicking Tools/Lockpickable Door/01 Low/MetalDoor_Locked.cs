...
namespace Server.Items
{
	...
	/// </summary>
	public class MetalDoor_Locked : MetalDoor, ILockpickable
	{
		...
		[Constructable]
		public MetalDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public MetalDoor_Locked( Serial serial ) : base( serial )
		{
