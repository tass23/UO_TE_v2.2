...
namespace Server.Items
{
	...
	// [add StrongWoodDoor_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class StrongWoodDoor_Locked : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public StrongWoodDoor_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public StrongWoodDoor_Locked( Serial serial ) : base( serial )
		{
