...
namespace Server.Items
{
	...
	// [add IronGateShort_Locked NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class IronGateShort_Locked : IronGateShort, ILockpickable
	{
		...
		[Constructable]
		public IronGateShort_Locked( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGateShort_Locked( Serial serial ) : base( serial )
		{
