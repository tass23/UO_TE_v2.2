...
namespace Server.Items
{
	...
	// [add IronGateShort_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class IronGateShort_Locked_H : IronGateShort, ILockpickable
	{
		...
		[Constructable]
		public IronGateShort_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGateShort_Locked_H( Serial serial ) : base( serial )
		{
