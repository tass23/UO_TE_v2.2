...
namespace Server.Items
{
	...
	// [add BarredMetalDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class BarredMetalDoor_Locked_H : BarredMetalDoor, ILockpickable
	{
		...
		[Constructable]
		public BarredMetalDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public BarredMetalDoor_Locked_H( Serial serial ) : base( serial )
		{
