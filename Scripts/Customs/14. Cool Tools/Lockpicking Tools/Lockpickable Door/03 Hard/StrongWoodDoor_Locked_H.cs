...
namespace Server.Items
{
	...
	// [add StrongWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class StrongWoodDoor_Locked_H : StrongWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public StrongWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public StrongWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
