...
{
	// [add HippieWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class HippieWoodDoor_Locked_H : HippieWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public HippieWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public HippieWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
