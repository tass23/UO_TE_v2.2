...
{
	// [add WhiteDragonWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// Original script created b Carding. Modified by Raist
	/// </summary>
	public class WhiteDragonWoodDoor_Locked_H : WhiteDragonWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public WhiteDragonWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
			m_LockLevel = Utility.Random( 50, 50 );//80
			m_MaxLockLevel = 100; 			//110
			m_RequiredSkill = 100; 			//100
		}
...
// determines how long the door remains unlocked
		private TimeSpan m_RelockTime = TimeSpan.FromMinutes( 60.0 );
		...
		public WhiteDragonWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
