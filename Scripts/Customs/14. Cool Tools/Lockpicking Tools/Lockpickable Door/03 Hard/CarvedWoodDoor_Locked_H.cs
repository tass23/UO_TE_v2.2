...
{
	// [add CarvedWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CarvedWoodDoor_Locked_H : CarvedWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public CarvedWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CarvedWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
