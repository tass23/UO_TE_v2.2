...
{
	// [add RedOrnateWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class RedOrnateWoodDoor_Locked_H : RedOrnateWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public RedOrnateWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public RedOrnateWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
