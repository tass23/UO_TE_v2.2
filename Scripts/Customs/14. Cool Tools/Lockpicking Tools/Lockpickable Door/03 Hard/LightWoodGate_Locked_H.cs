...
namespace Server.Items
{
	...
	// [add LightWoodGate_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodGate_Locked_H : LightWoodGate, ILockpickable
	{
		...
		[Constructable]
		public LightWoodGate_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodGate_Locked_H( Serial serial ) : base( serial )
		{
