...
namespace Server.Items
{
	...
	// [add DarkWoodGate_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class DarkWoodGate_Locked_H : DarkWoodGate, ILockpickable
	{
		...
		[Constructable]
		public DarkWoodGate_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public DarkWoodGate_Locked_H( Serial serial ) : base( serial )
		{
