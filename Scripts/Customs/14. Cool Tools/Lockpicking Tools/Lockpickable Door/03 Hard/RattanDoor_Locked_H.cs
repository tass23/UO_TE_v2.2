...
namespace Server.Items
{
	...
	// [add RattanDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class RattanDoor_Locked_H : RattanDoor, ILockpickable
	{
		...
		[Constructable]
		public RattanDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public RattanDoor_Locked_H( Serial serial ) : base( serial )
		{
