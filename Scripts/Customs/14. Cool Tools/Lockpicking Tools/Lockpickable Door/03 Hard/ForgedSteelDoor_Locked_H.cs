...
{
	// [add ForgedSteelDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class ForgedSteelDoor_Locked_H : ForgedSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public ForgedSteelDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public ForgedSteelDoor_Locked_H( Serial serial ) : base( serial )
		{
