...
{
	// [add TigerRatanDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class TigerRatanDoor_Locked_H : TigerRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public TigerRatanDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TigerRatanDoor_Locked_H( Serial serial ) : base( serial )
		{
