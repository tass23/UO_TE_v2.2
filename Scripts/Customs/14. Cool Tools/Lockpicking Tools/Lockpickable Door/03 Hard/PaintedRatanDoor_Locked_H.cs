...
{
	// [add PaintedRatanDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class PaintedRatanDoor_Locked_H : PaintedRatanDoor, ILockpickable
	{
		...
		[Constructable]
		public PaintedRatanDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public PaintedRatanDoor_Locked_H( Serial serial ) : base( serial )
		{
