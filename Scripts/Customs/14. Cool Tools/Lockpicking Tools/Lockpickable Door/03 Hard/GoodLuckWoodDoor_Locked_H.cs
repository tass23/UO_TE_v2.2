...
{
	// [add GoodLuckWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class GoodLuckWoodDoor_Locked_H : GoodLuckWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public GoodLuckWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public GoodLuckWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
