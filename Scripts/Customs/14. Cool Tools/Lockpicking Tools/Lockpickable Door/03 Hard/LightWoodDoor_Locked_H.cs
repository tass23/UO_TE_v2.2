...
namespace Server.Items
{
	...
	// [add LightWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class LightWoodDoor_Locked_H : LightWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public LightWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public LightWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
