...
namespace Server.Items
{
	...
	/// </summary>
	public class IronGate_Locked_H : IronGate, ILockpickable
	{
		...
		[Constructable]
		public IronGate_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public IronGate_Locked_H( Serial serial ) : base( serial )
		{
