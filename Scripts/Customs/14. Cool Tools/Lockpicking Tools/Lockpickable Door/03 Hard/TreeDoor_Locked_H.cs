...
namespace Server.Items
{
	...
	/// </summary>
	public class TreeDoor_Locked_H : TreeDoor, ILockpickable
	{
		...
		[Constructable]
		public TreeDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public TreeDoor_Locked_H( Serial serial ) : base( serial )
		{
