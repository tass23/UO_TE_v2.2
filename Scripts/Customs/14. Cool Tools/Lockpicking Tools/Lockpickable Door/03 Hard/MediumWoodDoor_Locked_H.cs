...
namespace Server.Items
{
	...
	// [add MediumWoodDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class MediumWoodDoor_Locked_H : MediumWoodDoor, ILockpickable
	{
		...
		[Constructable]
		public MediumWoodDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public MediumWoodDoor_Locked_H( Serial serial ) : base( serial )
		{
