...
{
	// [add CelestialSteelDoor_Locked_H NorthCW 
	//
	//	WestCW,
	//	EastCCW,
	//	WestCCW,
	...
	/// </summary>
	public class CelestialSteelDoor_Locked_H : CelestialSteelDoor, ILockpickable
	{
		...
		[Constructable]
		public CelestialSteelDoor_Locked_H( DoorFacing facing ) : base( facing )
		{
// default values		
...
// determines how long the door remains unlocked
		...
		public CelestialSteelDoor_Locked_H( Serial serial ) : base( serial )
		{
