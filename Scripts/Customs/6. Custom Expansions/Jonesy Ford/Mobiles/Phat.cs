...
{
	[CorpseName( "Phat's corpse" )]
	public class Phat : BaseCreature
	{
		[Constructable]
		public Phat() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Phat";
			Body = 183;
		...
		public Phat( Serial serial ) : base( serial )
		{
		}
