...
{
	public class NeeLandscapingAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new NeeLandscapingAddonDeed();
			}
		}

		[ Constructable ]
		public NeeLandscapingAddon()
		{
            for (int i = 0; i < m_AddOnSimpleComponents.Length / 4; i++)
                AddComponent( new AddonComponent( m_AddOnSimpleComponents[i,0] ), m_AddOnSimpleComponents[i,1], m_AddOnSimpleComponents[i,2], m_AddOnSimpleComponents[i,3] );
		}

		public NeeLandscapingAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class NeeLandscapingAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new NeeLandscapingAddon();
			}
		}

		[Constructable]
		public NeeLandscapingAddonDeed()
		{
			Name = "a Landscaping deed from the Knights Who Say 'Ni'!";
		}

		public NeeLandscapingAddonDeed( Serial serial ) : base( serial )
		{
		}
