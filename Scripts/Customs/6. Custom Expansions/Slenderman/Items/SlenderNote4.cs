...
{
	public class SlenderScroll4 : Item
	{

		[Constructable]
		public SlenderScroll4() : base( 3636 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "Slenderman Info Page 4";
		}

		public SlenderScroll4( Serial serial ) : base( serial )
		{
		}
		...
		{
			from.AddToBackpack( new SlenderNote4() );
			from.CloseGump( typeof( SlenderScroll4Gump ) );
			from.SendGump( new SlenderScroll4Gump( from, this ) );
			this.Delete();
		}
	}
	
	public class SlenderNote4 : Item
	{

		[Constructable]
		public SlenderNote4() : base( 5359 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
		...
		public SlenderNote4( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			from.CloseGump( typeof( SlenderNote4Gump ) );
			from.SendGump( new SlenderNote4Gump( from, this ) );
		}
	}

	public class SlenderScroll4Gump : Gump
	{
		private Mobile m_From;
		private SlenderScroll4 m_Deed;

		public SlenderScroll4Gump( Mobile from, SlenderScroll4 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
			...
			AddImage(86, 119, 30506, 1088); //Tarot Card
			...
			AddHtml( 165, 86, 146, 30, @"Slenderman Info Page 4", (bool)false, (bool)false); //Quest Title
			AddHtml( 207, 131, 177, 154, @"HELP ME", (bool)false, (bool)false); //Notestring
		}
	}
	
	public class SlenderNote4Gump : Gump
	{
		private Mobile m_From;
		private SlenderNote4 m_Deed;

		public SlenderNote4Gump( Mobile from, SlenderNote4 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
