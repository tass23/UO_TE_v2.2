...
{
	public class SlenderScroll8 : Item
	{

		[Constructable]
		public SlenderScroll8() : base( 3636 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "Slenderman Info Page 8";
		}

		public SlenderScroll8( Serial serial ) : base( serial )
		{
		}
		...
		{
			from.AddToBackpack( new SlenderNote8() );
			from.CloseGump( typeof( SlenderScroll8Gump ) );
			from.SendGump( new SlenderScroll8Gump( from, this ) );
			this.Delete();
		}
	}
	
	public class SlenderNote8 : Item
	{

		[Constructable]
		public SlenderNote8() : base( 5359 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
		...
		public SlenderNote8( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			from.CloseGump( typeof( SlenderNote8Gump ) );
			from.SendGump( new SlenderNote8Gump( from, this ) );
		}
	}

	public class SlenderScroll8Gump : Gump
	{
		private Mobile m_From;
		private SlenderScroll8 m_Deed;

		public SlenderScroll8Gump( Mobile from, SlenderScroll8 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
			...
			AddImage(86, 119, 30505, 1088); //Tarot Card
			...
			AddHtml( 165, 86, 146, 30, @"Slenderman Info Page 8", (bool)false, (bool)false); //Quest Title
			AddHtml( 207, 131, 177, 154, @"NO NO NO NO NO NO NO", (bool)false, (bool)false); //Notestring
		}
	}
	
	public class SlenderNote8Gump : Gump
	{
		private Mobile m_From;
		private SlenderNote8 m_Deed;

		public SlenderNote8Gump( Mobile from, SlenderNote8 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
