...
{
	public class SlenderScroll2 : Item
	{

		[Constructable]
		public SlenderScroll2() : base( 3636 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "Slenderman Info Page 2";
		}

		public SlenderScroll2( Serial serial ) : base( serial )
		{
		}
		...
		{
			from.AddToBackpack( new SlenderNote2() );
			from.CloseGump( typeof( SlenderScroll2Gump ) );
			from.SendGump( new SlenderScroll2Gump( from, this ) );
			this.Delete();
		}
	}
	
	public class SlenderNote2 : Item
	{

		[Constructable]
		public SlenderNote2() : base( 5359 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
		...
		public SlenderNote2( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			from.CloseGump( typeof( SlenderNote2Gump ) );
			from.SendGump( new SlenderNote2Gump( from, this ) );
		}
	}

	public class SlenderScroll2Gump : Gump
	{
		private Mobile m_From;
		private SlenderScroll2 m_Deed;

		public SlenderScroll2Gump( Mobile from, SlenderScroll2 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
			...
			AddImage(86, 119, 30509, 1089); //Tarot Card
			...
			AddHtml( 165, 86, 146, 30, @"Slenderman Info Page 2", (bool)false, (bool)false); //Quest Title
			AddHtml( 207, 131, 177, 154, @"CAN'T RUN", (bool)false, (bool)false); //Notestring
		}
	}
	
	public class SlenderNote2Gump : Gump
	{
		private Mobile m_From;
		private SlenderNote2 m_Deed;

		public SlenderNote2Gump( Mobile from, SlenderNote2 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
