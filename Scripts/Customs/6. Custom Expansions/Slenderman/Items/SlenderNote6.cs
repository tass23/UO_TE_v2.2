...
{
	public class SlenderScroll6 : Item
	{

		[Constructable]
		public SlenderScroll6() : base( 3636 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "Slenderman Info Page 6";
		}

		public SlenderScroll6( Serial serial ) : base( serial )
		{
		}
		...
		{
			from.AddToBackpack( new SlenderNote6() );
			from.CloseGump( typeof( SlenderScroll6Gump ) );
			from.SendGump( new SlenderScroll6Gump( from, this ) );
			this.Delete();
		}
	}
	
	public class SlenderNote6 : Item
	{

		[Constructable]
		public SlenderNote6() : base( 5359 )
		{
			Hue = 1089;
			Weight = 1.0;
			LootType = LootType.Blessed;
		...
		public SlenderNote6( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			from.CloseGump( typeof( SlenderNote6Gump ) );
			from.SendGump( new SlenderNote6Gump( from, this ) );
		}
	}

	public class SlenderScroll6Gump : Gump
	{
		private Mobile m_From;
		private SlenderScroll6 m_Deed;

		public SlenderScroll6Gump( Mobile from, SlenderScroll6 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
			...
			AddImage(86, 119, 30503, 1088); //Tarot Card
			...
			AddHtml( 165, 86, 146, 30, @"Slenderman Info Page 6", (bool)false, (bool)false); //Quest Title
			AddHtml( 207, 131, 177, 154, @"ALWAYS WATCHES-NO EYES", (bool)false, (bool)false); //Notestring
		}
	}
	
	public class SlenderNote6Gump : Gump
	{
		private Mobile m_From;
		private SlenderNote6 m_Deed;

		public SlenderNote6Gump( Mobile from, SlenderNote6 deed ) : base( 0, 0 )
		{
			m_From = from;
			m_Deed = deed;
