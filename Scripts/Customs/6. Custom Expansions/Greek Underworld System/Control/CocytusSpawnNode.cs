...
{
	public class CocytusSpawnNode : Item
	{
		...
		[Constructable]
		public CocytusSpawnNode( UnderworldSystem s ) : base( 3699 )
		{
		...
		public CocytusSpawnNode( Serial serial ) : base( serial )
		{
		}
		...
		{
			private CocytusSpawnNode node;
			private UnderworldSystem system;

			public InternalTimer( CocytusSpawnNode n, UnderworldSystem sy ) : base( TimeSpan.FromSeconds( 1.0 ))
			{
				node = n;
				system = sy;
			}
