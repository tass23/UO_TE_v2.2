...
namespace Server.Mobiles
{
	...
	public class Oneiroi : BaseCreature
	{
		private DateTime m_NextAbility;

		[Constructable]
		public Oneiroi() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "an oneiroi";
			Body = 4;
			this.Hue = 1000566;
		...
		public override void OnThink()
		{
			if ( m_NextAbility < DateTime.Now && this.Combatant != null )
			{
				...
				this.Combatant.AddStatMod( new StatMod( StatType.Str, "Curse of the Oneiroi", -20, TimeSpan.FromSeconds( 60.0 ) ) );
		...
		public Oneiroi( Serial serial ) : base( serial )
		{
		}
