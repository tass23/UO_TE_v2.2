...
namespace Server.Mobiles
{
	...
	public class Cocytus : BaseCreature
	{
		private DateTime m_NextAbility;

		[Constructable]
		public Cocytus() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Cocytus";
			Body = 16;
			Hue = 1765;
		...
		public override bool OnBeforeDeath()
		{
			...
			if ( alist != null && alist.Count > 0 )
			{
				for( int i = 0; i < alist.Count; i++ )
				{
					...
					{
						m.SendMessage( 0, "Cocytus has fallen and you receive some of the loot." );
						...
						if ( chance <= 25 )
						{
							...
							m.AddToBackpack( new CocytusBracer() );
						}
					}
				}
			}
			...
			if ( m_NextAbility < DateTime.Now )
			{
				...
				if ( alist != null && alist.Count > 0 )
				{
					for( int i = 0; i < alist.Count; i++ )
					{
						...
						m.AddStatMod( new StatMod( StatType.Str, "Curse of the Cacodaemon", -10, TimeSpan.FromSeconds( 15.0 ) ) );
					}
				}
		...
		public Cocytus( Serial serial ) : base( serial )
		{
		}
