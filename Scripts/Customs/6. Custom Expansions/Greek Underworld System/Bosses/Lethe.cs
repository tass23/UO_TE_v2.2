...
namespace Server.Mobiles
{
	...
	public class Lethe : BaseCreature
	{
		private DateTime m_NextAbility;
		[Constructable]
		public Lethe() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Lethe";
			Body = 16;
			Hue = 1767;
		...
		public override bool OnBeforeDeath()
		{
			...
			if ( alist != null && alist.Count > 0 )
			{
				for( int i = 0; i < alist.Count; i++ )
				{
					...
					{
						m.SendMessage( 0, "Lethe has fallen and you receive some of the loot." );
						...
						if ( chance <= 25 )
						{
							...
							m.AddToBackpack( new LetheGauntlets() );
						}
					}
				}
			}
		...
		public override void OnThink()
		{
			...
			{
				this.Str += 10;
				m_NextAbility = DateTime.Now + TimeSpan.FromSeconds( 10.0 );
			}
		}
		...
		public Lethe( Serial serial ) : base( serial )
		{
		}
