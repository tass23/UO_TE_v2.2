...
namespace Server.Mobiles
{
	...
	public class WerewolfTier1 : BaseCreature
	{
		private bool m_TrueForm;

		[Constructable]
		public WerewolfTier1() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "werewolf";
			Body = 23;
			SetStr( 400, 600 );
		...
		public WerewolfTier1( Serial serial ) : base( serial )
		{
		}
