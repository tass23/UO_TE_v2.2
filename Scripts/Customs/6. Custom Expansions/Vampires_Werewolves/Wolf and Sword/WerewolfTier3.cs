...
namespace Server.Mobiles
{
	...
	public class WerewolfTier3 : BaseCreature
	{
		private bool m_TrueForm;

		[Constructable]
		public WerewolfTier3() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "werewolf";
			Body = 23;
			SetStr( 800, 1000 );
		...
		public void Morph()
		{
			...
			Gorget.Name = "Werewolf Elder Collar";
			AddItem(Gorget);

			WerewolfChest1 Chest = new WerewolfChest1();
			Chest.Name = "Werewolf Elder Tunic";
			Chest.Movable = false;
			AddItem(Chest);

			WerewolfArms1 Arms = new WerewolfArms1();
			Arms.Name = "Werewolf Elder Armguards";
			Arms.Movable = false;
			AddItem(Arms);

			WerewolfGloves1 Gloves = new WerewolfGloves1();
			Gloves.Movable = false;
			Gloves.Name = "Werewolf Elder Gloves";
			AddItem(Gloves);
		...
		public override int HitsMax{ get{ return m_TrueForm ? 1000 : 1400; } }
		
		[CommandProperty( AccessLevel.GameMaster )]
		public override int ManaMax{ get{ return 300; } }
		...
		public virtual void CacophonicAttack( Mobile to )
		{
			...
			if ( to.Alive && to.Player && m_Table[ to ] == null )
			{
				...
				to.PlaySound( 0x0A5 );
				m_Table[ to ] = Timer.DelayCall( TimeSpan.FromSeconds( 35 ), new TimerStateCallback( EndCacophonic_Callback ), to );
			}
		}
		...
		public WerewolfTier3( Serial serial ) : base( serial )
		{
		}
