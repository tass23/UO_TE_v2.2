...
namespace Server.Mobiles
{
	...
	public class WerewolfTier5 : BaseCreature
	{
		private bool m_TrueForm;

		[Constructable]
		public WerewolfTier5() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "werewolf";
			Body = 719;
			SetStr( 1200, 1400 );
		...
		public virtual void CacophonicAttack( Mobile to )
		{
			...
			if ( to.Alive && to.Player && m_Table[ to ] == null )
			{
				...
				to.PlaySound( 0x0A5 );
				m_Table[ to ] = Timer.DelayCall( TimeSpan.FromSeconds( 20 ), new TimerStateCallback( EndCacophonic_Callback ), to );
			}
		}
		...
		public WerewolfTier5( Serial serial ) : base( serial )
		{
		}
