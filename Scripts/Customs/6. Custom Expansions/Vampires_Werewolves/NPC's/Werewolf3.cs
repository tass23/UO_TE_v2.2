...
namespace Server.Mobiles
{
	...
	public class Werewolf3 : BaseCreature
	{
		private bool m_TrueForm;

		[Constructable]
		public Werewolf3() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a werewolf";
			Body = 23;
			SetStr( 800, 1000 );
		...
		public void Morph()
		{
			...
			if ( this.Female = Utility.RandomBool() )
			{
				...
				LegWraps.Name = "Werewolf Elder Legwraps";
			...
			else
			{
				...
				Legs.Name = "Werewolf Elder Leggings";
				Legs.Movable = false;
				AddItem(Legs);
			}
		...
		public Werewolf3( Serial serial ) : base( serial )
		{
		}
