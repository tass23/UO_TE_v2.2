...
{
	public abstract class BaseSpecialPotion : BasePotion
	{
		...
		public BaseSpecialPotion( PotionEffect effect ) : base( 0x0EFF, effect )
		{
		}

		public BaseSpecialPotion( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BaseSpecialPotion m_Potion;

			public BaseSpecialPotion Potion
			{
				get{ return m_Potion; }
			}

			public ThrowTarget( BaseSpecialPotion potion ) : base( 12, true, TargetFlags.None )
			{
				m_Potion = potion;
			}
		...
		public void Explode( Mobile from, bool direct, Point3D loc, Map map )
		{
			...
			Effects.PlaySound(loc, map, 0x027);

			Effects.SendLocationEffect(loc, map, 0x373A, 9, 10, 0, 0);
			int alchemyBonus = 0;
			...
			foreach ( object o in eable )
			{
				...
				else if ( o is BaseSpecialPotion && o != this )
				{
					toExplode.Add( o );
				}
			}
			...
			for ( int i = 0; i < toExplode.Count; ++i )
			{
				...
				else if ( o is BaseSpecialPotion )
				{
					BaseSpecialPotion pot = (BaseSpecialPotion)o;
