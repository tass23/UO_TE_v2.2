...
{
	public class WerewolfLordAI : BaseAI
	{
		private DateTime m_NextCastTime;

		public WerewolfLordAI( BaseCreature m ) : base( m )
		{
		}
		...
		public virtual double ScaleByAnatomy( double v )
		{
			return m_Mobile.Skills[SkillName.Anatomy].Value * v * 0.01;
		}
		...
		public virtual double ScaleByHealing( double v )
		{
			...
			scaled = ( m_Mobile.Skills[SkillName.Anatomy].Value + m_Mobile.Skills[SkillName.SpiritSpeak].Value )* v * 0.005;
		...
		public virtual Spell GetRandomDamageSpell()
		{
			...
			switch ( Utility.Random( maxCircle*2 ) )
			{
				...
				case 24: return new PoisonSpell( m_Mobile, null );
			...
			switch ( Utility.Random( 6 + healChance ) )
			{
				...
				case 4: // Set up a combo
				{
					...
					else if ( m_Mobile.Mana > 60 )
					{
						...
						{
							m_Combo = 1;
							spell = new WEarthquakeSpell( m_Mobile, null );
						}
					}
					break;
				}
				case 5: //Combo to soften our enemies with a powerful attack while we have max mana amounts
				{
					if ( m_Mobile.Mana > 80 )
					{
						...
						{
							m_Combo = 0;
							spell = new WEvilOmenSpell ( m_Mobile, null );
						}
						else
						{
							m_Combo = 0;
		...
		public virtual Spell DoCombo( Mobile c )
		{
			...
			{
				spell = new WPainSpikeSpell( m_Mobile, null );
				++m_Combo; // Move to next spell
			}
		...
		public override bool DoActionCombat()
		{
			...
			if ( m_Mobile.Spell == null && DateTime.Now > m_NextCastTime && m_Mobile.InRange( c, 12 ) )
			{
				...
				if ( spell != null && spell.Cast() )
				{
					...
					{
						double del = ScaleByAnimalLore( 1.5 );
						double nec = ScaleByAnatomy( 1.5 );
