...
{
	[CorpseName( "a Rebel Desert Scout's corpse" )]
	public class RebelDesertScout : BaseCreature
	{
		[Constructable]
		public RebelDesertScout() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Rebel Desert Scout";
			Body = 183;
			SetStr( 445, 501 );
			SetDex( 78, 92 );
			SetInt( 301, 320 );
			...
			SetSkill( SkillName.MagicResist, 119.0, 120.0 );
			SetSkill( SkillName.Archery, 100.0, 119.0 );
			SetSkill( SkillName.Tactics, 90.0, 119.0 );
		...
		public RebelDesertScout( Serial serial ) : base( serial )
		{
		}
