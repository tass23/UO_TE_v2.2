...
{
	[CorpseName( "a Rebel Trooper's corpse" )]
	public class RebelTrooper : BaseCreature
	{
		[Constructable]
		public RebelTrooper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Rebel Trooper";
			Body = 183;
			SetStr( 478, 515 );
			SetDex( 71, 97 );
			SetInt( 301, 325 );
		...
		public RebelTrooper( Serial serial ) : base( serial )
		{
		}
