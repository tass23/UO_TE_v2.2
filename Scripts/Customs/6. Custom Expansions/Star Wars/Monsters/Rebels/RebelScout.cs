...
{
	[CorpseName( "a Rebel Scout's corpse" )]
	public class RebelScout : BaseCreature
	{
		[Constructable]
		public RebelScout() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Rebel Scout";
			Body = 183;
			SetStr( 481, 523 );
		...
		public RebelScout( Serial serial ) : base( serial )
		{
		}
