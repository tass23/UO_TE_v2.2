...
{
	[CorpseName( "a Rebel Commando's corpse" )]
	public class RebelCommando : BaseCreature
	{
		[Constructable]
		public RebelCommando() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Rebel Commando";
			Body = 183;
			SetStr( 476, 505 );
			SetDex( 76, 95 );
			SetInt( 301, 325 );
		...
		public RebelCommando( Serial serial ) : base( serial )
		{
		}
