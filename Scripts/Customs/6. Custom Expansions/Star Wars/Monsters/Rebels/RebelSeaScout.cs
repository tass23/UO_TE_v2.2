...
{
	[CorpseName( "a Rebel Sea Scout's corpse" )]
	public class RebelSeaScout : BaseCreature
	{
		[Constructable]
		public RebelSeaScout() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Rebel Sea Scout";
			Body = 183;
			SetStr( 471, 496 );
			SetDex( 76, 95 );
			SetInt( 305, 321 );
		...
		public RebelSeaScout( Serial serial ) : base( serial )
		{
		}
