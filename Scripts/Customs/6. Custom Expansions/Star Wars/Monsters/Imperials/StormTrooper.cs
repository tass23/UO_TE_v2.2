...
{
	[CorpseName( "a Storm Trooper's corpse" )]
	public class Stormtrooper : BaseCreature
	{
		[Constructable]
		public Stormtrooper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public Stormtrooper( Serial serial ) : base( serial )
		{
		}
