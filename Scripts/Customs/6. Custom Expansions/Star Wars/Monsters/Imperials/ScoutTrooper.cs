...
{
	[CorpseName( "a Scout Trooper's corpse" )]
	public class ScoutTrooper : BaseCreature
	{
		[Constructable]
		public ScoutTrooper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Scout Trooper";
			Body = 183;
			SetStr( 426, 475 );
			SetDex( 235, 255 );
			SetInt( 225, 245 );
		...
		public ScoutTrooper( Serial serial ) : base( serial )
		{
		}
