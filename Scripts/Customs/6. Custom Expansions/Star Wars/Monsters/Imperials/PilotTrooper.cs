...
{
	[CorpseName( "a Pilot Trooper's corpse" )]
	public class PilotTrooper : BaseCreature
	{
		[Constructable]
		public PilotTrooper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Pilot Trooper";
			Body = 183;
			SetStr( 456, 505 );
			SetDex( 115, 125 );
			SetInt( 251, 265 );
			...
			StandardPlateKabuto helmet = new StandardPlateKabuto();
		...
		public PilotTrooper( Serial serial ) : base( serial )
		{
		}
