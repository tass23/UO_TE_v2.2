...
{
	[CorpseName( "a Snow Trooper's corpse" )]
	public class SnowTrooper : BaseCreature
	{
		[Constructable]
		public SnowTrooper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Snow Trooper";
			Body = 183;
			SetStr( 986, 1185 );
		...
		public SnowTrooper( Serial serial ) : base( serial )
		{
		}
