...
{
	[CorpseName( "a Storm Commando's corpse" )]
	public class StormCommando : BaseCreature
	{
		[Constructable]
		public StormCommando() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Storm Commando";
			Body = 183;
			SetStr( 786, 885 );
			SetDex( 177, 255 );
			SetInt( 151, 250 );
		...
		public StormCommando( Serial serial ) : base( serial )
		{
		}
