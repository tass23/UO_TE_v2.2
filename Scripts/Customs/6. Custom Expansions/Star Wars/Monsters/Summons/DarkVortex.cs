...
{
    public class DarkVortex : BaseCreature
    {
        ...
        [Constructable]
        public DarkVortex(): base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a Force Vortex";
            Body = 573;
			Hue = 1068;
        ...
        public DarkVortex(Serial serial)
            : base(serial)
        {
            m_Timer = new InternalTimer(this);
            m_Timer.Start();
        ...
        {
            private DarkVortex m_Owner;
            private int m_Count = 0;

            public InternalTimer(DarkVortex owner)
