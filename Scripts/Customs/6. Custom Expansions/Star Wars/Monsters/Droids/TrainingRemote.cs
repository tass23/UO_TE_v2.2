...
{
	[CorpseName( "the remains of a Training Remote" )]
	public class TrainingRemote : BaseCreature
	{
		public override bool IsScaredOfScaryThings{ get{ return false; } }
		public override bool IsScaryToPets{ get{ return true; } }

		[Constructable]
		public TrainingRemote() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public TrainingRemote( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( this.Name == "a Training Remote" )
				this.Name = "a Training Remote";
		}
	}
}