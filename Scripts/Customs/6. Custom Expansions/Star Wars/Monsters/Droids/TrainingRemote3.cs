...
{
	[CorpseName( "the remains of a masterful Training Remote" )]
	public class TrainingRemote3 : BaseCreature
	{
		public override bool IsScaredOfScaryThings{ get{ return false; } }
		public override bool IsScaryToPets{ get{ return true; } }

		[Constructable]
		public TrainingRemote3() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a masterful Training Remote";
			Body = 0x2F4;
			Hue = 1159;
			SetStr( 72, 100 );
			SetDex( 706, 900 );
		...
		public TrainingRemote3( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( this.Name == "a masterful Training Remote" )
				this.Name = "a masterful Training Remote";
		}
	}
}