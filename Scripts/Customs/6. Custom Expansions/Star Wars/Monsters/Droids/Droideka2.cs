...
{
	[CorpseName( "the remains of a veteran Droideka" )]
	public class Droideka2 : BaseCreature
	{
		...
		[Constructable]
		public Droideka2() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a veteran Droideka";
			Body = 0x2F5;
			Hue = 1743;
			SetStr( 99, 121 );
			SetDex( 971, 1251 );
		...
		public Droideka2( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( this.Name == "a veteran Droideka" )
				this.Name = "a veteran Droideka";
		}
	}
}