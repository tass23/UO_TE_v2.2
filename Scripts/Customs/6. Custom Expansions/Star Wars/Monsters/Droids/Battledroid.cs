...
{
	[CorpseName( "the remains of a Battledroid" )]
	public class Battledroid : BaseCreature
	{
		private bool m_FieldActive;
		public bool FieldActive{ get{ return m_FieldActive; } }
		public bool CanUseField{ get{ return Hits >= HitsMax * 9 / 10; } }
		public override bool IsScaredOfScaryThings{ get{ return false; } }
		public override bool IsScaryToPets{ get{ return true; } }

		[Constructable]
		public Battledroid() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Battle Droid";
			Body = 0x2F4;
			Hue = 1169;
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( this.Name == "a Battle Droid" )
				this.Name = "a Battle Droid";
		}
	}
}