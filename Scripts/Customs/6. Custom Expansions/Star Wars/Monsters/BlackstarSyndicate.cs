...
{
	[CorpseName( "a Blackstar Syndicate member's corpse" )]
	public class BlackstarSyndicate : BaseCreature
	{
		[Constructable]
		public BlackstarSyndicate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Blackstar Syndicate Member";
			Body = 183;
			SetStr( 196, 215 );
			SetDex( 186, 205 );
			SetInt( 151, 165 );
		...
		public BlackstarSyndicate( Serial serial ) : base( serial )
		{
		}
