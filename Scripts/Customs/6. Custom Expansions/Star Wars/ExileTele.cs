...
namespace Server.Items
{
	public class ExileTele : Item
	{
		...
		public override int LabelNumber{ get{ return 1026095; } } // ExileTele

		[Constructable]
		public ExileTele() : this( new Point3D( 0, 0, 0 ), null, false )
		{
		}

		[Constructable]
		public ExileTele( Point3D pointDest, Map mapDest ) : this( pointDest, mapDest, false )
		{
		}

		[Constructable]
		public ExileTele( Point3D pointDest, Map mapDest, bool creatures ) : base( 0x1BC3 )
		{
			Movable = false;
			Visible = false;
			m_Active = true;
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if ( m_Active )
			{
				if (m.Player && (m.Karma >= -4999 & m.Karma <= 4999 & m.Title == "the Jedi Exile"))
					StartTeleport( m );
				else
					m.SendMessage("Your Karma will not allow you to enter here or you are not a Jedi Exile.");
				return false;
		...
		public ExileTele( Serial serial ) : base( serial )
		{
		}
