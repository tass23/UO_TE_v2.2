...
namespace Server.Items
{
   	...
   	public class JediMasterRobe : BaseOuterTorso
   	{
		...
		[Constructable]
		public JediMasterRobe() : base( 0x2683 )
		{
			Weight = 5.0;
				...
				if ( m != m_Owner )
				{
					if ( m_Owner == null )
					{
						if ( m.Karma >= 5000 )
						{
							...
							m_Owner = m;
							this.Name = "The Jedi Master " + m_Owner.Name.ToString() + "'s Robe";
		...
		public JediMasterRobe( Serial serial ) : base( serial )
		{
		}
