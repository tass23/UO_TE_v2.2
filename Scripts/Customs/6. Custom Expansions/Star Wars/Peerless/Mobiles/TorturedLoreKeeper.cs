...
{
	[CorpseName( "a tortured Lorekeeper's corpse" )]
	public class TorturedLoreKeeper : BaseCreature
	{
		[Constructable]
		public TorturedLoreKeeper() : base( AIType.AI_Sith, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a tortured Lorekeeper";
			Body = 740;
			Hue = 1460;
			SetStr( 96, 100 );
			SetDex( 286, 300 );
		...
		public override void OnDeath( Container c )
		{
			...
			if ( Utility.RandomDouble() < 0.10 )
				c.DropItem( new AncientHolocron() );

			if ( Utility.RandomDouble() < 0.20 )
			{
				switch ( Utility.Random( 2 ) )
				{
					case 0: c.DropItem( new DarkMatterDisc() ); break;
					case 1: c.DropItem( new LightMatterDisc() ); break;
				}
			}
		...
		public TorturedLoreKeeper( Serial serial ) : base( serial )
		{
		}
