...
namespace Server.Items
{
	...
	public class JediMasterCloak : Cloak
	{
		public override int Hue { get { return 1819; } }
		...
		[Constructable]
		public JediMasterCloak() : base( 0x1515 )
		{
			Name = "a Jedi Master's Cloak";
		...
		{
			m_SkillMod0 = new DefaultSkillMod( SkillName.Focus, true, 15 );
			m_SkillMod1 = new DefaultSkillMod( SkillName.Meditation, true, 15 );
			m_StatMod0 = new StatMod( StatType.Int, "JediMasterCloak", 15, TimeSpan.Zero );
		}
				...
				if ( from != m_Owner )
				{
					if ( m_Owner == null )
					{
						if ( from.Karma >= 5000 )
						{
							...
							m_Owner = from;
							Name = "The Jedi Master " + m_Owner.Name.ToString() + "'s Cloak";
		...
		public override void OnRemoved( object parent )
		{
			if ( parent is Mobile )
			{
				...
				m.RemoveStatMod( "JediMasterCloak" );
		...
		public JediMasterCloak( Serial serial ) : base( serial )
		{
			DefineMods();
