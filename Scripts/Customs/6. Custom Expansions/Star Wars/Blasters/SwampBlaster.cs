...
namespace Server.Items
{
	...
	public class SwampBlaster : BaseBlaster
	{
		...
		[Constructable]
		public SwampBlaster() : base( 0x26C3 )
		{
			Name = "Swamp Blaster";
			Hue = 2051;
		...
		public override bool OnFired( Mobile attacker, Mobile defender )
		{
			...
			attacker.MovingEffect( defender, EffectID, 18, 1, false, false, 1270, 0  );
			attacker.PlaySound( 0x644 );
			return true;
		}
			
		public SwampBlaster( Serial serial ) : base( serial )
		{
		}
