...
namespace Server.Items
{
	...
	public class BlasterTarget : AddonComponent
	{
		...
		[Constructable]
		public BlasterTarget() : this( 0x100A )
		{
			Name = "Blaster Target";
		}

		public BlasterTarget( int itemID ) : base( itemID )
		{
			m_MinSkill = -25.0;
			m_MaxSkill = +80.0;
		}

		public BlasterTarget( Serial serial ) : base( serial )
		{
		}
	...
	public class BlasterTargetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new BlasterTargetDeed(); } }

		[Constructable]
		public BlasterTargetAddon()
		{
			AddComponent( new BlasterTarget( 0x100A ), 0, 0, 0 );
		}

		public BlasterTargetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BlasterTargetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new BlasterTargetAddon(); } }

		[Constructable]
		public BlasterTargetDeed()
		{
			Name = "Blaster Target Deed";
		}

		public BlasterTargetDeed( Serial serial ) : base( serial )
		{
		}
