...
{
	public abstract class BaseBlaster : BaseMeleeWeapon
	{
		public abstract int EffectID{ get; }
		public abstract Type AmmoType{ get; }
		public abstract Item Ammo{ get; }

		public override int DefHitSound{ get{ return 1604; } }
		public override int DefMissSound{ get{ return 0x642; } }
		...
		public BaseBlaster( int itemID ) : base( itemID )
		{
		}

		public BaseBlaster( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnHit( Mobile attacker, Mobile defender, double damageBonus )
		{
			...
			if ( Core.ML && m_Velocity > 0 )
			{
				...
				if ( bonus > 0 && m_Velocity > Utility.Random( 100 ) )
				{
					...
					if ( attacker.Player )
						attacker.SendMessage( "Your blast hits its mark with velocity!" ); 

					if ( defender.Player )
						defender.SendMessage( "You have been hit by a blast with velocity!" ); 
				}
			}
