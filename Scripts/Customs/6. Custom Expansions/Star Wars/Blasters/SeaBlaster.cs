...
namespace Server.Items
{
	...
	public class SeaBlaster : BaseBlaster
	{
		...
		public override bool OnFired( Mobile attacker, Mobile defender )
		{
			...
			attacker.MovingEffect( defender, EffectID, 18, 1, false, false, 1265, 0  );
			attacker.PlaySound( 0x644 );
			return true;
		}

		public SeaBlaster( Serial serial ) : base( serial )
		{
		}
