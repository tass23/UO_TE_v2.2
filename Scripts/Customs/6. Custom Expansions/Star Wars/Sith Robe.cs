...
namespace Server.Items
{
   	...
   	public class SithRobe : BaseOuterTorso
   	{
		...
		public override bool OnEquip( Mobile from )
		{
			if ( ItemID == 0x2683 )
			{
				from.Title = "the Sith Apprentice";
				...
				if ( from != m_Owner )
				{
					if ( m_Owner == null )
					{
						if ( from.Karma <= -5000 )
						{
							...
							m_Owner = from;
							this.Name = "The Sith Apprentice " + m_Owner.Name.ToString() + "'s Robe";
		...
		public SithRobe( Serial serial ) : base( serial )
		{
		}
