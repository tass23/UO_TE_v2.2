...
namespace Server.Items
{
	...
	public class SithLordCloak : Cloak 
	{
		...
		[Constructable] 
		public SithLordCloak() : base( 0x1515 ) 
		{ 
			Name = "A Sith Lord Cloak";
			DefineMods();
		...
		private void DefineMods()
		{
			...
			m_StatMod0 = new StatMod( StatType.Int, "SithLordCloak", 15, TimeSpan.Zero ); 
		}
				...
				if ( from != m_Owner )
				{
					if ( m_Owner == null )
					{
						if ( from.Karma <= -5000 )
						{
							...
							m_Owner = from;
							Name = "The Sith Lord " + m_Owner.Name.ToString() + "'s Cloak";
		...
		*/
		...
		public SithLordCloak( Serial serial ) : base( serial ) 
		{ 
			DefineMods();
