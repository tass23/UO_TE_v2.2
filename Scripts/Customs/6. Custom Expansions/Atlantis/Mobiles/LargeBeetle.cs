...
{
	[CorpseName( "a large beetle corpse" )]
	public class LargeBeetle : BaseCreature
	{
		...
		[Constructable]
		public LargeBeetle() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a large beetle";
			Body = 222;
			SetStr( 401, 460 );
		...
		public LargeBeetle( Serial serial ) : base( serial )
		{
		}
