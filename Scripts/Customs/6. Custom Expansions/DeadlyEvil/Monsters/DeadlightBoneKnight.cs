...
namespace Server.Mobiles
{
	...
	public class DeadlightBoneKnight : BaseCreature
	{
		[Constructable]
		public DeadlightBoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Deadlight Bone Knight";
			Body = 57;
			BaseSoundID = 451;
			SetStr( 196, 250 );
			SetDex( 76, 95 );
		...
		public DeadlightBoneKnight( Serial serial ) : base( serial )
		{
		}
