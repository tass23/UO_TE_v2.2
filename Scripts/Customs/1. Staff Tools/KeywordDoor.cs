        ...
        public void ChangeDoorSet()
        {
            switch (Doors)
            {
                ...
                case DoorSet.SecretStoneDoor3 :
                    ...
                    break;
				/*Added by Raist*/
				case DoorSet.TreeDoor :
					this.ClosedID = 0x2BE9 + (2 * m_FaceValue);
                    this.OpenedID = 0x2BEA + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.CarvedWoodDoor :
					this.ClosedID = 0x2BF9 + (2 * m_FaceValue);
                    this.OpenedID = 0x2BFA + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.ForgedSteelDoor :
					this.ClosedID = 0x2C09 + (2 * m_FaceValue);
                    this.OpenedID = 0x2C0A + (2 * m_FaceValue);
                    this.OpenedSound = 0xEC;
                    this.ClosedSound = 0xF3;
					break;
				case DoorSet.RedOrnateWoodDoor :
					this.ClosedID = 0x2C7E + (2 * m_FaceValue);
                    this.OpenedID = 0x2C7F + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.HippieWoodDoor :
					this.ClosedID = 0x2C8E + (2 * m_FaceValue);
                    this.OpenedID = 0x2C8F + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.CelestialSteelDoor :
					this.ClosedID = 0x2C9E + (2 * m_FaceValue);
                    this.OpenedID = 0x2C9F + (2 * m_FaceValue);
                    this.OpenedSound = 0xEC;
                    this.ClosedSound = 0xF3;
					break;
				case DoorSet.WhiteDragonWoodDoor :
					this.ClosedID = 0x2CAE + (2 * m_FaceValue);
                    this.OpenedID = 0x2CAF + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.GoodLuckWoodDoor :
					this.ClosedID = 0x2CBE + (2 * m_FaceValue);
                    this.OpenedID = 0x2CBF + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.PaintedRatanDoor :
					this.ClosedID = 0x2CCE + (2 * m_FaceValue);
                    this.OpenedID = 0x2CCF + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
				case DoorSet.TigerRatanDoor :
					this.ClosedID = 0x2E48 + (2 * m_FaceValue);
                    this.OpenedID = 0x2E49 + (2 * m_FaceValue);
                    this.OpenedSound = 0xEA;
                    this.ClosedSound = 0xF1;
					break;
            }
