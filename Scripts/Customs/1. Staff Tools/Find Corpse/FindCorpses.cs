...
namespace Server.Gumps
{
	public class FindCorpsesGump : Gump
	{
		public static void Initialize()
		{
            ...
            CommandSystem.Register("FC", AccessLevel.GameMaster, new CommandEventHandler(FindCorpses_OnCommand));
		}
		...
		public static void FindCorpses_OnCommand( CommandEventArgs e )
		{
			if ( e.Mobile is PlayerMobile )
			{
				...
				e.Mobile.SendMessage("Who's corpses would you like to find?");
			}
		}
		...
		{
			public playerTarget() : base( -1, true, TargetFlags.None )
			{
			}
		...
		public FindCorpsesGump( Mobile owner, Mobile targeted ) : this( owner, BuildList( owner, targeted ), 0 )
		{
		}

		public FindCorpsesGump( Mobile owner, ArrayList list, int page ) : base( GumpOffsetX, GumpOffsetY )
		{
