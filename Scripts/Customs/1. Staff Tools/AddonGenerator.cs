...
{complexnamecomponentscode}
	...
	public class {name}AddonDeed : BaseAddonDeed
	{
        ...
        private static void OnAddonGen(CommandEventArgs e)
        {
            ...
            state[12] = state[14] = state[16] = 30000;
        ...
        private static void PickerCallback(Mobile from, Map map, Point3D start, Point3D end, object state)
        {
            ...
            short minStaticID = 2;
            short maxStaticID = 30000;
            short minItemID = 2;
            short maxItemID = 30000;
            short minTileID = 2;
            short maxTileID = 30000;
                ...
                foreach (object o in en)
                {
                    ...
                    if (getItems)
                    {
                        ...
                        if (i == null)
                            ...
                            continue;
                        else if (i.ItemID < 2 || i.ItemID > 29998) // This is not an Item within the normal artwork.. multi... etc.. Toss it
                            continue;
