...
//  Made into a BonusSkillBall50 by X-SirSly-X
...
{
	public class BonusSkillBall50 : Item
	{
		private int m_SkillBonus = 50;
		...
		[Constructable]
		public BonusSkillBall50( int SkillBonus, int SkillBallCap ) : base( 6249 )
		{
		...
		[Constructable]
		public BonusSkillBall50() : base( 6249 )
		{
			Name = m_BaseName + SkillBonus.ToString();
			Movable = false;
		}
		
		public BonusSkillBall50( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				GumpOpen = true;
				from.SendGump( new BonusSkillBall50Gump( from, this ) );
			}
			else if (GumpOpen)
...
{
	public class BonusSkillBall50Gump : Gump
	{
		private Skill m_Skill;
		private BonusSkillBall50 m_skb;
		
		public BonusSkillBall50Gump ( Mobile from, BonusSkillBall50 skb ) : base ( 20, 30 )
		{
