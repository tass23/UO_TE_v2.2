...
{
	public class HolidayTreeRedTrimAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeRedTrimAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeRedTrimAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1299, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1299, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1299, 1, "", 1);// 21

		}

		public HolidayTreeRedTrimAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeRedTrimAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeRedTrimAddon();
			}
		}

		[Constructable]
		public HolidayTreeRedTrimAddonDeed()
		{
			Name = "HolidayTreeRedTrim";
		}

		public HolidayTreeRedTrimAddonDeed( Serial serial ) : base( serial )
		{
		}
