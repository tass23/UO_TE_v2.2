...
{
	public class HolidayTreeWhiteBlueTrimAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeWhiteBlueTrimAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeWhiteBlueTrimAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 2064, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 2064, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 2064, 1, "", 1);// 21

		}

		public HolidayTreeWhiteBlueTrimAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeWhiteBlueTrimAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeWhiteBlueTrimAddon();
			}
		}

		[Constructable]
		public HolidayTreeWhiteBlueTrimAddonDeed()
		{
			Name = "HolidayTreeWhiteBlueTrim";
		}

		public HolidayTreeWhiteBlueTrimAddonDeed( Serial serial ) : base( serial )
		{
		}
