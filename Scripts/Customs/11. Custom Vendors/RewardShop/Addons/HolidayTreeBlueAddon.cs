...
{
	public class HolidayTreeBlueAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeBlueAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeBlueAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1078, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1078, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1078, 1, "", 1);// 21

		}

		public HolidayTreeBlueAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeBlueAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeBlueAddon();
			}
		}

		[Constructable]
		public HolidayTreeBlueAddonDeed()
		{
			Name = "HolidayTreeBlue";
		}

		public HolidayTreeBlueAddonDeed( Serial serial ) : base( serial )
		{
		}
