...
{
	public class HolidayTreeDarkPurpleAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeDarkPurpleAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeDarkPurpleAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1170, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1170, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1170, 1, "", 1);// 21

		}

		public HolidayTreeDarkPurpleAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeDarkPurpleAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeDarkPurpleAddon();
			}
		}

		[Constructable]
		public HolidayTreeDarkPurpleAddonDeed()
		{
			Name = "HolidayTreeDarkPurple";
		}

		public HolidayTreeDarkPurpleAddonDeed( Serial serial ) : base( serial )
		{
		}
