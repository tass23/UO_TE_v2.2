...
{
	public class HolidayTreePurpleAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreePurpleAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreePurpleAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1098, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1098, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1098, 1, "", 1);// 21

		}

		public HolidayTreePurpleAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreePurpleAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreePurpleAddon();
			}
		}

		[Constructable]
		public HolidayTreePurpleAddonDeed()
		{
			Name = "HolidayTreePurple";
		}

		public HolidayTreePurpleAddonDeed( Serial serial ) : base( serial )
		{
		}
