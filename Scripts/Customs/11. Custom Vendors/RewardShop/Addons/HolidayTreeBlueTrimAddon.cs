...
{
	public class HolidayTreeBlueTrimAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeBlueTrimAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeBlueTrimAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1300, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1300, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1300, 1, "", 1);// 21

		}

		public HolidayTreeBlueTrimAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeBlueTrimAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeBlueTrimAddon();
			}
		}

		[Constructable]
		public HolidayTreeBlueTrimAddonDeed()
		{
			Name = "HolidayTreeBlueTrim";
		}

		public HolidayTreeBlueTrimAddonDeed( Serial serial ) : base( serial )
		{
		}
