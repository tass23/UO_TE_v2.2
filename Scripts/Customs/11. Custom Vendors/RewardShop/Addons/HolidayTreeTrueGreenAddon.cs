...
{
	public class HolidayTreeTrueGreenAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeTrueGreenAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeTrueGreenAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1187, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1187, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1187, 1, "", 1);// 21

		}

		public HolidayTreeTrueGreenAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeTrueGreenAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeTrueGreenAddon();
			}
		}

		[Constructable]
		public HolidayTreeTrueGreenAddonDeed()
		{
			Name = "HolidayTreeTrueGreen";
		}

		public HolidayTreeTrueGreenAddonDeed( Serial serial ) : base( serial )
		{
		}
