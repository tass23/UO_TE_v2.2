...
{
	public class HolidayTreeWhiteTrimAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreeWhiteTrimAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreeWhiteTrimAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1394, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1394, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1394, 1, "", 1);// 21

		}

		public HolidayTreeWhiteTrimAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreeWhiteTrimAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreeWhiteTrimAddon();
			}
		}

		[Constructable]
		public HolidayTreeWhiteTrimAddonDeed()
		{
			Name = "HolidayTreeWhiteTrim";
		}

		public HolidayTreeWhiteTrimAddonDeed( Serial serial ) : base( serial )
		{
		}
