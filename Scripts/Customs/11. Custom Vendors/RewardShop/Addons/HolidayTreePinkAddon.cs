...
{
	public class HolidayTreePinkAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new HolidayTreePinkAddonDeed();
			}
		}

		[ Constructable ]
		public HolidayTreePinkAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 3287, 0, 0, 0, 1459, -1, "", 1);// 2
			...
			AddComplexComponent( (BaseAddon) this, 2842, 0, 1, 12, 1459, 1, "", 1);// 20
			AddComplexComponent( (BaseAddon) this, 2842, 1, 1, 30, 1459, 1, "", 1);// 21

		}

		public HolidayTreePinkAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayTreePinkAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new HolidayTreePinkAddon();
			}
		}

		[Constructable]
		public HolidayTreePinkAddonDeed()
		{
			Name = "HolidayTreePink";
		}

		public HolidayTreePinkAddonDeed( Serial serial ) : base( serial )
		{
		}
