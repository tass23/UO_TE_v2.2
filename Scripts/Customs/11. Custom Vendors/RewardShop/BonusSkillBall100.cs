...
//  Made into a BonusSkillBall100 by X-SirSly-X
...
{
	public class BonusSkillBall100 : Item
	{
		...
		[Constructable]
		public BonusSkillBall100( int SkillBonus, int SkillBallCap ) : base( 6249 )
		{
		...
		[Constructable]
		public BonusSkillBall100() : base( 6249 )
		{
			Name = m_BaseName + SkillBonus.ToString();
			Movable = false;
		}
		
		public BonusSkillBall100( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				GumpOpen = true;
				from.SendGump( new BonusSkillBall100Gump( from, this ) );
			}
			else if (GumpOpen)
...
{
	public class BonusSkillBall100Gump : Gump
	{
		private Skill m_Skill;
		private BonusSkillBall100 m_skb;
		
		public BonusSkillBall100Gump ( Mobile from, BonusSkillBall100 skb ) : base ( 20, 30 )
		{
