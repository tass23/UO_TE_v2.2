...
//  Made into a BonusSkillBall75 by X-SirSly-X
...
{
	public class BonusSkillBall75 : Item
	{
		private int m_SkillBonus = 75;
		...
		[Constructable]
		public BonusSkillBall75( int SkillBonus, int SkillBallCap ) : base( 6249 )
		{
		...
		[Constructable]
		public BonusSkillBall75() : base( 6249 )
		{
			Name = m_BaseName + SkillBonus.ToString();
			Movable = false;
		}
		
		public BonusSkillBall75( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				GumpOpen = true;
				from.SendGump( new BonusSkillBall75Gump( from, this ) );
			}
			else if (GumpOpen)
...
{
	public class BonusSkillBall75Gump : Gump
	{
		private Skill m_Skill;
		private BonusSkillBall75 m_skb;
		
		public BonusSkillBall75Gump ( Mobile from, BonusSkillBall75 skb ) : base ( 20, 30 )
		{
