...
{
	public interface DIAxe
	{
		bool Axe( Mobile from, BaseRewardAxe axe );
	}

	public abstract class BaseRewardAxe : BaseMeleeWeapon
	{
		...
		public int UsesRemaining
		{
			...
			set
			{
				if (HarvestSystem!=Lumberjacking.System || HarvestSystem!=Mining.System)
				{
					m_UsesRemaining = value; InvalidateProperties();
				}
				else if (HarvestSystem!=Mining.System)
				{
					m_UsesRemaining = value; InvalidateProperties();
				}
			}
		...
		public bool ShowUsesRemaining
		{
			...
			set
			{
				if (HarvestSystem!=Lumberjacking.System || HarvestSystem!=Mining.System)
				{
					m_ShowUsesRemaining = value; InvalidateProperties();
				}
				else if (HarvestSystem!=Mining.System)
				{
					m_ShowUsesRemaining = value; InvalidateProperties();
		...
		public BaseRewardAxe( int itemID ) : base( itemID )
		{
			m_UsesRemaining = 150;
		}

		public BaseRewardAxe( Serial serial ) : base( serial )
		{
		}
