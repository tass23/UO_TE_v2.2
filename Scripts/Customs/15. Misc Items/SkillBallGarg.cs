...
namespace Server
{
	public class GargSkillPickGump : Gump
	{
///////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////
			...
			: base( 0, 0 )
		{
			...
			this.AddPage(0);
			this.AddBackground(39, 33, 219, 320, 5054);
			...
			this.AddLabel(80, 165, 0, @"Throwing");
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case 1:
				{
					...
					{
						m.SendGump( new GargSkillPickGump() );
	...
	public class SkillBallGarg : Item
	{ 
		[Constructable] 
		public SkillBallGarg() :  base( 0x1870 ) 
		{ 
			Weight = 1.0; 
			Hue = 1194; 
			Name = "skill ball"; 
		...
		{				
			m.CloseGump( typeof( GargSkillPickGump ) );
			m.SendGump ( new GargSkillPickGump() );
			this.Delete();
		} 

		public SkillBallGarg( Serial serial ) : base( serial ) 
		{ 
		} 
