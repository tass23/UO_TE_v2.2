	...
	public class Skullball : Item
	{
		...
		public void goldteamb()
		{
			...
			if( m_AllowedPlayer2 != null )
			{
				...
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Gold team scores! Gold is winning, the score is " + m_goldscore + " to " + m_silverscore + ".");
				}
				else if( m_goldscore < m_silverscore )
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Gold team scores! Silver is winning, the score is " + m_silverscore + " to " + m_goldscore + ".");
				}
				else
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Gold team scores! Both teams are tied, the score is " + m_goldscore + " to " + m_silverscore + ".");
				}
			}
			...
			{
				if( m_goldscore > m_silverscore )
					m_AllowedPlayer1.Say( "Gold team scores! Gold is winning, the score is " + m_goldscore + " to " + m_silverscore + ".");
				else if( m_goldscore < m_silverscore )
					m_AllowedPlayer1.Say( "Gold team scores! Silver is winning, the score is " + m_silverscore + " to " + m_goldscore + ".");
				else
					m_AllowedPlayer1.Say( "Gold team scores! Both teams are tied, the score is " + m_goldscore + " to " + m_silverscore + ".");
			}
		}
		...
		public void silverteamb()
		{
			...
			if( m_AllowedPlayer2 != null )
			{
				...
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Silver team scores! Gold is winning, the score is " + m_goldscore + " to " + m_silverscore + ".");
				}
				else if( m_goldscore < m_silverscore )
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Silver team scores! Silver is winning, the score is " + m_silverscore + " to " + m_goldscore + ".");
				}
				else
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Silver team scores! Both teams are tied, the score is " + m_goldscore + " to " + m_silverscore + ".");
				}
			}
			...
			{
				if( m_goldscore > m_silverscore )
					m_AllowedPlayer1.Say( "Silver team scores! Gold is winning, the score is " + m_goldscore + " to " + m_silverscore + ".");
				else if( m_goldscore < m_silverscore )
					m_AllowedPlayer1.Say( "Silver team scores! Silver is winning, the score is " + m_silverscore + " to " + m_goldscore + ".");
				else
					m_AllowedPlayer1.Say( "Silver team scores! Both teams are tied, the score is " + m_goldscore + " to " + m_silverscore + ".");
			}
		}
					...
					if ( ko.SolidHueOverride == 2101 || ko.SolidHueOverride == 2125 )
					{
						if( m_goldscore >= 10)
						{
							...
							if( ko.SolidHueOverride == 2125 && m_GiveReward )	//Gold Winners Reward
							{
								...
								prize.Hue = 2125;
								prize.Name = "Skullball Match Trophy";
