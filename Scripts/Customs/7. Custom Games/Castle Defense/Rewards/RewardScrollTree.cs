    ...
    public class RSTree : BaseAddon
    {
        ...
        public override void OnComponentUsed( AddonComponent c, Mobile from )
        {
            ...
            if (from.AccessLevel == AccessLevel.Player)
            {
                ...
                {
                    case 4: from.AddToBackpack(new RewardScroll()); break;
                    case 3: from.AddToBackpack(new RewardScroll()); break;
        ...
        public RSTree(Serial serial): base(serial)
        {
        }
