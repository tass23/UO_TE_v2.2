...
namespace Server.Items
{
	...
	public class LotteryStone : Item
	{
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write((int)m_VisitsToStone);
            writer.Write((int)m_PriceToPlay);
            writer.Write((int)m_HighestEverJackpot);
            writer.Write((int)m_RollOverAmount);
            writer.Write((int)m_NextTicketNumber);
            writer.Write((int)m_LotteryGoldTaken);
            writer.Write((int)m_JackpotAmount);
            writer.Write((int)m_Split5);
            writer.Write((int)m_Split4);
            writer.Write((int)m_Split3);
            writer.Write((int)m_Split2);
            writer.Write((int)m_Split1);

            writer.Write((int)m_LastWin1);
            writer.Write((int)m_LastWin2);
            writer.Write((int)m_LastWin3);
            writer.Write((int)m_LastWin4);
            writer.Write((int)m_LastWin5);
            writer.Write((int)m_LastTotalWins);

            writer.Write((DateTime)m_DateOfNextDraw);

            writer.Write((int)m_OneWinner1);
            writer.Write((int)m_OneWinner2);
            writer.Write((int)m_OneWinner3);
            writer.Write((int)m_OneWinner4);
            writer.Write((int)m_OneWinner5);

            writer.Write((int)m_TwoWinner1);
            writer.Write((int)m_TwoWinner2);
            writer.Write((int)m_TwoWinner3);
            writer.Write((int)m_TwoWinner4);
            writer.Write((int)m_TwoWinner5);

            writer.Write((int)m_ThreeWinner1);
            writer.Write((int)m_ThreeWinner2);
            writer.Write((int)m_ThreeWinner3);
            writer.Write((int)m_ThreeWinner4);
            writer.Write((int)m_ThreeWinner5);

            writer.Write((int)m_WinAmount5);
            writer.Write((int)m_WinAmount4);
            writer.Write((int)m_WinAmount3);
            writer.Write((int)m_WinAmount2);
            writer.Write((int)m_WinAmount1);
		}
        ...
        {
            CommandSystem.Register("LotteryTicketDelete", AccessLevel.Administrator, new CommandEventHandler(LotteryTicketDelete_OnCommand));
        }
    ...
    {
        private LotteryStone m_lotterystone;
        ...
        public LotteryGump(LotteryStone m) : base(80, 80)
        {
            ...
            this.AddPage(0);
            this.AddBackground(0, 0, 437, 406, 83);
			this.AddImageTiled(9, 10, 420, 385, 5058);
            this.AddBackground(20, 126, 245, 131, 2620);
            this.AddBackground(102, 274, 247, 113, 2620);
            this.AddLabel(86, 13, 1160, @"***** The Expanse Lottery Game *****");
            this.AddLabel(64, 134, 1166, @"The Next Lottery Details");
            this.AddLabel(127, 282, 1265, @"Previous Lottery Win Numbers");
            this.AddLabel(31, 162, 170, @"Draw Date : " + m_lotterystone.DateOfNextDraw.ToString());
            this.AddLabel(31, 222, 167, @"Next Jackpot : " + m_lotterystone.LotteryGoldTaken.ToString());
            this.AddLabel(31, 202, 168, @"Ticket Sales So Far : " + m_lotterystone.NextTicketNumber.ToString());
            this.AddLabel(95, 70, 44, @"Highest Payout To Date : " + m_lotterystone.HighestEverJackpot.ToString());
            this.AddLabel(95, 90, 43, @"Rollover Amount Currently At : " + m_lotterystone.RollOverAmount.ToString());
            this.AddLabel(31, 182, 169, @"Price Per Ticket : " + m_lotterystone.PriceToPlay.ToString());
            this.AddLabel(116, 311, 100, @"The Last Draw : " + m_lotterystone.OneWinner1.ToString() + "," + m_lotterystone.OneWinner2.ToString() + "," + m_lotterystone.OneWinner3.ToString() + "," + m_lotterystone.OneWinner4.ToString() + "," + m_lotterystone.OneWinner5.ToString());
            this.AddLabel(116, 331, 99, @"2nd Last Draw: " + m_lotterystone.TwoWinner1.ToString() + "," + m_lotterystone.TwoWinner2.ToString() + "," + m_lotterystone.TwoWinner3.ToString() + "," + m_lotterystone.TwoWinner4.ToString() + "," + m_lotterystone.TwoWinner5.ToString());
            this.AddLabel(116, 351, 98, @"3rd Last Draw : " + m_lotterystone.ThreeWinner1.ToString() + "," + m_lotterystone.ThreeWinner2.ToString() + "," + m_lotterystone.ThreeWinner3.ToString() + "," + m_lotterystone.ThreeWinner4.ToString() + "," + m_lotterystone.ThreeWinner5.ToString());
            this.AddLabel(95, 50, 45, @"Visits To This Stone So Far : " + m_lotterystone.VisitsToStone.ToString()); 
            this.AddLabel(320, 213, 85, @"Purchase Ticket");
            this.AddLabel(320, 235, 30, @"Cancel / Exit");
            this.AddButton(280, 212, 4005, 4007, 1, GumpButtonType.Reply, 0);
            this.AddButton(280, 234, 4017, 4019, 2, GumpButtonType.Reply, 0);
            // NEW EXTRAS
            this.AddLabel(320, 136, 85, @"Next Lottery");
            this.AddLabel(320, 154, 85, @"Details");
            this.AddButton(280, 135, 4005, 4007, 3, GumpButtonType.Reply, 0); // next details
            this.AddLabel(320, 175, 1265, @"Previous");
            this.AddLabel(320, 193, 1265, @"Draw Details");
            this.AddButton(280, 174, 4005, 4007, 4, GumpButtonType.Reply, 0); // previous details
    ...
    {
        private LotteryTicket m_lotteryticket;
        ...
        public LotteryTicketGump(LotteryTicket m) : base(50, 50)
        {
            ...
            this.Resizable = false;
            this.AddPage(0);
            this.AddBackground(0, 0, 316, 416, 9380);
            this.AddLabel(84, 34, 57, @"Official Lottery Ticket");
            this.AddLabel(40, 70, 94, @"Ticket Number : " + m_lotteryticket.TicketNumbers.ToString());
            this.AddLabel(40, 90, 94, @"Draw Date : " + m_lotteryticket.DateOfDrawOnTickets.ToString());
            this.AddLabel(40, 130, 94, @"Ticket Status : " + m_lotteryticket.TicketStatus);
            this.AddLabel(64, 150, 35, @"Lottery Terms and Conditions");
            this.AddLabel(35, 170, 47, @"The status will show if the ticket was");
            this.AddLabel(35, 190, 47, @"a winner or not. Winning claims must be");
            this.AddLabel(35, 209, 47, @"made before the next lottery is drawn.");
            this.AddImage(50, 314, 9004);
            this.AddLabel(35, 230, 35, @"Un-claimed tickets will become void.");
            this.AddLabel(35, 270, 47, @"Management will not be held accountable");
            this.AddLabel(35, 290, 47, @"for muggings, deaths or looted tickets.");
            this.AddButton(151, 315, 9723, 9724, 1, GumpButtonType.Reply, 0); // Exit
            this.AddButton(151, 350, 9723, 9724, 2, GumpButtonType.Reply, 0); // Claim Prize
            this.AddLabel(185, 319, 47, @"Close / Exit.");
            this.AddLabel(185, 354, 47, @"Claim Winnings.");
            this.AddLabel(40, 110, 94, @"Lottery Numbers : " + m_lotteryticket.LotteryNumber1Ticket.ToString() + ", " + m_lotteryticket.LotteryNumber2Ticket.ToString() + ", " + m_lotteryticket.LotteryNumber3Ticket.ToString() + ", " + m_lotteryticket.LotteryNumber4Ticket.ToString() + ", " + m_lotteryticket.LotteryNumber5Ticket.ToString());
        }
    ...
    public class LotteryTicket : Item
    {
        ...
        {
            Weight = 1.0;
            Name = "Lottery Ticket : " + ticknum.ToString() + " Drawn on : " + dateofdraw.ToString();
            Hue = 1260;
        ...
        public override void Serialize(GenericWriter writer)
        {
            base.Serialize(writer);
            writer.Write((int)0); // version
            writer.Write((int)m_TicketNumbers);
            writer.Write((string)m_TicketStatus);
            writer.Write((DateTime)m_DateOfDrawOnTickets);

            writer.Write((int)m_LotteryNumber1Ticket);
            writer.Write((int)m_LotteryNumber2Ticket);
            writer.Write((int)m_LotteryNumber3Ticket);
            writer.Write((int)m_LotteryNumber4Ticket);
            writer.Write((int)m_LotteryNumber5Ticket);

            writer.Write((int)m_LotteryTicketValue);
        }
    ...
    {
        private int ticknumbr = 0;
        private DateTime drawdt = DateTime.Now;
        ...
        public NumberSelectionGump(int ticknumber, DateTime draw, int pds1, int pds2, int pds3, int pds4, int pds5, int sc, int dn0, int dn1, int dn2, int dn3, int dn4, int dn5, int dn6, int dn7, int dn8, int dn9) : base(50, 50)
        {
            ...
            this.AddPage(0);
            this.AddBackground(0, 0, 437, 406, 83);
            this.AddBackground(18, 197, 202, 185, 2620);
            this.AddBackground(18, 59, 399, 106, 2620);
            this.AddLabel(84, 13, 1160, @"***** The Expanse Lottery Game *****");
            this.AddLabel(152, 35, 1166, @"NUMBER SELECTION");
            this.AddLabel(291, 335, 85, @"Continue To Ticket");
            this.AddLabel(291, 357, 85, @"Lucky Dip Selection");

            if (sc >= 6)
            {
                this.AddButton(251, 334, 4005, 4007, 12, GumpButtonType.Reply, 0); // cont to tick
            }
            this.AddButton(251, 356, 4017, 4019, 11, GumpButtonType.Reply, 0); // lucky D
            this.AddLabel(30, 70, 95, @"You are now required to select your 5 numbers for the draw.");
            this.AddLabel(35, 90, 94, @"The next number in the selection will be displayed in white");
            this.AddLabel(88, 110, 92, @"or you can try the lucky dip feature now.");
            this.AddLabel(30, 130, 92, @"The lucky dip will generate 5 random number for your ticket.");
            this.AddLabel(85, 169, 85, @"Number Selections Are :");

            if (sc == 1)
            {
                this.AddLabel(80, 208, 1152, @"Select Here");
                this.AddLabel(50, 238, 268, @"0");
                this.AddLabel(50, 260, 268, @"1");
                this.AddLabel(50, 282, 268, @"2");
                this.AddLabel(50, 304, 268, @"3");
                this.AddLabel(50, 326, 268, @"4");
                this.AddLabel(118, 238, 268, @"5");
                this.AddLabel(118, 260, 268, @"6");
                this.AddLabel(118, 282, 268, @"7");
                this.AddLabel(118, 304, 268, @"8");
                this.AddLabel(118, 326, 268, @"9");

                if (dn0 == 1)
                {
                    this.AddButton(71, 237, 4014, 4016, 0, GumpButtonType.Reply, 0); // Select 0
                }
                if (dn1 == 1)
                {
                    this.AddButton(71, 259, 4014, 4016, 1, GumpButtonType.Reply, 0); // Select 1
                }
                if (dn2 == 1)
                {
                    this.AddButton(71, 281, 4014, 4016, 2, GumpButtonType.Reply, 0); // Select 2
                }
                if (dn3 == 1)
                {
                    this.AddButton(71, 303, 4014, 4016, 3, GumpButtonType.Reply, 0); // Select 3
                }
                if (dn4 == 1)
                {
                    this.AddButton(71, 325, 4014, 4016, 4, GumpButtonType.Reply, 0); // Select 4
                }
                if (dn5 == 1)
                {
                    this.AddButton(139, 237, 4014, 4016, 5, GumpButtonType.Reply, 0); // Select 5
                }
                if (dn6 == 1)
                {
                    this.AddButton(139, 259, 4014, 4016, 6, GumpButtonType.Reply, 0); // Select 6
                }
                if (dn7 == 1)
                {
                    this.AddButton(139, 281, 4014, 4016, 7, GumpButtonType.Reply, 0); // Select 7
                }
                if (dn8 == 1)
                {
                    this.AddButton(139, 303, 4014, 4016, 8, GumpButtonType.Reply, 0); // Select 8
                }
                if (dn9 == 1)
                {
                    this.AddButton(139, 325, 4014, 4016, 9, GumpButtonType.Reply, 0); // Select 9
                }

                this.AddLabel(250, 169, 1152, pds1.ToString());
                this.AddLabel(270, 169, 55, pds2.ToString());
                this.AddLabel(290, 169, 55, pds3.ToString());
                this.AddLabel(310, 169, 55, pds4.ToString());
                this.AddLabel(330, 169, 55, pds5.ToString());
            }
            else if (sc == 2)
            {
                this.AddLabel(80, 208, 1152, @"Select Here");
                ...
                this.AddLabel(250, 169, 55, pds1.ToString());
                this.AddLabel(270, 169, 1152, pds2.ToString());
                this.AddLabel(290, 169, 55, pds3.ToString());
                this.AddLabel(310, 169, 55, pds4.ToString());
                this.AddLabel(330, 169, 55, pds5.ToString());
            }
            else if (sc == 3)
            {
                ...
                this.AddLabel(250, 169, 55, pds1.ToString());
                this.AddLabel(270, 169, 55, pds2.ToString());
                this.AddLabel(290, 169, 1152, pds3.ToString());
                this.AddLabel(310, 169, 55, pds4.ToString());
                this.AddLabel(330, 169, 55, pds5.ToString());
            }
            else if (sc == 4)
            {
                ...
                this.AddLabel(270, 169, 55, pds2.ToString());
                this.AddLabel(290, 169, 55, pds3.ToString());
                this.AddLabel(310, 169, 1152, pds4.ToString());
                this.AddLabel(330, 169, 55, pds5.ToString());
            }
            else if (sc == 5)
            {
                ...
                this.AddLabel(290, 169, 55, pds3.ToString());
                this.AddLabel(310, 169, 55, pds4.ToString());
                this.AddLabel(330, 169, 1152, pds5.ToString());
            }
            else if (sc >= 6)
            {
                this.AddLabel(250, 169, 1152, pds1.ToString());
            ...
            this.AddButton(251, 312, 4029, 4031, 10, GumpButtonType.Reply, 0); // Reset            
            this.AddLabel(291, 313, 90, @"Reset Selection");
    ...
    public class LotteryTimer : Timer
    {
        ...
        public LotteryTimer() : base(TimeSpan.FromSeconds(5), TimeSpan.FromMinutes(20))
        ...
        {
            World.Broadcast(0x35, true, "Lottery System Message...");
            ...
            foreach (Item item in World.Items.Values)
            {
                if (item is LotteryStone)
                {
                    ...
                    World.Broadcast(0x35, true, "System Date/Time : {0}", DateTime.Now);
                    World.Broadcast(0x33, true, "Lottery Date/Time : {0}", timeofdraw);
                    ...
                    if (DateTime.Now >= timeofdraw)
                    {
                        ...
                        // ***********************************************************************************
                        // ***********************************************************************************
                        World.Broadcast(0x55, true, "Lottery timer reset for next draw.");
                    }
                    else
                    {
                        World.Broadcast(0x35, true, "Lottery checked.");
                    }
                }
            }       
        }
    ...
    public class PreviousLottery : Gump
    {
        public PreviousLottery(int visits, int highjp, int ldn1, int ldn2, int ldn3, int ldn4, int ldn5, int lwn5, int lwn4, int lwn3, int lwn2, int lwn1, int lwt) : base(80, 100)
        {
            ...
            this.AddPage(0);
            this.AddBackground(0, 0, 437, 406, 83);
            this.AddBackground(20, 126, 395, 230, 2620);
            this.AddLabel(86, 13, 1160, @"***** The Expanse Lottery Game *****");
            this.AddLabel(123, 137, 1265, @"Previous Lottery Win Details");
            this.AddLabel(95, 70, 44, @"Highest Payout To Date : " + highjp.ToString() + "gp");
            this.AddLabel(56, 166, 100, @"Last Lottery Draw Numbers : " + ldn1.ToString() + ", " + ldn2.ToString() + ", " + ldn3.ToString() + ", " + ldn4.ToString() + ", " + ldn5.ToString());
            this.AddLabel(95, 50, 45, @"Visits To This Stone So Far : " + visits.ToString());
            this.AddLabel(206, 366, 30, @"Cancel / Exit");
            this.AddButton(166, 365, 4017, 4019, 1, GumpButtonType.Reply, 0); // Exit
            this.AddLabel(56, 196, 100, @"Total Tickets With 5 Matching Numbers : " + lwn5.ToString());
            this.AddLabel(56, 216, 99, @"Total Tickets With 4 Matching Numbers : " + lwn4.ToString());
            this.AddLabel(56, 236, 99, @"Total Tickets With 3 Matching Numbers : " +lwn3.ToString());
            this.AddLabel(56, 256, 98, @"Total Tickets With 2 Matching Numbers : " + lwn2.ToString());
            this.AddLabel(56, 276, 98, @"Total Tickets With 1 Matching Number : " + lwn1.ToString());
            this.AddLabel(56, 306, 98, @"Total Amount of Winning Tickets : " + lwt.ToString());
    ...
    {
        private DateTime drawnon = DateTime.Now;
        ...
        public NextLottery(DateTime nextdrawdate, int sales, int jackpotamountsofar, int splits5, int splits4, int splits3, int splits2, int splits1, int stonevisits, int highpay, int rollo) : base(100, 80)
        {
            ...
            this.AddBackground(20, 126, 395, 230, 2620);
            this.AddLabel(86, 13, 1160, @"***** The Expanse Lottery Game *****");
            this.AddLabel(130, 137, 1166, @"Next Lottery Draw Details");
            this.AddLabel(95, 70, 44, @"Highest Payout To Date : " + highpay.ToString());
            this.AddLabel(95, 90, 43, @"Rollover Amount Currently At : " + rollo.ToString());
            this.AddLabel(56, 166, 170, @"Draw Date : " + drawnon.ToString());
            this.AddLabel(95, 50, 45, @"Visits To This Stone So Far : " + stonevisits.ToString());
            this.AddLabel(206, 366, 30, @"Cancel / Exit");
            this.AddButton(166, 365, 4017, 4019, 1, GumpButtonType.Reply, 0); // Exit
            this.AddLabel(56, 196, 169, @"Ticket Sales So Far : " + sales.ToString() + ", Gold Taken : " + jackpotamountsofar.ToString() + "gp");
            this.AddLabel(56, 216, 168, @"Winnings For 5 Draw Numbers : " + win5.ToString() + "gp @ " + splits5.ToString() + "%");
            this.AddLabel(56, 236, 167, @"Winnings For 4 Draw Numbers : " + win4.ToString() + "gp @ " + splits4.ToString() + "%");
            this.AddLabel(56, 256, 167, @"Winnings For 3 Draw Numbers : " + win3.ToString() + "gp @ " + splits3.ToString() + "%");
            this.AddLabel(56, 276, 166, @"Winnings For 2 Draw Numbers : " + win2.ToString() + "gp @ " + splits2.ToString() + "%");
            this.AddLabel(56, 296, 166, @"Winnings For 1 Draw Number : " + win1.ToString() + "gp @ " + splits1.ToString() + "%");
            this.AddLabel(56, 316, 190, @"Rollover Added If 5 Ticket Numbers Are Matched.");
