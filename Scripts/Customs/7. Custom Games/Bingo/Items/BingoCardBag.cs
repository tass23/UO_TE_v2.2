...
namespace Server.Items
{
	...
	public class BingoCardBag : Container
	{
		...
		[Constructable]
		public  BingoCardBag() : base ( 0xE76 )
                                  ...
                                  
		{
		   	 ...
		   	 CharacterCreation.PlaceItemIn( this, 29, 34, new BingoCard1( ) );
                                                      ...
                                                      CharacterCreation.PlaceItemIn( this, 78, 68, new BingoCard11( ) );
		...
		public BingoCardBag( Serial serial ) : base( serial )
		{
		}
