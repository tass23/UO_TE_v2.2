...
namespace Server.Items
{
	public class CraftBag : StrongBackpack
	{
        ...
        private void SalvageIngots( Mobile from )
        {
            ...
            /* Remove these comment marks to add in the check to be near a forge or anvil to salvage.
			bool anvil, forge;
        ...
        {
            private CraftBag m_Bag;

            public SalvageAllEntry( CraftBag bag, bool enabled ): base( 6276 )
            {
                m_Bag = bag;
        ...
        private class SalvageIngotsEntry : ContextMenuEntry
        {
            ...
            public SalvageIngotsEntry( CraftBag bag, bool enabled ): base( 6277 )
            {
                m_Bag = bag;
        ...
        private class SalvageClothEntry : ContextMenuEntry
        {
            ...
            public SalvageClothEntry( CraftBag bag, bool enabled ): base( 6278 )
            {
                m_Bag = bag;
