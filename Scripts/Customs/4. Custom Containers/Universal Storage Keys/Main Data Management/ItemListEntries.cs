...
namespace Solaris.ItemStore
{
	...
	public class ArtifactMapListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 400; } }
		
		//treasure map specific data
		protected Point2D _ChestLocation;
		protected Map _ArtifactChestMap;
		protected Mobile _Decoder;
		protected int _Level;
		protected Rectangle2D _Bounds;
		...
		public override List<ItemListEntryColumn> Columns
		{
			get
			{
				if( _Columns == null )
				{
					...
					//add in specifics for this list type here
					columns.Add( new ItemListEntryColumn( 150, "Map", _ArtifactChestMap.ToString() ) );
					columns.Add( new ItemListEntryColumn( 240, "Decoded?", ( _Decoder == null ? "no" : "yes" ) ) );
		...
		//public accessors
		public Point2D ChestLocation{ get{ return _ChestLocation; } }
		public Map ArtifactChestMap{ get{ return _ArtifactChestMap; } }
		public Mobile Decoder{ get{ return _Decoder; } }
		public int Level{ get{ return _Level; } }
		public Rectangle2D Bounds{ get{ return _Bounds; } }
		
		//master constructor
		public ArtifactMapListEntry( Item item ) : base ( item )
		{
			ArtifactMap map = (ArtifactMap)item;
			...
			_ChestLocation = map.ChestLocation;
			_ArtifactChestMap = map.ArtifactChestMap;
			_Decoder = map.Decoder;
			_Level = map.Level;
			_Bounds = map.Bounds;
		...
		//world load constructor
		public ArtifactMapListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public ArtifactMapListEntry( ArtifactMapListEntry entry ) : base( entry )
		{
			_ChestLocation = entry.ChestLocation;
			_ArtifactChestMap = entry.ArtifactChestMap;
			_Decoder = entry.Decoder;
			_Level = entry.Level;
			_Bounds = entry.Bounds;
		...
		public override Item GenerateItem()
		{
			ArtifactMap map = (ArtifactMap)Activator.CreateInstance( _Type, new object[]{ _Level, _ArtifactChestMap } );
		...
		public override ItemListEntry Clone()
		{
			return new ArtifactMapListEntry( this );
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( _ChestLocation );
			writer.Write( _ArtifactChestMap );
			writer.Write( _Decoder );
			writer.Write( _Level );
			writer.Write( _Bounds );
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			_ChestLocation = reader.ReadPoint2D();
			_ArtifactChestMap = reader.ReadMap();
			_Decoder = reader.ReadMobile();
			_Level = reader.ReadInt();
			_Bounds = reader.ReadRect2D();
		}
	...
	//stores Scroll of Transcendence
	public class ScrollofTranscendenceListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 400; } }
		...
		//master constructor, use the addon deed class name, and hue
		public ScrollofTranscendenceListEntry( Item item ) : base ( item, ((ScrollofTranscendence)item).Skill.ToString(), item.Hue - 1 )
		{
			ScrollofTranscendence scroll = (ScrollofTranscendence)item;
		...
		//world load constructor
		public ScrollofTranscendenceListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public ScrollofTranscendenceListEntry( ScrollofTranscendenceListEntry entry ) : base( entry )
		{
			_Skill = entry.Skill;
			_Value = entry.Value;
		}
		...
		{
			//this allows for inherited classes of addon deeds to fit into this entry.
			ScrollofTranscendence scroll = (ScrollofTranscendence)Activator.CreateInstance( _Type, new object[]{ _Skill, _Value } );
		...
		public override ItemListEntry Clone()
		{
			return new ScrollofTranscendenceListEntry( this );
