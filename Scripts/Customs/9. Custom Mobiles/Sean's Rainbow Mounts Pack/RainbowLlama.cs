...
namespace Server.Mobiles
{
	...
	public class RainbowLlama : BaseMount
	{
		...
		public RainbowLlama( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Fire, 5, 35 );
			SetResistance( ResistanceType.Cold, 5, 35 );
			SetResistance( ResistanceType.Poison, 5, 35 );
			SetResistance( ResistanceType.Energy, 5, 35 );
            ...
            MinTameSkill = 39.1;//Set min taming skill here
		}
