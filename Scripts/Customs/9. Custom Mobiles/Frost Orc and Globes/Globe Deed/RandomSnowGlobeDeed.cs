		...
		public RandomSnowGlobeDeed ( Serial serial ) : base ( serial )
		{
            ...
            else
            {
                switch (Utility.Random(33))
                {
                    ...
                    case 59: from.AddToBackpack(new NorthernMountainsGlobe()); break;
                    ...
                    case 76: from.AddToBackpack(new DeceitGlobe()); break;
                    ...
                    case 98: from.AddToBackpack(new MiningMountainsGlobe()); break;
                    case 99: from.AddToBackpack(new TheExpanseGlobe()); break; 
                }
                this.Delete();
			}
