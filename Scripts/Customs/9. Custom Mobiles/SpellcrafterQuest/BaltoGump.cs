...
"<BASEFONT COLOR=YELLOW>and I was robbed, I do not know what to do.. I am an apprentice to Master Gallin, the spell crafter.<BR><BR>If you can please go and tell my master what has happened, I'm sure he will reward you. Tell him Balto sent you. <BR>" +
"<BASEFONT COLOR=YELLOW>Please be quick so we may find what was stolen quickly! <br><br>" +
"<BASEFONT COLOR=YELLOW>You can find him at Moonglow's Finest Alchemy shop! God Speed, traveler.<br><br>"+
						     "</BODY>", false, true);
