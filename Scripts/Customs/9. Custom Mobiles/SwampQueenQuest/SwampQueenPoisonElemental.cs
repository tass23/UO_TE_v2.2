...
{
	[CorpseName( "a swamp queen guardian's corpse" )]
	public class SwampQueenGuardian : BaseCreature
	{
		[Constructable]
		public SwampQueenGuardian () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Swamp Queen Guardian";
			Body = 162;
			BaseSoundID = 263;
		...
		public SwampQueenGuardian( Serial serial ) : base( serial )
		{
		}
