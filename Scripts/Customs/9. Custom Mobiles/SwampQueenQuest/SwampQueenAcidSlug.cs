...
{
	[CorpseName( "an acidic slug corpse" )]
	public class AcidicSlug : BaseCreature
	{
		[Constructable]
		public AcidicSlug() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an acidic slug";
			Body = 51;
            Hue = 44;
		...
		public AcidicSlug( Serial serial ) : base( serial )
		{
		}
