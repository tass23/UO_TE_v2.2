...
namespace Server.Items
{
    ...
    public class PetPost : Item, ISecurable
    {
        ...
        {
            private PetPost m_Post;
            private Mobile m_From;

            public StableEntry(PetPost post, Mobile from)
                : base(6126, 12)
            {
                m_Post = post;
                m_From = from;
        ...
        private class ClaimListGump : Gump
        {
            ...
            public ClaimListGump(PetPost post, Mobile from, List<BaseCreature> list)
                : base(50, 50)
            {
                m_Post = post;
                m_From = from;
        ...
        private class StableTarget : Target
        {
            ...
            public StableTarget(PetPost post)
