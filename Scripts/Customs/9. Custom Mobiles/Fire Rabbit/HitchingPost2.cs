...
namespace Server.Items
{
    ...
    public class HitchingPost2 : Item, ISecurable
    {
        ...
        public HitchingPost2(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            private HitchingPost2 m_Post;
            private Mobile m_From;

            public StableEntry(HitchingPost2 post, Mobile from)
                : base(6126, 12)
            {
                m_Post = post;
                m_From = from;
        ...
        private class ClaimListGump : Gump
        {
            ...
            public ClaimListGump(HitchingPost2 post, Mobile from, List<BaseCreature> list)
                : base(50, 50)
            {
                m_Post = post;
                m_From = from;
        ...
        private class StableTarget : Target
        {
            ...
            public StableTarget(HitchingPost2 post)
