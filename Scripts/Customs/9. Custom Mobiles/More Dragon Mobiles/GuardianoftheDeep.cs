...
namespace Server.Mobiles
{
	...
	public class GuardianofNight : BaseCreature
	{
		...
		public GuardianofNight() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            ...
            SetResistance( ResistanceType.Physical, 73, 78 );
			SetResistance( ResistanceType.Fire, 72, 78 );
			SetResistance( ResistanceType.Cold, 52, 63 );
			SetResistance( ResistanceType.Poison, 84, 87 );
		...
		public override int TreasureMapLevel{ get{ return 5; } }
            ...
            public GuardianofNight( Serial serial ) : base( serial )
		{
		}
