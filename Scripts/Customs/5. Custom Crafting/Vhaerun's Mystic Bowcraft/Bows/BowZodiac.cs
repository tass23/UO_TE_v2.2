...
namespace Server.Items
{
	...
	public class BowZodiac : BaseRanged
	{
		public override int EffectID{ get{ return 0x3789; } }

		public override Type AmmoType{ get{ return typeof( ZodiacArrow ); } }
		public override Item Ammo{ get{ return new ZodiacArrow(); } }
		...
		[Constructable]
		public BowZodiac() : base( 0x26CC )
		{
			Name = "Bow of the Zodiac";
			Weight = 3.0;
		...
		{
			cold = phys = fire = nrgy = pois = 20;
			chaos = direct = 0;
		}

		public BowZodiac( Serial serial ) : base( serial )
		{
		}
