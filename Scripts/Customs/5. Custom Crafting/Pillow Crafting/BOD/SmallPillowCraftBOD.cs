...
{
	public class SmallPillowCraftBOD : SmallBOD
	{
		...
		public static SmallPillowCraftBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				...
				CraftSystem system = DefPillowCraft.CraftSystem;
				...
				if ( validEntries.Count > 0 )
				{
					...
					return new SmallPillowCraftBOD( entry, material, amountMax, reqExceptional );
				}
			}
		...
		private SmallPillowCraftBOD( SmallBulkEntry entry, BulkMaterialType material, int amountMax, bool reqExceptional )
		{
			this.Hue = 0x483;
		...
		public SmallPillowCraftBOD( int amountCur, int amountMax, Type type, int number, int graphic, bool reqExceptional, BulkMaterialType mat )
		{
			this.Hue = 0x483;
			this.AmountMax = amountMax;
		...
		public SmallPillowCraftBOD( Serial serial ) : base( serial )
		{
		}
