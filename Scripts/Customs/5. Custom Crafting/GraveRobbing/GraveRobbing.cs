	...
	public class GraveRobbing : HarvestSystem
	{
		...
		private GraveRobbing()
		{
			...
			res = new HarvestResource[]
			{
				...
				new HarvestResource( 065.0, 040.0, 150.0, "You put some PetrifiedWood in your backpack",	typeof( PetrifiedWood ) )
			};
			...
			veins = new HarvestVein[]
			{
				...
				new HarvestVein( 10.0, 0.5, res[5], res[0] )	// PetrifiedWood
			};
