...
{
	public class CraftedContractOfEmployment : Item
	{
		public override int LabelNumber{ get{ return 1041243; } } // a contract of employment

		[Constructable]
		public CraftedContractOfEmployment() : base( 0x14F0 )
		{
			Weight = 1.0;
			//LootType = LootType.Blessed;
		}

		public CraftedContractOfEmployment( Serial serial ) : base( serial )
		{
		}
