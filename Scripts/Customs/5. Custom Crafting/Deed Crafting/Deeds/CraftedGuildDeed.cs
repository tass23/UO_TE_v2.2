...
{
	public class CraftedGuildDeed : Item
	{
		public override int LabelNumber{ get{ return 1041055; } } // a guild deed

		[Constructable]
		public CraftedGuildDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
		}

		public CraftedGuildDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			private CraftedGuildDeed m_Deed;

			public InternalPrompt( CraftedGuildDeed deed )
			{
				m_Deed = deed;
			}
