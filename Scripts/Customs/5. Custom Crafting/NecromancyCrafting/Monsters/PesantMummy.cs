...
{
	[CorpseName( "a peasant mummy corpse" )]
	public class PeasantMummy : BaseCreature
	{
		...
		[Constructable]
		public PeasantMummy() : this( false, 1.0 )
		{
		}

		[Constructable]
		public PeasantMummy( bool summoned, double scalar ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a peasant mummy";
			Body = 154;
			BaseSoundID = 471;
		...
		public PeasantMummy( Serial serial ) : base( serial )
		{
		}
