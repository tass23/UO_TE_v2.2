...
namespace Server.Mobiles
{
	...
	public class AvengingBones : BaseCreature
	{
		[Constructable]
		public AvengingBones() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Avenging Bones";
			Body = 147;
			BaseSoundID = 451;
		...
		public AvengingBones( Serial serial ) : base( serial )
		{
		}
