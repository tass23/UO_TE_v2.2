...
{
	[CorpseName( "an Im Perfect corpse" )]
	public class ImPerfect : BaseCreature
	{
		[Constructable]
		public ImPerfect() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Im Perfect";
			Body = 74;
			BaseSoundID = 422;
		...
		public ImPerfect( Serial serial ) : base( serial )
		{
		}
