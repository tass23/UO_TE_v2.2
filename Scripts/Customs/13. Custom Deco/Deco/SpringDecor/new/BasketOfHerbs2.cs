...
{
	public class BasketOfHerbs2 : Item
	{
		...
		[Constructable]
		public BasketOfHerbs2() : base( 0x194F )
		{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			foreach ( BasketOfHerbs2 basket in from.Backpack.FindItemsByType( typeof( BasketOfHerbs2 ) ) )
			{
				if ( basket.IsActive )
					return;
			}
		...
		public BasketOfHerbs2( Serial serial ) : base( serial )
		{
		}
