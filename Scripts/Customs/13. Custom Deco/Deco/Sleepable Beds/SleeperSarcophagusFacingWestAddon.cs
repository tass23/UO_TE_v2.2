...
{
	public class SleeperSarcophagusFacingWestAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperSarcophagusFacingWestAddonDeed();
			}
		}

		public SleeperSarcophagusFacingWestAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperSarcophagusFacingWestAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C63 ), -1, 0, 0 );
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C64 ), 0, 0, 0 );
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C65 ), 1, 0, 0 );
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C62 ), -1, 1, 0 );
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C61 ), 0, 1, 0 );
			AddComponent( new SleeperSarcophagusFacingWestPiece(this, 0x1C60 ), 1, 1, 0 );
			
		}

		private SleeperSarcophagusFacingWestAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperSarcophagusFacingWestAddon Sleeper
		{
	...
	public class SleeperSarcophagusFacingWestPiece : AddonComponent
	{

		private SleeperSarcophagusFacingWestAddon m_Sleeper;

		public SleeperSarcophagusFacingWestPiece( SleeperSarcophagusFacingWestAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperSarcophagusFacingWestPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperSarcophagusFacingWestAddon)reader.ReadItem();

		}

	}

	public class SleeperSarcophagusFacingWestAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperSarcophagusFacingWestAddon();
			}
		}

		[Constructable]
		public SleeperSarcophagusFacingWestAddonDeed()
		{
			Name = "Sarcophagus West";
		}

		public SleeperSarcophagusFacingWestAddonDeed( Serial serial ) : base( serial )
		{
		}
