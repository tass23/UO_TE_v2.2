...
{
	public class SleeperCoffinFacingWestAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperCoffinFacingWestAddonDeed();
			}
		}

		public SleeperCoffinFacingWestAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperCoffinFacingWestAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperCoffinFacingWestPiece(this, 0x1C41 ), -1, 0, 0 );
			AddComponent( new SleeperCoffinFacingWestPiece(this, 0x1C42 ), 0, 0, 0 );
			AddComponent( new SleeperCoffinFacingWestPiece(this, 0x1C43 ), 1, 0, 0 );
			
		}

		private SleeperCoffinFacingWestAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperCoffinFacingWestAddon Sleeper
		{
	...
	public class SleeperCoffinFacingWestPiece : AddonComponent
	{

		private SleeperCoffinFacingWestAddon m_Sleeper;

		public SleeperCoffinFacingWestPiece( SleeperCoffinFacingWestAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperCoffinFacingWestPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperCoffinFacingWestAddon)reader.ReadItem();

		}

	}

	public class SleeperCoffinFacingWestAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperCoffinFacingWestAddon();
			}
		}

		[Constructable]
		public SleeperCoffinFacingWestAddonDeed()
		{
			Name = "Coffin West";
		}

		public SleeperCoffinFacingWestAddonDeed( Serial serial ) : base( serial )
		{
		}
