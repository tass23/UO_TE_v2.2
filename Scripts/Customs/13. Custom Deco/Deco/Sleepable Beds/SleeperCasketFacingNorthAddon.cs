...
//  Coffins/caskets/sarcophagus by Gembone
...
{
	public class SleeperCasketFacingNorthAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperCasketFacingNorthAddonDeed();
			}
		}

		public SleeperCasketFacingNorthAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperCasketFacingNorthAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C32 ), 0, -1, 0 );
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C33 ), 0, 0, 0 );
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C34 ), 0, 1, 0 );
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C31 ), 1, -1, 0 );
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C30 ), 1, 0, 0 );
			AddComponent( new SleeperCasketFacingNorthPiece(this, 0x1C2F ), 1, 1, 0 );
			
		}

		private SleeperCasketFacingNorthAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperCasketFacingNorthAddon Sleeper
		{
		...
		{ 
			...
			else
			{
				...
				{	
					...
					{
						from.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You cannot sleep in someone elses casket! Get a casket of your own." );
						return;
					}
					...
					{
						from.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You must be in the house and be the owner, co-owner or friend of the house this casket is in to sleep in it." );
						return;
					}
				...
				else 
				{
					if(m_Owner==m_Player)
					{
						...
						case 1:
							...
							break;
						case 2:
							m_Player.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You rise from your casket, ready for another day!" );
							break;
						case 3:
							m_Player.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You rise from your casket and blearily reach for the coffee pot." );
							break;
						}
					}
					else
	...
	public class SleeperCasketFacingNorthPiece : AddonComponent
	{
		private SleeperCasketFacingNorthAddon m_Sleeper;

		public SleeperCasketFacingNorthPiece( SleeperCasketFacingNorthAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperCasketFacingNorthPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperCasketFacingNorthAddon)reader.ReadItem();

		}
	}

	public class SleeperCasketFacingNorthAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperCasketFacingNorthAddon();
			}
		}

		[Constructable]
		public SleeperCasketFacingNorthAddonDeed()
		{
			Name = "Casket North";
		}

		public SleeperCasketFacingNorthAddonDeed( Serial serial ) : base( serial )
		{
		}
