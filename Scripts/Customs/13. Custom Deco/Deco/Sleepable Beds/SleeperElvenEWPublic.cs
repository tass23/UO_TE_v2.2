...
namespace Server.Items
{
	...
	public class SleeperElvenEWPublic: BaseAddon, IChopable
	{

		public SleeperElvenEWPublic( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperElvenEWPublic( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperElvenEWPiecePublic(this,  0x304D ), 0, 0, 0 );
			AddComponent( new SleeperElvenEWPiecePublic(this,  0x304C ), 1, 0, 0 );

		}
		
		private SleeperElvenEWPublic m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperElvenEWPublic Sleeper
		{
	...
	public class SleeperElvenEWPiecePublic : AddonComponent
	{

		private SleeperElvenEWPublic m_Sleeper;

		public SleeperElvenEWPiecePublic( SleeperElvenEWPublic sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperElvenEWPiecePublic( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperElvenEWPublic)reader.ReadItem();
