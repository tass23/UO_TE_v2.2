...
{
	public class AddonPaintbrush : Item
	{
...
//		Once the region is set the AddonPaintbrush can be [dupe with the region already set.
        ...
        public static void GetContextMenuEntries( Mobile from, Item item, List<ContextMenuEntry> list/*ArrayList list*/ )
		{
			list.Add( new SetRegionEntry( from, item ) );
		}

        public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list/*ArrayList list*/)
		{
