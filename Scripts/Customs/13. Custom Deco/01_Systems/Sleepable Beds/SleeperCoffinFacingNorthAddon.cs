...
{
	public class SleeperCoffinFacingNorthAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperCoffinFacingNorthAddonDeed();
			}
		}

		public SleeperCoffinFacingNorthAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperCoffinFacingNorthAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperCoffinFacingNorthPiece(this, 0x1C4F ), 0, -1, 0 );
			AddComponent( new SleeperCoffinFacingNorthPiece(this, 0x1C50 ), 0, 0, 0 );
			AddComponent( new SleeperCoffinFacingNorthPiece(this, 0x1C51 ), 0, 1, 0 );
			
		}

		private SleeperCoffinFacingNorthAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperCoffinFacingNorthAddon Sleeper
		{
		...
		{ 
			...
			else
			{
				...
				{	
					...
					{
						from.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You cannot sleep in someone elses coffin! Get a coffin of your own." );
						return;
					}
					...
					{
						from.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You must be in the house and be the owner, co-owner or friend of the house this coffin is in to sleep in it." );
						return;
					}
				...
				else 
				{
					if(m_Owner==m_Player)
					{
						...
						case 1:
							...
							break;
						case 2:
							m_Player.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You rise from your coffin, ready for another day!" );
							break;
						case 3:
							m_Player.LocalOverheadMessage( MessageType.Regular, 0x33, true, "You rise from your coffin and blearily reach for the coffee pot." );
							break;
						}
					}
					else
	...
	public class SleeperCoffinFacingNorthPiece : AddonComponent
	{

		private SleeperCoffinFacingNorthAddon m_Sleeper;

		public SleeperCoffinFacingNorthPiece( SleeperCoffinFacingNorthAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperCoffinFacingNorthPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperCoffinFacingNorthAddon)reader.ReadItem();

		}

	}

	public class SleeperCoffinFacingNorthAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperCoffinFacingNorthAddon();
			}
		}

		[Constructable]
		public SleeperCoffinFacingNorthAddonDeed()
		{
			Name = "Coffin North";
		}

		public SleeperCoffinFacingNorthAddonDeed( Serial serial ) : base( serial )
		{
		}
