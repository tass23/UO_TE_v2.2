...
namespace Server.Items
{
	...
	public class SleeperFurEWAddon: BaseAddon, IChopable
	{
     ...
     public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperFurEWAddonDeed ();
            }
        }
		public SleeperFurEWAddon( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperFurEWAddon( ) 
		{
			Visible = true;
			Name = "SleeperFurEW";
			AddComponent( new SleeperFurEWPiece(this, 4599), 0, 0, 0 );
		}
		
		private SleeperFurEWAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperFurEWAddon Sleeper
		{
	...
	public class SleeperFurEWPiece : AddonComponent
	{

		private SleeperFurEWAddon m_Sleeper;

		public SleeperFurEWPiece( SleeperFurEWAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperFurEWPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperFurEWAddon)reader.ReadItem();

		}

	}
  public class SleeperFurEWAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperFurEWAddon ();
            }
        }

        [Constructable]
        public SleeperFurEWAddonDeed ()
        {
            Name = "Fur East";
        }

        public SleeperFurEWAddonDeed ( Serial serial )
            : base ( serial )
        {
        }
