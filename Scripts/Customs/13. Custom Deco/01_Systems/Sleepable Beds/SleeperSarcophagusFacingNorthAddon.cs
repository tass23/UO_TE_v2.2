...
{
	public class SleeperSarcophagusFacingNorthAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperSarcophagusFacingNorthAddonDeed();
			}
		}

		public SleeperSarcophagusFacingNorthAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperSarcophagusFacingNorthAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C93 ), 0, -1, 0 );
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C94 ), 0, 0, 0 );
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C95 ), 0, 1, 0 );
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C92 ), 1, -1, 0 );
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C91 ), 1, 0, 0 );
			AddComponent( new SleeperSarcophagusFacingNorthPiece(this, 0x1C90 ), 1, 1, 0 );
			
		}

		private SleeperSarcophagusFacingNorthAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperSarcophagusFacingNorthAddon Sleeper
		{
	...
	public class SleeperSarcophagusFacingNorthPiece : AddonComponent
	{

		private SleeperSarcophagusFacingNorthAddon m_Sleeper;

		public SleeperSarcophagusFacingNorthPiece( SleeperSarcophagusFacingNorthAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperSarcophagusFacingNorthPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperSarcophagusFacingNorthAddon)reader.ReadItem();

		}

	}

	public class SleeperSarcophagusFacingNorthAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperSarcophagusFacingNorthAddon();
			}
		}

		[Constructable]
		public SleeperSarcophagusFacingNorthAddonDeed()
		{
			Name = "Sarcophagus North";
		}

		public SleeperSarcophagusFacingNorthAddonDeed( Serial serial ) : base( serial )
		{
		}
