...
{
	public class SleeperFurNSAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperFurNSAddonDeed ();
            }
        }

		public SleeperFurNSAddon( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperFurNSAddon( ) 
		{
			Visible = true;
			Name = "SleeperFurNS";
			AddComponent( new SleeperFurNSPiece(this, 4602), 0, 0, 0 );
		}
		
		private SleeperFurNSAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperFurNSAddon Sleeper
		{
	...
	public class SleeperFurNSPiece : AddonComponent
	{

		private SleeperFurNSAddon m_Sleeper;

		public SleeperFurNSPiece( SleeperFurNSAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperFurNSPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperFurNSAddon)reader.ReadItem();

		}

	}
  public class SleeperFurNSAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperFurNSAddon ();
            }
        }

        [Constructable]
        public SleeperFurNSAddonDeed ()
        {
            Name = "Fur North";
        }

        public SleeperFurNSAddonDeed ( Serial serial )
            : base ( serial )
        {
        }
