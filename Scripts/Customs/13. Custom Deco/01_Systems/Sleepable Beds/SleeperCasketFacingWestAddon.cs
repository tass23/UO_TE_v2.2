...
{
	public class SleeperCasketFacingWestAddon : BaseAddon, IChopable
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SleeperCasketFacingWestAddonDeed();
			}
		}

		public SleeperCasketFacingWestAddon( Serial serial ) : base( serial )
		{
		}

		[ Constructable ]
		public SleeperCasketFacingWestAddon()
		{
			Visible = true;
			Name = "Sleeper";			
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C25 ), -1, 0, 0 );
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C26 ), 0, 0, 0 );
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C27 ), 1, 0, 0 );
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C24 ), -1, 1, 0 );
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C23 ), 0, 1, 0 );
			AddComponent( new SleeperCasketFacingWestPiece(this, 0x1C22 ), 1, 1, 0 );
			
		}

		private SleeperCasketFacingWestAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperCasketFacingWestAddon Sleeper
		{
	...
	public class SleeperCasketFacingWestPiece : AddonComponent
	{

		private SleeperCasketFacingWestAddon m_Sleeper;

		public SleeperCasketFacingWestPiece( SleeperCasketFacingWestAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperCasketFacingWestPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperCasketFacingWestAddon)reader.ReadItem();

		}

	}

	public class SleeperCasketFacingWestAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SleeperCasketFacingWestAddon();
			}
		}

		[Constructable]
		public SleeperCasketFacingWestAddonDeed()
		{
			Name = "Casket West";
		}

		public SleeperCasketFacingWestAddonDeed( Serial serial ) : base( serial )
		{
		}
