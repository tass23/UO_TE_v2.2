...
namespace Server.Items
{
	...
	public class SleeperElvenSouthPublic: BaseAddon, IChopable
	{
		...
		public SleeperElvenSouthPublic( Serial serial ) : base( serial )
		{
		}
	...
	public class SleeperElvenSouthPiecePublic : AddonComponent
	{
		...
		public SleeperElvenSouthPiecePublic( SleeperElvenSouthPublic sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperElvenSouthPiecePublic( Serial serial ) : base( serial )
		{
		}
