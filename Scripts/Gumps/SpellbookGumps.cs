...
namespace Server.Gumps
{
    public abstract class LycanGump : Gump
    {
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                for (int j = (CurrentPage - 1) * 11, C = 0; j < CurrentPage * 11 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        ...
                        AddHtml((C > 5 ? 305 : 145), 155 + (C > 5 ? (C - 6) * 20 : C * 20), 110, 20, String.Format("<basefont color=#{0}>{1}</basefont>", TextHue, info.Name), false, false);
                        AddButton((C > 5 ? 290 : 130), 157 + (C > 5 ? (C - 6) * 20 : C * 20), SpellBtn, SpellBtnP, j + 2000, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
			...
			{
				//state.Mobile.CloseGump(typeof(LycanPrimerGump));	//Add Master Craft Menu to select specific crafting menu.
	...
	public abstract class VampyGump : Gump
    {
            ...
            : base(50, 100)
        {
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                for (int j = (CurrentPage - 1) * 11, C = 0; j < CurrentPage * 11 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        AddButton((C > 5 ? 320 : 174), 155 + (C > 5 ? (C - 6) * 20 : C * 20), 2482, 2482, j + 1000, GumpButtonType.Reply, 0);
                    }
                }
				...
				AddButton(98, 120, 254, 254, 10, GumpButtonType.Reply, 0);	//Bite button
				AddButton(476, 120, 254, 254, 10, GumpButtonType.Reply, 0);	//Bite button
				AddButton(98, 340, 254, 254, 10, GumpButtonType.Reply, 0);	//Bite button
				AddButton(476, 340, 254, 254, 10, GumpButtonType.Reply, 0);	//Bite button
				AddButton(479, 183, 2643, 2643, 11, GumpButtonType.Reply, 0); //Master crafting right button
                AddImage(70, 100, BGImage);
                AddHtml(141, 155, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label1), false, false);
                AddHtml(320, 155, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label2), false, false);
				//AddImage(84, 110, 30021, 2976);	//Bat Form
				//AddImage(84, 140, 30049, 2976);	//Fog Form
				//AddImage(84, 170, 30048, 2976);	//Raven Form
				//AddImage(98, 120, 10700, 2976);	//Bite Top Left
				//AddImage(476, 120, 10700, 2976);	//Bite Top Right
				//AddImage(98, 340, 10720, 2976);	//Bite Bottom Left
				//AddImage(476, 340, 10720, 2976);	//Bite Bottom Right
				//AddImage(479, 183, 2643, 2976); //Master crafting right
                //End Hidden Buttons
                ...
                for (int j = (CurrentPage - 1) * 11, C = 0; j < CurrentPage * 11 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        ...
                        AddHtml((C > 5 ? 321 : 147), 175 + (C > 5 ? (C - 6) * 20 : C * 20), 110, 20, String.Format("<basefont color=#{0}>{1}</basefont>", TextHue, info.Name), false, false);
                        AddButton((C > 5 ? 305 : 132), 177 + (C > 5 ? (C - 6) * 20 : C * 20), SpellBtn, SpellBtnP, j + 2000, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
			...
			{
				//state.Mobile.CloseGump(typeof(CovenSpellbookGump));	//Add Master Craft Menu to select specific crafting menu.
                m.SendMessage( "What do you want to Craft?" );
				m.SendGump( new MasterCraftGump(m) );
			}
	...
	public abstract class MageryGump : Gump
    {
            ...
            : base(50, 100)
        {
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                AddImage(70, 100, BGImage);
				AddHtml(145, 109, 100, 20, String.Format("<big><basefont color=#{0}><Center>INDEX</Center>", TextHue), false, false);
                AddHtml(305, 109, 100, 20, String.Format("<big><basefont color=#{0}><Center>INDEX</Center>", TextHue), false, false);
                //AddHtml(161, 115, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label1), false, false);
                //AddHtml(305, 115, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label2), false, false);
				...
				if (CurrentPage == 1)
				{
					AddHtml(130, 130, 100, 20, String.Format("<big><basefont color=#{0}>First Circle", TextHue), false, false);
					AddHtml(283, 130, 100, 20, String.Format("<big><basefont color=#{0}>Second Circle", TextHue), false, false);
				}
				else if (CurrentPage == 2)
				{
					AddHtml(130, 128, 100, 20, String.Format("<big><basefont color=#{0}>Third Circle", TextHue), false, false);
					AddHtml(283, 128, 100, 20, String.Format("<big><basefont color=#{0}>Fourth Circle", TextHue), false, false);
				}
				else if (CurrentPage == 3)
				{
					AddHtml(130, 128, 100, 20, String.Format("<big><basefont color=#{0}>Fifth Circle", TextHue), false, false);
					AddHtml(283, 128, 100, 20, String.Format("<big><basefont color=#{0}>Sixth Circle", TextHue), false, false);
				}
				else if (CurrentPage == 4)
				{
					AddHtml(130, 128, 120, 20, String.Format("<big><basefont color=#{0}>Seventh Circle", TextHue), false, false);
					AddHtml(283, 128, 100, 20, String.Format("<big><basefont color=#{0}>Eighth Circle", TextHue), false, false);
				}
                //End Prev/Next Buttons
                ...
                for (int j = (CurrentPage - 1) * 16, C = 0; j < CurrentPage * 16 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        ...
                        AddHtml((C > 7 ? 283 : 130), 146 + (C > 7 ? (C - 8) * 16 : C * 16), 110, 20, String.Format("<big><basefont color=#{0}>{1}", BookHue, info.Name), false, false);
                        //AddButton((C > 7 ? 288 : 130), 138 + (C > 7 ? (C - 8) * 20 : C * 17), SpellBtn, SpellBtnP, j + 2000, GumpButtonType.Reply, 0);
                        AddButton((C > 7 ? 408 : 250), 149 + (C > 7 ? (C - 8) * 16 : C * 16), 9272, 9272, j + 2000, GumpButtonType.Reply, 0);//AddButton((C > 7 ? 408 : 247), 138 + (C > 7 ? (C - 8) * 20 : C * 17), 9272, 9272, j + 1000, GumpButtonType.Reply, 0);
						AddImage((C > 7 ? 408 : 250), 149 + (C > 7 ? (C - 8) * 16 : C * 16), 9272, 2973);
                    }
                }
                //End Spell Buttons/Labels
            }
	...
	public abstract class ChivGump : Gump
    {
        ...
        public ChivGump(CSpellbook book)
            : base(50, 100)
        {
            if (!CSS.Running)
                return;
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
				...
				AddButton(73, 202, 11400, 11400, 6, GumpButtonType.Reply, 0);	//Minimize button
				AddButton(438, 130, 2643, 2643, 7, GumpButtonType.Reply, 0); //Master crafting right button
				AddButton(75, 244, 257, 257, 8, GumpButtonType.Reply, 0); //Tithe left button
                AddImage(70, 100, BGImage);
				AddHtml(145, 109, 100, 20, String.Format("<big><basefont color=#{0}><Center>INDEX</Center>", TextHue), false, false);
                AddHtml(305, 109, 100, 20, String.Format("<big><basefont color=#{0}><Center>INDEX</Center>", TextHue), false, false);
                //AddHtml(161, 115, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label1), false, false);
                //AddHtml(305, 115, 100, 20, String.Format("<basefont color=#{0}><Center>{1}</Center>", TextHue, Label2), false, false);
				//AddImage(73, 202, 11400, 2976);	//Minimize button
				//AddImage(75, 244, 257, 2976 ); //Tithe left button
                //End Hidden Buttons
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                for (int j = (CurrentPage - 1) * 6, C = 0; j < CurrentPage * 6 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        ...
                        AddHtml((C > 2 ? 283 : 130), 146 + (C > 2 ? (C - 3) * 16 : C * 16), 150, 20, String.Format("<big><basefont color=#{0}>{1}", BookHue, info.Name), false, false);
                        //AddButton((C > 7 ? 288 : 130), 138 + (C > 7 ? (C - 8) * 20 : C * 17), SpellBtn, SpellBtnP, j + 2000, GumpButtonType.Reply, 0);
                        AddButton((C > 2 ? 408 : 250), 149 + (C > 2 ? (C - 3) * 16 : C * 16), 9272, 9272, j + 2000, GumpButtonType.Reply, 0);//AddButton((C > 7 ? 408 : 247), 138 + (C > 7 ? (C - 8) * 20 : C * 17), 9272, 9272, j + 1000, GumpButtonType.Reply, 0);
            ...
            for (int i = 0; i < Pages; i++, CurrentPage++)
            {
                ...
                for (int j = (CurrentPage - 1) * 8, C = 0; j < CurrentPage * 8 && j < m_Spells.Count; j++, C++)
                {
                    if (HasSpell((Type)m_Spells[j]))
                    {
                        ...
                        AddHtml((C > 3 ? 283 : 130), 146 + (C > 3 ? (C - 4) * 16 : C * 16), 110, 20, String.Format("<big><basefont color=#{0}>{1}", BookHue, info.Name), false, false);
                        //AddButton((C > 7 ? 288 : 130), 138 + (C > 7 ? (C - 8) * 20 : C * 17), SpellBtn, SpellBtnP, j + 2000, GumpButtonType.Reply, 0);
                        AddButton((C > 3 ? 408 : 250), 149 + (C > 3 ? (C - 4) * 16 : C * 16), 9272, 9272, j + 2000, GumpButtonType.Reply, 0);//AddButton((C > 7 ? 408 : 247), 138 + (C > 7 ? (C - 8) * 20 : C * 17), 9272, 9272, j + 1000, GumpButtonType.Reply, 0);
