			...
			else
			{
				...
				if ( index >= 0 && index < m_Book.Entries.Count )
				{
					...
					switch ( type )
					{
						...
						case 3: // Recall
						{
							if ( HasSpell( from, 31 ) || Server.ACC.CSS.CSpellbook.MobileHasSpell(from, ACC.CSS.School.Magery, typeof(RecallSpell)))
							{
								int xLong = 0, yLat = 0;
								int xMins = 0, yMins = 0;
								bool xEast = false, ySouth = false;
							...
							if ( Server.ACC.CSS.CSpellbook.MobileHasSpell(from, ACC.CSS.School.LightForce, typeof(FoldSpaceSpell)))
							{
								int xLong = 0, yLat = 0;
								int xMins = 0, yMins = 0;
								bool xEast = false, ySouth = false;
								...
								m_Book.OnTravel();
								new FoldSpaceSpell( from, null, e, null ).Cast();
							}
							if ( Server.ACC.CSS.CSpellbook.MobileHasSpell(from, ACC.CSS.School.DarkForce, typeof(DarkFoldSpaceSpell)))
							{
								int xLong = 0, yLat = 0;
								int xMins = 0, yMins = 0;
								bool xEast = false, ySouth = false;
								...
								m_Book.OnTravel();
								new DarkFoldSpaceSpell( from, null, e, null ).Cast();
							}
							else
							{
						...
						case 4: // Gate
						{
							if ( HasSpell( from, 51 )  || Server.ACC.CSS.CSpellbook.MobileHasSpell(from, ACC.CSS.School.Magery, typeof(GateTravelSpell)))
							{
								int xLong = 0, yLat = 0;
								int xMins = 0, yMins = 0;
								bool xEast = false, ySouth = false;
						...
						case 5: // Sacred Journey
						{
							if ( Core.AOS )
							{
								if ( HasSpell( from, 209 )  || Server.ACC.CSS.CSpellbook.MobileHasSpell(from, ACC.CSS.School.Chivalry, typeof(SacredJourneySpell)))
								{
									int xLong = 0, yLat = 0;
									int xMins = 0, yMins = 0;
									bool xEast = false, ySouth = false;
