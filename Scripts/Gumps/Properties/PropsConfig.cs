...
namespace Server.Gumps
{
	public class PropsConfig
	{
		...
		public static readonly int TextHue = 1085;
		public static readonly int TextOffsetX = 2;

		public static readonly int OffsetGumpID = 0x0DB0; //public static readonly int OffsetGumpID = 0x0A40; // Pure black Divider
		public static readonly int HeaderGumpID = OldStyle ? 0x0BBC : 0x1404; //public static readonly int HeaderGumpID = OldStyle ? 0x0BBC : 0x0E14; // Light offwhite, textured : Dark navy blue, textured
		public static readonly int  EntryGumpID = 0x0A40; //public static readonly int  EntryGumpID = 0x0BBC; // Light offwhite, textured Entry background
		public static readonly int   BackGumpID = 0x13BE; // Gray slate/stoney
		public static readonly int    SetGumpID = OldStyle ? 0x0000 : 0x0A2C; //public static readonly int    SetGumpID = OldStyle ? 0x0000 : 0x0E14; // Empty : Dark navy blue, textured
