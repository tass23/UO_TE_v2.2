...
namespace Server.Gumps
{
	public class ReportMurdererGump : Gump
	{
		...
		{
			#region FS Bounty System
			Closable = false;
			Resizable = false;
			AddPage(0);
			AddBackground(0, 0, 292, 201, 5054);
			AddLabel(24, 22, 1080, @"The Expanse: Report Murderer");
			AddHtml( 20, 82, 249, 63, @"Would you like to report {0} as a murderer?", (bool)false, (bool)false);
			AddButton(17, 161, 247, 248, 1, GumpButtonType.Reply, 0);
			AddButton(211, 161, 241, 242, 2, GumpButtonType.Reply, 0);
			AddHtml( 20, 54, 249, 22, ((Mobile)m_Killers[m_Idx]).Name, false, false);
